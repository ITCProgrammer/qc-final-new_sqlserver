      ...
      <div class="box-body">
        <table class="table table-bordered table-hover table-striped nowrap" id="example3" style="width:100%">
          ...
          <tr bgcolor="<?php echo $bgcolor; ?>">
            ...
            <a href="#" class="btn btn-success btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; } ?>" onclick="confirm_potong('./HapusDataPotongNew-<?php echo $row1['id'] ?>');"><i class="fa fa-check-circle" data-toggle="tooltip" data-placement="top" title="Sudah Potong?"></i> </a>
            </td>
            ...
            <td align="center"><a href="#" class="btn btn-danger btn-xs <?php if($_SESSION['akses']=='biasa' AND $_SESSION['lvl_id']!='NCP'){ echo "disabled"; } ?>" onclick="confirm_delete('./HapusDataPotongNew-<?php echo $row1['id'] ?>');"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Hapus"></i> </a></td>
            </tr>
          <?php	$no++;  } ?>
        </tbody>
      </table>

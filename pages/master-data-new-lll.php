  ...
  <body>
    <div class="box box-info">
      <div class="box-header with-border">
        <h3 class="box-title">Filter Data Master LLL</h3>
      ...
      <form method="post" enctype="multipart/form-data" name="form1" class="form-horizontal" id="form1">
        <div class="box-body">
          <div class="form-group">
			<div class="col-sm-2">
                <input name="item" type="text" class="form-control" id="item" placeholder="No Hanger" value="<?php echo $Item; ?>" />
		    </div>
        ...
        <div class="box">
          <div class="box-header with-border">
            ...
            <div class="pull-right">
                <a href="#" class="btn btn-success tambah_lll">Tambah Data</a>
            </div>
            <!--<?php if ($_POST['item']!="") { ?>
            <br><b>Periode:
            ...
            <table id="example3" class="table table-bordered table-hover table-striped display" width="100%">
              <thead class="bg-red">
                <tr>
                  ...
                  <th><div align="center">Fiber Content</div></th>
              ...
              <tbody>
                ...
                <tr bgcolor="<?php echo $bgcolor; ?>">
                  ...
                  <td align="center"><?php echo $r['matrial_name'];?></td>
                  <td align="center"><?php echo $r['fiber_content'];?></td>
                  <td align="center"><div class="btn-group">
                  <a href="#" id='<?php echo $r['id']; ?>' class="btn btn-info btn-xs edit_lll"><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="Edit"></i> </a>
                  <a href="#" class="btn btn-danger btn-xs" onclick="confirm_delete('./HapusDataLLL-<?php echo $r['id'] ?>');"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Hapus"></i> </a>
                  </div></td>
                </tr>
                <?php } ?>
              </tbody>

...
<div class="row">
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped" style="width: 100%;">
          ...
          <tbody>
            ...
            $totaldDis=0;
            $totaldllDis=0;
            $qryAll=sqlsrv_query($con_db_qc_sqlsrv,"SELECT COUNT(*) AS jml_all, SUM(berat) AS berat_all FROM db_qc.tbl_ncp_qcf WHERE TRY_CAST(tgl_buat AS DATE) BETWEEN '$Awal' AND '$Akhir' AND (masalah_dominan!='' OR masalah_dominan!=NULL) AND NOT status='Cancel'");
            $rAll=sqlsrv_fetch_array($qryAll);
            $qryAllDis=sqlsrv_query($con_db_qc_sqlsrv,"SELECT COUNT(*) AS jml_all, SUM(berat) AS berat_all FROM db_qc.tbl_ncp_qcf WHERE TRY_CAST(tgl_buat AS DATE) BETWEEN '$Awal' AND '$Akhir' AND (masalah_dominan!='' OR masalah_dominan!=NULL) AND status='Disposisi' AND NOT status='Cancel'");
            $rAllDis=sqlsrv_fetch_array($qryAllDis);
            $qrydef=sqlsrv_query($con_db_qc_sqlsrv,"SELECT TOP 5 SUM(berat) AS berat, ROUND(COUNT(masalah_dominan)/(SELECT COUNT(*) FROM db_qc.tbl_ncp_qcf WHERE TRY_CAST(tgl_buat AS DATE) BETWEEN '$Awal' AND '$Akhir' AND NOT status='Cancel'
            AND (masalah_dominan!='' OR masalah_dominan!=NULL))*100,1) AS persen,
            masalah_dominan
            FROM
            db_qc.tbl_ncp_qcf
            WHERE TRY_CAST(tgl_buat AS DATE) BETWEEN '$Awal' AND '$Akhir' AND (masalah_dominan!='' OR masalah_dominan!=NULL) AND NOT status='Cancel'
            GROUP BY masalah_dominan
            ORDER BY berat DESC");
            while($rd=sqlsrv_fetch_array($qrydef)){
              $qrydefDis=sqlsrv_query($con_db_qc_sqlsrv,"SELECT SUM(berat) AS berat, ROUND(COUNT(masalah_dominan)/(SELECT COUNT(*) FROM db_qc.tbl_ncp_qcf WHERE TRY_CAST(tgl_buat AS DATE) BETWEEN '$Awal' AND '$Akhir' AND status='Disposisi' AND masalah_dominan='$rd[masalah_dominan]' AND NOT status='Cancel'
              AND (masalah_dominan!='' OR masalah_dominan!=NULL))*100,1) AS persen,
              masalah_dominan
              FROM
              db_qc.tbl_ncp_qcf
              WHERE TRY_CAST(tgl_buat AS DATE) BETWEEN '$Awal' AND '$Akhir' AND status='Disposisi' AND masalah_dominan='$rd[masalah_dominan]' AND (masalah_dominan!='' OR masalah_dominan!=NULL) AND NOT status='Cancel'");
  ...
  <div class="col-xs-5">	
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped" style="width: 100%;">
          ...
          <tbody>
            ...
            $totaldptDis=0;
            $totaldlldptDis=0;
            $qryAllDpt=sqlsrv_query($con_db_qc_sqlsrv,"SELECT COUNT(*) AS jml_all, SUM(berat) AS berat_all FROM db_qc.tbl_ncp_qcf WHERE TRY_CAST(tgl_buat AS DATE) BETWEEN '$Awal' AND '$Akhir' AND (dept!='' OR dept!=NULL) AND NOT status='Cancel'");
            $rAllDpt=sqlsrv_fetch_array($qryAllDpt);
            $qryAllDptDis=sqlsrv_query($con_db_qc_sqlsrv,"SELECT COUNT(*) AS jml_all, SUM(berat) AS berat_all FROM db_qc.tbl_ncp_qcf WHERE TRY_CAST(tgl_buat AS DATE) BETWEEN '$Awal' AND '$Akhir' AND (dept!='' OR dept!=NULL) AND status='Disposisi' AND NOT status='Cancel'");
            $rAllDptDis=sqlsrv_fetch_array($qryAllDptDis);
            $qrydpt=sqlsrv_query($con_db_qc_sqlsrv,"SELECT TOP 5 SUM(berat) AS berat, ROUND(COUNT(dept)/(SELECT COUNT(*) FROM db_qc.tbl_ncp_qcf WHERE TRY_CAST(tgl_buat AS DATE) BETWEEN '$Awal' AND '$Akhir' AND NOT status='Cancel'
            AND (dept!='' OR dept!=NULL))*100,1) AS persen,
            dept
            FROM
            db_qc.tbl_ncp_qcf
            WHERE TRY_CAST(tgl_buat AS DATE) BETWEEN '$Awal' AND '$Akhir' AND (dept!='' OR dept!=NULL) AND NOT status='Cancel'
            GROUP BY dept
            ORDER BY berat DESC");
            while($rdpt=sqlsrv_fetch_array($qrydpt)){
              $qrydptDis=sqlsrv_query($con_db_qc_sqlsrv,"SELECT SUM(berat) AS berat, ROUND(COUNT(dept)/(SELECT COUNT(*) FROM db_qc.tbl_ncp_qcf WHERE TRY_CAST(tgl_buat AS DATE) BETWEEN '$Awal' AND '$Akhir' AND status='Disposisi' AND dept='$rdpt[dept]' AND NOT status='Cancel'
              AND (dept!='' OR dept!=NULL))*100,1) AS persen,
              dept
              FROM
              db_qc.tbl_ncp_qcf
              WHERE TRY_CAST(tgl_buat AS DATE) BETWEEN '$Awal' AND '$Akhir' AND status='Disposisi' AND dept='$rdpt[dept]' AND (dept!='' OR dept!=NULL) AND NOT status='Cancel'
              GROUP BY dept");
	...
	$qrySUM=sqlsrv_query($con_db_qc_sqlsrv,"SELECT COUNT(*) as Lot, SUM(rol) as Rol,SUM(berat) as Berat FROM db_qc.tbl_ncp_qcf WHERE $Wdept TRY_CAST(tgl_buat AS DATE) BETWEEN '$Awal' AND '$Akhir' $sts ");
	...
	while($row1=sqlsrv_fetch_array($qry1)){
		 ?>
          <tr bgcolor="<?php echo $bgcolor; ?>">
            ...
            <td align="center"><?php echo date_format($row1['tgl_buat'], "d-m-Y H:i:s");?><br><div class="btn-group"><a href="pages/cetak/cetak_ncp.php?id=<?php echo $row1['id'];?>" class="btn btn-xs btn-danger" target="_blank"><i class="fa fa-print"></i></a><a href="pages/cetak/cetak_ncp_pdf.php?id=<?php echo $row1['id'];?>" class="btn btn-xs btn-info" target="_blank"><i class="fa fa-file-pdf-o"></i></a></div></td>
            ...
            <td align="center"><?php echo ($row1['tgl_rencana'] !== null) ? date_format($row1['tgl_rencana'], 'd/m/y') : '';?></td>
            <td align="center"><?php echo ($row1['tgl_selesai'] !== null) ? date_format($row1['tgl_selesai'], 'd/m/y') : '';?></td>

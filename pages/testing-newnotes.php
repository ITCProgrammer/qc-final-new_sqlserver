			...
			<div class="box">
				<div class="box-header">
					<small class="pull-right">Date:
						<?php echo ($rcek1['tgl_buat']) ? $rcek1['tgl_buat']->format('Y-m-d') : null; ?>
					</small>
					<div class="box-body">
...
if ($_POST['physical_save'] == "save" and $cek1 > 0) {
	...
	if ($sqlPHY) {
		...
		UPDATE db_qc.tbl_tq_disptest SET
			dflamability=?, dfla_note=?, dfc_cott=?, dfc_poly=?, dfc_elastane=?, 
			dfc_cott1=?, dfc_poly1=?, dfc_elastane1=?, dfibercontent=?, dfiber_note=?, 
			std_dfc_cott1=?, std_dfc_poly1=?, std_dfc_elastane1=?, dfc_wpi=?, dfc_cpi=?, 
			dfc_note=?, df_weight=?, dfwe_note=?, df_width=?, dfwi_note=?, 
			dbow=?, dskew=?, dbas_note=?, dh_shrinkage_temp=?, dh_shrinkage_l1=?, 
			dh_shrinkage_w1=?, dh_shrinkage_grd=?, dh_shrinkage_app=?, dh_shrinkage_note=?, dss_temp=?, 
			dss_washes3=?, dss_washes10=?, dss_washes15=?, dss_cmt=?, dshrinkage_l1=?, 
			dshrinkage_l2=?, dshrinkage_l3=?, dshrinkage_l4=?, dshrinkage_l5=?, dshrinkage_l6=?, 
			dshrinkage_w1=?, dshrinkage_w2=?, dshrinkage_w3=?, dshrinkage_w4=?, dshrinkage_w5=?, 
			dshrinkage_w6=?, dspirality1=?, dspirality2=?, dspirality3=?, dspirality4=?, 
			dspirality5=?, dspirality6=?, dss_linedry=?, dss_tumbledry=?, dsns_note=?, 
			dapperss_ch1=?, dapperss_ch2=?, dapperss_ch3=?, dapperss_ch4=?, dapperss_cc1=?, 
			dapperss_cc2=?, dapperss_cc3=?, dapperss_cc4=?, dapperss_st=?, dapperss_pf1=?, 
			dapperss_pf2=?, dapperss_pf3=?, dapperss_pf4=?, dapperss_pb1=?, dapperss_pb2=?, 
			dapperss_pb3=?, dapperss_pb4=?, dapperss_sf1=?, dapperss_sf2=?, dapperss_sf3=?, 
			dapperss_sf4=?, dapperss_sb1=?, dapperss_sb2=?, dapperss_sb3=?, dapperss_sb4=?, 
			dapperss_note=?, dpm_f1=?, dpm_b1=?, dpm_f2=?, dpm_b2=?, 
			dpm_f3=?, dpm_b3=?, dpm_f4=?, dpm_b4=?, dpm_f5=?, 
			dpm_b5=?, dpillm_note=?, dpl_f1=?, dpl_b1=?, dpl_f2=?, 
			dpl_b2=?, dpl_f3=?, dpl_b3=?, dpl_f4=?, dpl_b4=?, 
			dpl_f5=?, dpl_b5=?, dpilll_note=?, dpb_f1=?, dpb_b1=?, 
			dpb_f2=?, dpb_b2=?, dpb_f3=?, dpb_b3=?, dpb_f4=?, 
			dpb_b4=?, dpb_f5=?, dpb_b5=?, dpillb_note=?, dprt_f1=?, 
			dprt_b1=?, dprt_f2=?, dprt_b2=?, dprt_f3=?, dprt_b3=?, 
			dprt_f4=?, dprt_b4=?, dprt_f5=?, dprt_b5=?, dpillr_note=?, 
			dabration=?, dabr_note=?, dsm_l1=?, dsm_w1=?, dsm_l2=?, 
			dsm_w2=?, dsm_l3=?, dsm_w3=?, dsm_l4=?, dsm_w4=?, 
			dsnam_note=?, dsp_grdl1=?, dsp_clsl1=?, dsp_shol1=?, dsp_medl1=?, 
			dsp_lonl1=?, dsp_grdw1=?, dsp_clsw1=?, dsp_show1=?, dsp_medw1=?, 
			dsp_lonw1=?, dsp_grdl2=?, dsp_clsl2=?, dsp_shol2=?, dsp_medl2=?, 
			dsp_lonl2=?, dsp_grdw2=?, dsp_clsw2=?, dsp_show2=?, dsp_medw2=?, 
			dsp_lonw2=?, dsnap_note=?, dsb_l1=?, dsb_w1=?, dsb_l2=?, 
			dsb_w2=?, dsb_l3=?, dsb_w3=?, dsb_l4=?, dsb_w4=?, 
			dsnab_note=?, dbs_instron=?, dbs_mullen=?, dbs_tru=?, dbs_tru2=?, 
			dburs_note=?, dthick1=?, dthick2=?, dthick3=?, dthickav=?, 
			dthick_note=?, dstretch_l1=?, dstretch_w1=?, dstretch_l2=?, dstretch_w2=?, 
			dstretch_l3=?, dstretch_w3=?, dstretch_l4=?, dstretch_w4=?, dstretch_l5=?, 
			dstretch_w5=?, dload_stretch=?, dstretch_note=?, drecover_l1=?, drecover_w1=?, 
			drecover_l2=?, drecover_w2=?, drecover_l3=?, drecover_w3=?, drecover_l4=?, 
			drecover_w4=?, drecover_l5=?, drecover_w5=?, drecover_w11=?, drecover_l21=?, 
			drecover_w21=?, drecover_l31=?, drecover_w31=?, drecover_l41=?, drecover_w41=?, 
			drecover_l51=?, drecover_w51=?, drecover_note=?, dgrowth_l1=?, dgrowth_w1=?, 
			dgrowth_l2=?, dgrowth_w2=?, drec_growth_l1=?, drec_growth_w1=?, drec_growth_l2=?, 
			drec_growth_w2=?, dgrowth_note=?, dapper_ch1=?, dapper_ch2=?, dapper_ch3=?, 
			dapper_cc1=?, dapper_cc2=?, dapper_cc3=?, dapper_st=?, dapper_st2=?, 
			dapper_st3=?, dapper_pf1=?, dapper_pf2=?, dapper_pf3=?, dapper_pb1=?, 
			dapper_pb2=?, dapper_pb3=?, dapper_acetate=?, dapper_cotton=?, dapper_nylon=?, 
			dapper_poly=?, dapper_acrylic=?, dapper_wool=?, dapper_note=?, dfibre_transfer=?, 
			dfibre_grade=?, dfibre_note=?, dodour=?, dodour_note=?, dcurling=?, 
			dcurling_note=?, dnedle=?, dnedle_note=?, tgl_update=GETDATE()
		WHERE id_nokk = ?
		";
		
		$paramspy_d = [
			$_POST['dflamability'], $_POST['dfla_note'], $_POST['dfc_cott'], $_POST['dfc_poly'], $_POST['dfc_ela'],
			$_POST['dfc_cott1'], $_POST['dfc_poly1'], $_POST['dfc_ela1'], $_POST['dfibercontent'], $_POST['dfiber_note'],
			$_POST['std_dfc_cott1'], $_POST['std_dfc_poly1'], $_POST['std_dfc_elastane1'], $_POST['dwpi'], $_POST['dcpi'],
			$_POST['dfc_note'], $_POST['dfabric_weight'], $_POST['dfwe_note'], $_POST['dfabric_width'], $_POST['dfwi_note'],
			$_POST['dbow'], $_POST['dskew'], $_POST['dbas_note'], $_POST['dh_shrinkage_temp'], $_POST['dh_shrinkage_l1'],
			$_POST['dh_shrinkage_w1'], $_POST['dh_shrinkage_grd'], $_POST['dh_shrinkage_app'], $_POST['dh_shrinkage_note'], $_POST['dss_temp'],
			$_POST['dss_washes3'], $_POST['dss_washes10'], $_POST['dss_washes15'], $_POST['dss_cmt'], $_POST['dshrinkage_len1'],
			$_POST['dshrinkage_len2'], $_POST['dshrinkage_len3'], $_POST['dshrinkage_len4'], $_POST['dshrinkage_len5'], $_POST['dshrinkage_len6'],
			$_POST['dshrinkage_wid1'], $_POST['dshrinkage_wid2'], $_POST['dshrinkage_wid3'], $_POST['dshrinkage_wid4'], $_POST['dshrinkage_wid5'],
			$_POST['dshrinkage_wid6'], $_POST['dspirality1'], $_POST['dspirality2'], $_POST['dspirality3'], $_POST['dspirality4'],
			$_POST['dspirality5'], $_POST['dspirality6'], $_POST['dss_linedry'], $_POST['dss_tumbledry'], $_POST['dsns_note'],
			$_POST['dapperss_ch1'], $_POST['dapperss_ch2'], $_POST['dapperss_ch3'], $_POST['dapperss_ch4'], $_POST['dapperss_cc1'],
			$_POST['dapperss_cc2'], $_POST['dapperss_cc3'], $_POST['dapperss_cc4'], $_POST['dapperss_st'], $_POST['dapperss_pf1'],
			$_POST['dapperss_pf2'], $_POST['dapperss_pf3'], $_POST['dapperss_pf4'], $_POST['dapperss_pb1'], $_POST['dapperss_pb2'],
			$_POST['dapperss_pb3'], $_POST['dapperss_pb4'], $_POST['dapperss_sf1'], $_POST['dapperss_sf2'], $_POST['dapperss_sf3'],
			$_POST['dapperss_sf4'], $_POST['dapperss_sb1'], $_POST['dapperss_sb2'], $_POST['dapperss_sb3'], $_POST['dapperss_sb4'],
			$_POST['dapperss_note'], $_POST['dpillingm_f1'], $_POST['dpillingm_b1'], $_POST['dpillingm_f2'], $_POST['dpillingm_b2'],
			$_POST['dpillingm_f3'], $_POST['dpillingm_b3'], $_POST['dpillingm_f4'], $_POST['dpillingm_b4'], $_POST['dpillingm_f5'],
			$_POST['dpillingm_b5'], $_POST['dpillm_note'], $_POST['dpillingl_f1'], $_POST['dpillingl_b1'], $_POST['dpillingl_f2'],
			$_POST['dpillingl_b2'], $_POST['dpillingl_f3'], $_POST['dpillingl_b3'], $_POST['dpillingl_f4'], $_POST['dpillingl_b4'],
			$_POST['dpillingl_f5'], $_POST['dpillingl_b5'], $_POST['dpilll_note'], $_POST['dpillingb_f1'], $_POST['dpillingb_b1'],
			$_POST['dpillingb_f2'], $_POST['dpillingb_b2'], $_POST['dpillingb_f3'], $_POST['dpillingb_b3'], $_POST['dpillingb_f4'],
			$_POST['dpillingb_b4'], $_POST['dpillingb_f5'], $_POST['dpillingb_b5'], $_POST['dpillb_note'], $_POST['dpillingrt_f1'],
			$_POST['dpillingrt_b1'], $_POST['dpillingrt_f2'], $_POST['dpillingrt_b2'], $_POST['dpillingrt_f3'], $_POST['dpillingrt_b3'],
			$_POST['dpillingrt_f4'], $_POST['dpillingrt_b4'], $_POST['dpillingrt_f5'], $_POST['dpillingrt_b5'], $_POST['dpillr_note'],
			$_POST['dabr'], $_POST['dabr_note'], $_POST['dsnaggingm_l1'], $_POST['dsnaggingm_w1'], $_POST['dsnaggingm_l2'],
			$_POST['dsnaggingm_w2'], $_POST['dsnaggingm_l3'], $_POST['dsnaggingm_w3'], $_POST['dsnaggingm_l4'], $_POST['dsnaggingm_w4'],
			$_POST['dsnam_note'], $_POST['dsp_grdl1'], $_POST['dsp_clsl1'], $_POST['dsp_shol1'], $_POST['dsp_medl1'],
			$_POST['dsp_lonl1'], $_POST['dsp_grdw1'], $_POST['dsp_clsw1'], $_POST['dsp_show1'], $_POST['dsp_medw1'],
			$_POST['dsp_lonw1'], $_POST['dsp_grdl2'], $_POST['dsp_clsl2'], $_POST['dsp_shol2'], $_POST['dsp_medl2'],
			$_POST['dsp_lonl2'], $_POST['dsp_grdw2'], $_POST['dsp_clsw2'], $_POST['dsp_show2'], $_POST['dsp_medw2'],
			$_POST['dsp_lonw2'], $_POST['dsnap_note'], $_POST['dsnaggingb_l1'], $_POST['dsnaggingb_w1'], $_POST['dsnaggingb_l2'],
			$_POST['dsnaggingb_w2'], $_POST['dsnaggingb_l3'], $_POST['dsnaggingb_w3'], $_POST['dsnaggingb_l4'], $_POST['dsnaggingb_w4'],
			$_POST['dsnab_note'], $_POST['dinstron'], $_POST['dmullen'], $_POST['dtru_burst'], $_POST['dtru_burst2'],
			$_POST['dburs_note'], $_POST['dthick1'], $_POST['dthick2'], $_POST['dthick3'], $_POST['dthickav'],
			$_POST['dthick_note'], $_POST['dstretch_l1'], $_POST['dstretch_w1'], $_POST['dstretch_l2'], $_POST['dstretch_w2'],
			$_POST['dstretch_l3'], $_POST['dstretch_w3'], $_POST['dstretch_l4'], $_POST['dstretch_w4'], $_POST['dstretch_l5'],
			$_POST['dstretch_w5'], $_POST['dload_stretch'], $_POST['dstretch_note'], $_POST['drecover_l1'], $_POST['drecover_w1'],
			$_POST['drecover_l2'], $_POST['drecover_w2'], $_POST['drecover_l3'], $_POST['drecover_w3'], $_POST['drecover_l4'],
			$_POST['drecover_w4'], $_POST['drecover_l5'], $_POST['drecover_w5'], $_POST['drecover_w11'], $_POST['drecover_l21'],
			$_POST['drecover_w21'], $_POST['drecover_l31'], $_POST['drecover_w31'], $_POST['drecover_l41'], $_POST['drecover_w41'],
			$_POST['drecover_l51'], $_POST['drecover_w51'], $_POST['drecover_note'], $_POST['dgrowth_l1'], $_POST['dgrowth_w1'],
			$_POST['dgrowth_l2'], $_POST['dgrowth_w2'], $_POST['drec_growth_l1'], $_POST['drec_growth_w1'], $_POST['drec_growth_l2'],
			$_POST['drec_growth_w2'], $_POST['dgrowth_note'], $_POST['dapper_ch1'], $_POST['dapper_ch2'], $_POST['dapper_ch3'],
			$_POST['dapper_cc1'], $_POST['dapper_cc2'], $_POST['dapper_cc3'], $_POST['dapper_st'], $_POST['dapper_st2'],
			$_POST['dapper_st3'], $_POST['dapper_pf1'], $_POST['dapper_pf2'], $_POST['dapper_pf3'], $_POST['dapper_pb1'],
			$_POST['dapper_pb2'], $_POST['dapper_pb3'], $_POST['dapper_acetate'], $_POST['dapper_cotton'], $_POST['dapper_nylon'],
			$_POST['dapper_poly'], $_POST['dapper_acrylic'], $_POST['dapper_wool'], $_POST['dapper_note'], $_POST['dfibre_transfer'],
			$_POST['dfibre_grade'], $_POST['dfibre_note'], $_POST['dodour'], $_POST['dodour_note'], $_POST['dcurling'],
			$_POST['dcurling_note'], $_POST['dnedle'], $_POST['dnedle_note'],
			$rcek['id'] // Parameter terakhir untuk WHERE
		];

		$sqlPHYD = sqlsrv_query($con_db_qc_sqlsrv, $sqlpy_d, $paramspy_d);

		if ($sqlPHYD === false) {
			die(print_r(sqlsrv_errors(), true));
		}

		$sqlpy_m = "UPDATE db_qc.tbl_tq_marginal SET
					mflamability=?, mfla_note=?, mfc_cott=?, mfc_poly=?, mfc_elastane=?, 
					mfc_cott1=?, mfc_poly1=?, mfc_elastane1=?, std_mfc_cott1=?, std_mfc_poly1=?, 
					std_mfc_elastane1=?, mfibercontent=?, mfiber_note=?, mfc_wpi=?, mfc_cpi=?, 
					mfc_note=?, mf_weight=?, mfwe_note=?, mf_width=?, mfwi_note=?, 
					mbow=?, mskew=?, mbas_note=?, mh_shrinkage_temp=?, mh_shrinkage_l1=?, 
					mh_shrinkage_w1=?, mh_shrinkage_grd=?, mh_shrinkage_app=?, mh_shrinkage_note=?, mss_temp=?, 
					mss_washes3=?, mss_washes10=?, mss_washes15=?, mss_cmt=?, mshrinkage_l1=?, 
					mshrinkage_l2=?, mshrinkage_l3=?, mshrinkage_l4=?, mshrinkage_l5=?, mshrinkage_l6=?, 
					mshrinkage_w1=?, mshrinkage_w2=?, mshrinkage_w3=?, mshrinkage_w4=?, mshrinkage_w5=?, 
					mshrinkage_w6=?, mspirality1=?, mspirality2=?, mspirality3=?, mspirality4=?, 
					mspirality5=?, mspirality6=?, mss_linedry=?, mss_tumbledry=?, msns_note=?, 
					mapperss_ch1=?, mapperss_ch2=?, mapperss_ch3=?, mapperss_ch4=?, mapperss_cc1=?, 
					mapperss_cc2=?, mapperss_cc3=?, mapperss_cc4=?, mapperss_st=?, mapperss_pf1=?, 
					mapperss_pf2=?, mapperss_pf3=?, mapperss_pf4=?, mapperss_pb1=?, mapperss_pb2=?, 
					mapperss_pb3=?, mapperss_pb4=?, mapperss_sf1=?, mapperss_sf2=?, mapperss_sf3=?, 
					mapperss_sf4=?, mapperss_sb1=?, mapperss_sb2=?, mapperss_sb3=?, mapperss_sb4=?, 
					mapperss_note=?, mpm_f1=?, mpm_b1=?, mpm_f2=?, mpm_b2=?, 
					mpm_f3=?, mpm_b3=?, mpm_f4=?, mpm_b4=?, mpm_f5=?, 
					mpm_b5=?, mpillm_note=?, mpl_f1=?, mpl_b1=?, mpl_f2=?, 
					mpl_b2=?, mpl_f3=?, mpl_b3=?, mpl_f4=?, mpl_b4=?, 
					mpl_f5=?, mpl_b5=?, mpilll_note=?, mpb_f1=?, mpb_b1=?, 
					mpb_f2=?, mpb_b2=?, mpb_f3=?, mpb_b3=?, mpb_f4=?, 
					mpb_b4=?, mpb_f5=?, mpb_b5=?, mpillb_note=?, mprt_f1=?, 
					mprt_b1=?, mprt_f2=?, mprt_b2=?, mprt_f3=?, mprt_b3=?, 
					mprt_f4=?, mprt_b4=?, mprt_f5=?, mprt_b5=?, mpillr_note=?, 
					mabration=?, mabr_note=?, msm_l1=?, msm_w1=?, msm_l2=?, 
					msm_w2=?, msm_l3=?, msm_w3=?, msm_l4=?, msm_w4=?, 
					msnam_note=?, msp_grdl1=?, msp_clsl1=?, msp_shol1=?, msp_medl1=?, 
					msp_lonl1=?, msp_grdw1=?, msp_clsw1=?, msp_show1=?, msp_medw1=?, 
					msp_lonw1=?, msp_grdl2=?, msp_clsl2=?, msp_shol2=?, msp_medl2=?, 
					msp_lonl2=?, msp_grdw2=?, msp_clsw2=?, msp_show2=?, msp_medw2=?, 
					msp_lonw2=?, msnap_note=?, msb_l1=?, msb_w1=?, msb_l2=?, 
					msb_w2=?, msb_l3=?, msb_w3=?, msb_l4=?, msb_w4=?, 
					msnab_note=?, mbs_instron=?, mbs_mullen=?, mbs_tru=?, mbs_tru2=?, 
					mburs_note=?, mthick1=?, mthick2=?, mthick3=?, mthickav=?, 
					mthick_note=?, mstretch_l1=?, mstretch_w1=?, mstretch_l2=?, mstretch_w2=?, 
					mstretch_l3=?, mstretch_w3=?, mstretch_l4=?, mstretch_w4=?, mstretch_l5=?, 
					mstretch_w5=?, mload_stretch=?, mstretch_note=?, mrecover_l1=?, mrecover_w1=?, 
					mrecover_l2=?, mrecover_w2=?, mrecover_l3=?, mrecover_w3=?, mrecover_l4=?, 
					mrecover_w4=?, mrecover_l5=?, mrecover_w5=?, mrecover_l11=?, mrecover_w11=?, 
					mrecover_l21=?, mrecover_w21=?, mrecover_l31=?, mrecover_w31=?, mrecover_l41=?, 
					mrecover_w41=?, mrecover_l51=?, mrecover_w51=?, mrecover_note=?, mgrowth_l1=?, 
					mgrowth_w1=?, mgrowth_l2=?, mgrowth_w2=?, mrec_growth_l1=?, mrec_growth_w1=?, 
					mrec_growth_l2=?, mrec_growth_w2=?, mgrowth_note=?, mapper_ch1=?, mapper_ch2=?, 
					mapper_ch3=?, mapper_cc1=?, mapper_cc2=?, mapper_cc3=?, mapper_st=?, 
					mapper_st2=?, mapper_st3=?, mapper_pf1=?, mapper_pf2=?, mapper_pf3=?, 
					mapper_pb1=?, mapper_pb2=?, mapper_pb3=?, mapper_acetate=?, mapper_cotton=?, 
					mapper_nylon=?, mapper_poly=?, mapper_acrylic=?, mapper_wool=?, mapper_note=?, 
					mfibre_transfer=?, mfibre_grade=?, mfibre_note=?, modour=?, modour_note=?, 
					tgl_update=GETDATE()
				WHERE id_nokk = ?
				";

		$paramspy_m = [
					$_POST['mflamability'], $_POST['mfla_note'], $_POST['mfc_cott'], $_POST['mfc_poly'], $_POST['mfc_ela'],
					$_POST['mfc_cott1'], $_POST['mfc_poly1'], $_POST['mfc_ela1'], $_POST['std_mfc_cott1'], $_POST['std_mfc_poly1'],
					$_POST['std_mfc_elastane1'], $_POST['mfibercontent'], $_POST['mfiber_note'], $_POST['mwpi'], $_POST['mcpi'],
					$_POST['mfc_note'], $_POST['mfabric_weight'], $_POST['mfwe_note'], $_POST['mfabric_width'], $_POST['mfwi_note'],
					$_POST['mbow'], $_POST['mskew'], $_POST['mbas_note'], $_POST['mh_shrinkage_temp'], $_POST['mh_shrinkage_l1'],
					$_POST['mh_shrinkage_w1'], $_POST['mh_shrinkage_grd'], $_POST['mh_shrinkage_app'], $_POST['mh_shrinkage_note'], $_POST['mss_temp'],
					$_POST['mss_washes3'], $_POST['mss_washes10'], $_POST['mss_washes15'], $_POST['mss_cmt'], $_POST['mshrinkage_len1'],
					$_POST['mshrinkage_len2'], $_POST['mshrinkage_len3'], $_POST['mshrinkage_len4'], $_POST['mshrinkage_len5'], $_POST['mshrinkage_len6'],
					$_POST['mshrinkage_wid1'], $_POST['mshrinkage_wid2'], $_POST['mshrinkage_wid3'], $_POST['mshrinkage_wid4'], $_POST['mshrinkage_wid5'],
					$_POST['mshrinkage_wid6'], $_POST['mspirality1'], $_POST['mspirality2'], $_POST['mspirality3'], $_POST['mspirality4'],
					$_POST['mspirality5'], $_POST['mspirality6'], $_POST['mss_linedry'], $_POST['mss_tumbledry'], $_POST['msns_note'],
					$_POST['mapperss_ch1'], $_POST['mapperss_ch2'], $_POST['mapperss_ch3'], $_POST['mapperss_ch4'], $_POST['mapperss_cc1'],
					$_POST['mapperss_cc2'], $_POST['mapperss_cc3'], $_POST['mapperss_cc4'], $_POST['mapperss_st'], $_POST['mapperss_pf1'],
					$_POST['mapperss_pf2'], $_POST['mapperss_pf3'], $_POST['mapperss_pf4'], $_POST['mapperss_pb1'], $_POST['mapperss_pb2'],
					$_POST['mapperss_pb3'], $_POST['mapperss_pb4'], $_POST['mapperss_sf1'], $_POST['mapperss_sf2'], $_POST['mapperss_sf3'],
					$_POST['mapperss_sf4'], $_POST['mapperss_sb1'], $_POST['mapperss_sb2'], $_POST['mapperss_sb3'], $_POST['mapperss_sb4'],
					$_POST['mapperss_note'], $_POST['mpillingm_f1'], $_POST['mpillingm_b1'], $_POST['mpillingm_f2'], $_POST['mpillingm_b2'],
					$_POST['mpillingm_f3'], $_POST['mpillingm_b3'], $_POST['mpillingm_f4'], $_POST['mpillingm_b4'], $_POST['mpillingm_f5'],
					$_POST['mpillingm_b5'], $_POST['mpillm_note'], $_POST['mpillingl_f1'], $_POST['mpillingl_b1'], $_POST['mpillingl_f2'],
					$_POST['mpillingl_b2'], $_POST['mpillingl_f3'], $_POST['mpillingl_b3'], $_POST['mpillingl_f4'], $_POST['mpillingl_b4'],
					$_POST['mpillingl_f5'], $_POST['mpillingl_b5'], $_POST['mpilll_note'], $_POST['mpillingb_f1'], $_POST['mpillingb_b1'],
					$_POST['mpillingb_f2'], $_POST['mpillingb_b2'], $_POST['mpillingb_f3'], $_POST['mpillingb_b3'], $_POST['mpillingb_f4'],
					$_POST['mpillingb_b4'], $_POST['mpillingb_f5'], $_POST['mpillingb_b5'], $_POST['mpillb_note'], $_POST['mpillingrt_f1'],
					$_POST['mpillingrt_b1'], $_POST['mpillingrt_f2'], $_POST['mpillingrt_b2'], $_POST['mpillingrt_f3'], $_POST['mpillingrt_b3'],
					$_POST['mpillingrt_f4'], $_POST['mpillingrt_b4'], $_POST['mpillingrt_f5'], $_POST['mpillingrt_b5'], $_POST['mpillr_note'],
					$_POST['mabr'], $_POST['mabr_note'], $_POST['msnaggingm_l1'], $_POST['msnaggingm_w1'], $_POST['msnaggingm_l2'],
					$_POST['msnaggingm_w2'], $_POST['msnaggingm_l3'], $_POST['msnaggingm_w3'], $_POST['msnaggingm_l4'], $_POST['msnaggingm_w4'],
					$_POST['msnam_note'], $_POST['msp_grdl1'], $_POST['msp_clsl1'], $_POST['msp_shol1'], $_POST['msp_medl1'],
					$_POST['msp_lonl1'], $_POST['msp_grdw1'], $_POST['msp_clsw1'], $_POST['msp_show1'], $_POST['msp_medw1'],
					$_POST['msp_lonw1'], $_POST['msp_grdl2'], $_POST['msp_clsl2'], $_POST['msp_shol2'], $_POST['msp_medl2'],
					$_POST['msp_lonl2'], $_POST['msp_grdw2'], $_POST['msp_clsw2'], $_POST['msp_show2'], $_POST['msp_medw2'],
					$_POST['msp_lonw2'], $_POST['msnap_note'], $_POST['msnaggingb_l1'], $_POST['msnaggingb_w1'], $_POST['msnaggingb_l2'],
					$_POST['msnaggingb_w2'], $_POST['msnaggingb_l3'], $_POST['msnaggingb_w3'], $_POST['msnaggingb_l4'], $_POST['msnaggingb_w4'],
					$_POST['msnab_note'], $_POST['minstron'], $_POST['mmullen'], $_POST['mtru_burst'], $_POST['mtru_burst2'],
					$_POST['mburs_note'], $_POST['mthick1'], $_POST['mthick2'], $_POST['mthick3'], $_POST['mthickav'],
					$_POST['mthick_note'], $_POST['mstretch_l1'], $_POST['mstretch_w1'], $_POST['mstretch_l2'], $_POST['mstretch_w2'],
					$_POST['mstretch_l3'], $_POST['mstretch_w3'], $_POST['mstretch_l4'], $_POST['mstretch_w4'], $_POST['mstretch_l5'],
					$_POST['mstretch_w5'], $_POST['mload_stretch'], $_POST['mstretch_note'], $_POST['mrecover_l1'], $_POST['mrecover_w1'],
					$_POST['mrecover_l2'], $_POST['mrecover_w2'], $_POST['mrecover_l3'], $_POST['mrecover_w3'], $_POST['mrecover_l4'],
					$_POST['mrecover_w4'], $_POST['mrecover_l5'], $_POST['mrecover_w5'], $_POST['mrecover_l11'], $_POST['mrecover_w11'],
					$_POST['mrecover_l21'], $_POST['mrecover_w21'], $_POST['mrecover_l31'], $_POST['mrecover_w31'], $_POST['mrecover_l41'],
					$_POST['mrecover_w41'], $_POST['mrecover_l51'], $_POST['mrecover_w51'], $_POST['mrecover_note'], $_POST['mgrowth_l1'],
					$_POST['mgrowth_w1'], $_POST['mgrowth_l2'], $_POST['mgrowth_w2'], $_POST['mrec_growth_l1'], $_POST['mrec_growth_w1'],
					$_POST['mrec_growth_l2'], $_POST['mrec_growth_w2'], $_POST['mgrowth_note'], $_POST['mapper_ch1'], $_POST['mapper_ch2'],
					$_POST['mapper_ch3'], $_POST['mapper_cc1'], $_POST['mapper_cc2'], $_POST['mapper_cc3'], $_POST['mapper_st'],
					$_POST['mapper_st2'], $_POST['mapper_st3'], $_POST['mapper_pf1'], $_POST['mapper_pf2'], $_POST['mapper_pf3'],
					$_POST['mapper_pb1'], $_POST['mapper_pb2'], $_POST['mapper_pb3'], $_POST['mapper_acetate'], $_POST['mapper_cotton'],
					$_POST['mapper_nylon'], $_POST['mapper_poly'], $_POST['mapper_acrylic'], $_POST['mapper_wool'], $_POST['mapper_note'],
					$_POST['mfibre_transfer'], $_POST['mfibre_grade'], $_POST['mfibre_note'], $_POST['modour'], $_POST['modour_note'],
					$rcek['id'] // Primary Key / WHERE
				];
									
		$sqlPHYM = sqlsrv_query($con_db_qc_sqlsrv, $sqlpy_m, $paramspy_m);
	...
	$sql = "
			INSERT INTO db_qc.tbl_tq_disptest (
				id_nokk, dflamability, dfla_note, dfc_cott, dfc_poly, dfc_elastane,
				dfc_cott1, dfc_poly1, dfc_elastane1, std_dfc_cott1, std_dfc_poly1, std_dfc_elastane1,
				dfibercontent, dfiber_note, dfc_wpi, dfc_cpi, dfc_note,
				df_weight, dfwe_note, df_width, dfwi_note,
				dbow, dskew, dbas_note, dh_shrinkage_temp, dh_shrinkage_l1, dh_shrinkage_w1,
				dh_shrinkage_grd, dh_shrinkage_app, dh_shrinkage_note, dss_temp, dss_washes3, dss_washes10, dss_washes15, dss_cmt,
				...
				dapperss_ch1, dapperss_ch2, dapperss_ch3, dapperss_ch4, dapperss_cc1, dapperss_cc2, dapperss_cc3, dapperss_cc4,
				dapperss_st, dapperss_pf1, dapperss_pf2, dapperss_pf3, dapperss_pf4, dapperss_pb1, dapperss_pb2, dapperss_pb3, dapperss_pb4,
				dapperss_sf1, dapperss_sf2, dapperss_sf3, dapperss_sf4, dapperss_sb1, dapperss_sb2, dapperss_sb3, dapperss_sb4,
				dapperss_note, dpm_f1, dpm_b1, dpm_f2, dpm_b2, dpm_f3, dpm_b3, dpm_f4, dpm_b4, dpm_f5, dpm_b5, dpillm_note,
				...
				dabration, dabr_note, dsm_l1, dsm_w1, dsm_l2, dsm_w2, dsm_l3, dsm_w3, dsm_l4, dsm_w4, dsnam_note,
				dsp_grdl1, dsp_clsl1, dsp_shol1, dsp_medl1, dsp_lonl1, dsp_grdw1, dsp_clsw1, dsp_show1, dsp_medw1, dsp_lonw1,
				dsp_grdl2, dsp_clsl2, dsp_shol2, dsp_medl2, dsp_lonl2, dsp_grdw2, dsp_clsw2, dsp_show2, dsp_medw2, dsp_lonw2, dsnap_note,
				...
				dstretch_l1, dstretch_w1, dstretch_l2, dstretch_w2, dstretch_l3, dstretch_w3, dstretch_l4, dstretch_w4, dstretch_l5, dstretch_w5, dload_stretch, dstretch_note,
				drecover_l1, drecover_w1, drecover_l2, drecover_w2, drecover_l3, drecover_w3, drecover_l4, drecover_w4, drecover_l5, drecover_w5,
				drecover_w11, drecover_l21, drecover_w21, drecover_l31, drecover_w31, drecover_l41, drecover_w41, drecover_l51, drecover_w51, drecover_note,
				dgrowth_l1, dgrowth_w1, dgrowth_l2, dgrowth_w2, drec_growth_l1, drec_growth_w1, drec_growth_l2, drec_growth_w2, dgrowth_note,
				dapper_ch1, dapper_ch2, dapper_ch3, dapper_cc1, dapper_cc2, dapper_cc3, dapper_st, dapper_st2, dapper_st3,
				dapper_pf1, dapper_pf2, dapper_pf3, dapper_pb1, dapper_pb2, dapper_pb3,
				dapper_acetate, dapper_cotton, dapper_nylon, dapper_poly, dapper_acrylic, dapper_wool, dapper_note,
				dfibre_transfer, dfibre_grade, dfibre_note, dodour, dodour_note,
				dcurling, dcurling_note, dnedle, dnedle_note,
				tgl_buat, tgl_update
			) VALUES (
				?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,
				?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,
		...
		$params = [
					$rcek['id'], $_POST['dflamability'], $_POST['dfla_note'], $_POST['dfc_cott'], $_POST['dfc_poly'], $_POST['dfc_ela'],
					$_POST['dfc_cott1'], $_POST['dfc_poly1'], $_POST['dfc_ela1'], $_POST['std_dfc_cott1'], $_POST['std_dfc_poly1'], $_POST['std_dfc_elastane1'],
					$_POST['dfibercontent'], $_POST['dfiber_note'], $_POST['dwpi'], $_POST['dcpi'], $_POST['dfc_note'],
					$_POST['dfabric_weight'], $_POST['dfwe_note'], $_POST['dfabric_width'], $_POST['dfwi_note'],
					$_POST['dbow'], $_POST['dskew'], $_POST['dbas_note'], $_POST['dh_shrinkage_temp'], $_POST['dh_shrinkage_l1'], $_POST['dh_shrinkage_w1'],
					$_POST['dh_shrinkage_grd'], $_POST['dh_shrinkage_app'], $_POST['dh_shrinkage_note'], $_POST['dss_temp'], $_POST['dss_washes3'], $_POST['dss_washes10'], $_POST['dss_washes15'], $_POST['dss_cmt'],
					...
					$_POST['dapperss_ch1'], $_POST['dapperss_ch2'], $_POST['dapperss_ch3'], $_POST['dapperss_ch4'], $_POST['dapperss_cc1'], $_POST['dapperss_cc2'], $_POST['dapperss_cc3'], $_POST['dapperss_cc4'],
					$_POST['dapperss_st'], $_POST['dapperss_pf1'], $_POST['dapperss_pf2'], $_POST['dapperss_pf3'], $_POST['dapperss_pf4'], $_POST['dapperss_pb1'], $_POST['dapperss_pb2'], $_POST['dapperss_pb3'], $_POST['dapperss_pb4'],
					$_POST['dapperss_sf1'], $_POST['dapperss_sf2'], $_POST['dapperss_sf3'], $_POST['dapperss_sf4'], $_POST['dapperss_sb1'], $_POST['dapperss_sb2'], $_POST['dapperss_sb3'], $_POST['dapperss_sb4'],
					$_POST['dapperss_note'], $_POST['dpillingm_f1'], $_POST['dpillingm_b1'], $_POST['dpillingm_f2'], $_POST['dpillingm_b2'], $_POST['dpillingm_f3'], $_POST['dpillingm_b3'], $_POST['dpillingm_f4'], $_POST['dpillingm_b4'], $_POST['dpillingm_f5'], $_POST['dpillingm_b5'], $_POST['dpillm_note'],
					...
					$_POST['dabr'], $_POST['dabr_note'], $_POST['dsnaggingm_l1'], $_POST['dsnaggingm_w1'], $_POST['dsnaggingm_l2'], $_POST['dsnaggingm_w2'], $_POST['dsnaggingm_l3'], $_POST['dsnaggingm_w3'], $_POST['dsnaggingm_l4'], $_POST['dsnaggingm_w4'], $_POST['dsnam_note'],
					$_POST['dsp_grdl1'], $_POST['dsp_clsl1'], $_POST['dsp_shol1'], $_POST['dsp_medl1'], $_POST['dsp_lonl1'], $_POST['dsp_grdw1'], $_POST['dsp_clsw1'], $_POST['dsp_show1'], $_POST['dsp_medw1'], $_POST['dsp_lonw1'],
					$_POST['dsp_grdl2'], $_POST['dsp_clsl2'], $_POST['dsp_shol2'], $_POST['dsp_medl2'], $_POST['dsp_lonl2'], $_POST['dsp_grdw2'], $_POST['dsp_clsw2'], $_POST['dsp_show2'], $_POST['dsp_medw2'], $_POST['dsp_lonw2'], $_POST['dsnap_note'],
					...
					$_POST['dstretch_l1'], $_POST['dstretch_w1'], $_POST['dstretch_l2'], $_POST['dstretch_w2'], $_POST['dstretch_l3'], $_POST['dstretch_w3'], $_POST['dstretch_l4'], $_POST['dstretch_w4'], $_POST['dstretch_l5'], $_POST['dstretch_w5'], $_POST['dload_stretch'], $_POST['dstretch_note'],
					$_POST['drecover_l1'], $_POST['drecover_w1'], $_POST['drecover_l2'], $_POST['drecover_w2'], $_POST['drecover_l3'], $_POST['drecover_w3'], $_POST['drecover_l4'], $_POST['drecover_w4'], $_POST['drecover_l5'], $_POST['drecover_w5'],
					$_POST['drecover_w11'], $_POST['drecover_l21'], $_POST['drecover_w21'], $_POST['drecover_l31'], $_POST['drecover_w31'], $_POST['drecover_l41'], $_POST['drecover_w41'], $_POST['drecover_l51'], $_POST['drecover_w51'], $_POST['drecover_note'],
					$_POST['dgrowth_l1'], $_POST['dgrowth_w1'], $_POST['dgrowth_l2'], $_POST['dgrowth_w2'], $_POST['drec_growth_l1'], $_POST['drec_growth_w1'], $_POST['drec_growth_l2'], $_POST['drec_growth_w2'], $_POST['dgrowth_note'],
					$_POST['dapper_ch1'], $_POST['dapper_ch2'], $_POST['dapper_ch3'], $_POST['dapper_cc1'], $_POST['dapper_cc2'], $_POST['dapper_cc3'], $_POST['dapper_st'], $_POST['dapper_st2'], $_POST['dapper_st3'],
					$_POST['dapper_pf1'], $_POST['dapper_pf2'], $_POST['dapper_pf3'], $_POST['dapper_pb1'], $_POST['dapper_pb2'], $_POST['dapper_pb3'],
					$_POST['dapper_acetate'], $_POST['dapper_cotton'], $_POST['dapper_nylon'], $_POST['dapper_poly'], $_POST['dapper_acrylic'], $_POST['dapper_wool'], $_POST['dapper_note'],
					$_POST['dfibre_transfer'], $_POST['dfibre_grade'], $_POST['dfibre_note'], $_POST['dodour'], $_POST['dodour_note'],
					$_POST['dcurling'], $_POST['dcurling_note'], $_POST['dnedle'], $_POST['dnedle_note']
				];
		...
		$sqlpy_mi = "
			INSERT INTO db_qc.tbl_tq_marginal (
				id_nokk, mflamability, mfla_note, mfc_cott, mfc_poly, mfc_elastane,
				mfc_cott1, mfc_poly1, mfc_elastane1, std_mfc_cott1, std_mfc_poly1, std_mfc_elastane1,
				mfibercontent, mfiber_note, mfc_wpi, mfc_cpi, mfc_note,
				mf_weight, mfwe_note, mf_width, mfwi_note,
				mbow, mskew, mbas_note, mh_shrinkage_temp, mh_shrinkage_l1, mh_shrinkage_w1,
				mh_shrinkage_grd, mh_shrinkage_app, mh_shrinkage_note, mss_temp, mss_washes3, mss_washes10, mss_washes15, mss_cmt,
				...
				mapperss_ch1, mapperss_ch2, mapperss_ch3, mapperss_ch4, mapperss_cc1, mapperss_cc2, mapperss_cc3, mapperss_cc4,
				mapperss_st, mapperss_pf1, mapperss_pf2, mapperss_pf3, mapperss_pf4, mapperss_pb1, mapperss_pb2, mapperss_pb3, mapperss_pb4,
				mapperss_sf1, mapperss_sf2, mapperss_sf3, mapperss_sf4, mapperss_sb1, mapperss_sb2, mapperss_sb3, mapperss_sb4,
				mapperss_note, mpm_f1, mpm_b1, mpm_f2, mpm_b2, mpm_f3, mpm_b3, mpm_f4, mpm_b4, mpm_f5, mpm_b5, mpillm_note,
				...
				mabration, mabr_note, msm_l1, msm_w1, msm_l2, msm_w2, msm_l3, msm_w3, msm_l4, msm_w4, msnam_note,
				msp_grdl1, msp_clsl1, msp_shol1, msp_medl1, msp_lonl1, msp_grdw1, msp_clsw1, msp_show1, msp_medw1, msp_lonw1,
				msp_grdl2, msp_clsl2, msp_shol2, msp_medl2, msp_lonl2, msp_grdw2, msp_clsw2, msp_show2, msp_medw2, msp_lonw2, msnap_note,
				...
				mstretch_l1, mstretch_w1, mstretch_l2, mstretch_w2, mstretch_l3, mstretch_w3, mstretch_l4, mstretch_w4, mstretch_l5, mstretch_w5, mload_stretch, mstretch_note,
				mrecover_l1, mrecover_w1, mrecover_l2, mrecover_w2, mrecover_l3, mrecover_w3, mrecover_l4, mrecover_w4, mrecover_l5, mrecover_w5,
				mrecover_l11, mrecover_w11, mrecover_l21, mrecover_w21, mrecover_l31, mrecover_w31, mrecover_l41, mrecover_w41, mrecover_l51, mrecover_w51, mrecover_note,
				mgrowth_l1, mgrowth_w1, mgrowth_l2, mgrowth_w2, mrec_growth_l1, mrec_growth_w1, mrec_growth_l2, mrec_growth_w2, mgrowth_note,
				mapper_ch1, mapper_ch2, mapper_ch3, mapper_cc1, mapper_cc2, mapper_cc3, mapper_st, mapper_st2, mapper_st3,
				mapper_pf1, mapper_pf2, mapper_pf3, mapper_pb1, mapper_pb2, mapper_pb3,
				mapper_acetate, mapper_cotton, mapper_nylon, mapper_poly, mapper_acrylic, mapper_wool, mapper_note,
				mfibre_transfer, mfibre_grade, mfibre_note, modour, modour_note,
				tgl_update
			) VALUES (
				?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,
			...
			";
		$paramspy_mi = [
			$rcek['id'], $_POST['mflamability'], $_POST['mfla_note'], $_POST['mfc_cott'], $_POST['mfc_poly'], $_POST['mfc_ela'],
			$_POST['mfc_cott1'], $_POST['mfc_poly1'], $_POST['mfc_ela1'], $_POST['std_mfc_cott1'], $_POST['std_mfc_poly1'], $_POST['std_mfc_elastane1'],
			$_POST['mfibercontent'], $_POST['mfiber_note'], $_POST['mwpi'], $_POST['mcpi'], $_POST['mfc_note'],
			$_POST['mfabric_weight'], $_POST['mfwe_note'], $_POST['mfabric_width'], $_POST['mfwi_note'],
			$_POST['mbow'], $_POST['mskew'], $_POST['mbas_note'], $_POST['mh_shrinkage_temp'], $_POST['mh_shrinkage_l1'], $_POST['mh_shrinkage_w1'],
			$_POST['mh_shrinkage_grd'], $_POST['mh_shrinkage_app'], $_POST['mh_shrinkage_note'], $_POST['mss_temp'], $_POST['mss_washes3'], $_POST['mss_washes10'], $_POST['mss_washes15'], $_POST['mss_cmt'],
			...
			$_POST['mapperss_ch1'], $_POST['mapperss_ch2'], $_POST['mapperss_ch3'], $_POST['mapperss_ch4'], $_POST['mapperss_cc1'], $_POST['mapperss_cc2'], $_POST['mapperss_cc3'], $_POST['mapperss_cc4'],
			$_POST['mapperss_st'], $_POST['mapperss_pf1'], $_POST['mapperss_pf2'], $_POST['mapperss_pf3'], $_POST['mapperss_pf4'], $_POST['mapperss_pb1'], $_POST['mapperss_pb2'], $_POST['mapperss_pb3'], $_POST['mapperss_pb4'],
			$_POST['mapperss_sf1'], $_POST['mapperss_sf2'], $_POST['mapperss_sf3'], $_POST['mapperss_sf4'], $_POST['mapperss_sb1'], $_POST['mapperss_sb2'], $_POST['mapperss_sb3'], $_POST['mapperss_sb4'],
			$_POST['mapperss_note'], $_POST['mpillingm_f1'], $_POST['mpillingm_b1'], $_POST['mpillingm_f2'], $_POST['mpillingm_b2'], $_POST['mpillingm_f3'], $_POST['mpillingm_b3'], $_POST['mpillingm_f4'], $_POST['mpillingm_b4'], $_POST['mpillingm_f5'], $_POST['mpillingm_b5'], $_POST['mpillm_note'],
			...
			$_POST['mabr'], $_POST['mabr_note'], $_POST['msnaggingm_l1'], $_POST['msnaggingm_w1'], $_POST['msnaggingm_l2'], $_POST['msnaggingm_w2'], $_POST['msnaggingm_l3'], $_POST['msnaggingm_w3'], $_POST['msnaggingm_l4'], $_POST['msnaggingm_w4'], $_POST['msnam_note'],
			$_POST['msp_grdl1'], $_POST['msp_clsl1'], $_POST['msp_shol1'], $_POST['msp_medl1'], $_POST['msp_lonl1'], $_POST['msp_grdw1'], $_POST['msp_clsw1'], $_POST['msp_show1'], $_POST['msp_medw1'], $_POST['msp_lonw1'],
			$_POST['msp_grdl2'], $_POST['msp_clsl2'], $_POST['msp_shol2'], $_POST['msp_medl2'], $_POST['msp_lonl2'], $_POST['msp_grdw2'], $_POST['msp_clsw2'], $_POST['msp_show2'], $_POST['msp_medw2'], $_POST['msp_lonw2'], $_POST['msnap_note'],
			...
			$_POST['mstretch_l1'], $_POST['mstretch_w1'], $_POST['mstretch_l2'], $_POST['mstretch_w2'], $_POST['mstretch_l3'], $_POST['mstretch_w3'], $_POST['mstretch_l4'], $_POST['mstretch_w4'], $_POST['mstretch_l5'], $_POST['mstretch_w5'], $_POST['mload_stretch'], $_POST['mstretch_note'],
			$_POST['mrecover_l1'], $_POST['mrecover_w1'], $_POST['mrecover_l2'], $_POST['mrecover_w2'], $_POST['mrecover_l3'], $_POST['mrecover_w3'], $_POST['mrecover_l4'], $_POST['mrecover_w4'], $_POST['mrecover_l5'], $_POST['mrecover_w5'],
			$_POST['mrecover_l11'], $_POST['mrecover_w11'], $_POST['mrecover_l21'], $_POST['mrecover_w21'], $_POST['mrecover_l31'], $_POST['mrecover_w31'], $_POST['mrecover_l41'], $_POST['mrecover_w41'], $_POST['mrecover_l51'], $_POST['mrecover_w51'], $_POST['mrecover_note'],
			$_POST['mgrowth_l1'], $_POST['mgrowth_w1'], $_POST['mgrowth_l2'], $_POST['mgrowth_w2'], $_POST['mrec_growth_l1'], $_POST['mrec_growth_w1'], $_POST['mrec_growth_l2'], $_POST['mrec_growth_w2'], $_POST['mgrowth_note'],
			$_POST['mapper_ch1'], $_POST['mapper_ch2'], $_POST['mapper_ch3'], $_POST['mapper_cc1'], $_POST['mapper_cc2'], $_POST['mapper_cc3'], $_POST['mapper_st'], $_POST['mapper_st2'], $_POST['mapper_st3'],
			$_POST['mapper_pf1'], $_POST['mapper_pf2'], $_POST['mapper_pf3'], $_POST['mapper_pb1'], $_POST['mapper_pb2'], $_POST['mapper_pb3'],
			$_POST['mapper_acetate'], $_POST['mapper_cotton'], $_POST['mapper_nylon'], $_POST['mapper_poly'], $_POST['mapper_acrylic'], $_POST['mapper_wool'], $_POST['mapper_note'],
			$_POST['mfibre_transfer'], $_POST['mfibre_grade'], $_POST['mfibre_note'], $_POST['modour'], $_POST['modour_note']
		];

	$sqlPHYMI = sqlsrv_query($con_db_qc_sqlsrv, $sqlpy_mi, $paramspy_mi);

	$sqlpy_i = "
		INSERT INTO db_qc.tbl_tq_test (
			id_nokk, flamability, fla_note, fc_cott, fc_poly, fc_elastane,
			fc_cott1, fc_poly1, fc_elastane1, std_fc_cott1, std_fc_poly1, std_fc_elastane1,
			fibercontent, fiber_note, fc_wpi, fc_cpi, fc_note,
			f_weight, fwe_note, f_width, fwi_note, bow, skew, bas_note,
			...
			apperss_ch1, apperss_ch2, apperss_ch3, apperss_ch4, apperss_cc1, apperss_cc2, apperss_cc3, apperss_cc4,
			apperss_st, apperss_pf1, apperss_pf2, apperss_pf3, apperss_pf4, apperss_pb1, apperss_pb2, apperss_pb3, apperss_pb4,
			apperss_sf1, apperss_sf2, apperss_sf3, apperss_sf4, apperss_sb1, apperss_sb2, apperss_sb3, apperss_sb4,
			apperss_note, pm_f1, pm_b1, pm_f2, pm_b2, pm_f3, pm_b3, pm_f4, pm_b4, pm_f5, pm_b5, pillm_note,
			...
			abration, abr_note, sm_l1, sm_w1, sm_l2, sm_w2, sm_l3, sm_w3, sm_l4, sm_w4, snam_note,
			sp_grdl1, sp_clsl1, sp_shol1, sp_medl1, sp_lonl1, sp_grdw1, sp_clsw1, sp_show1, sp_medw1, sp_lonw1,
			sp_grdl2, sp_clsl2, sp_shol2, sp_medl2, sp_lonl2, sp_grdw2, sp_clsw2, sp_show2, sp_medw2, sp_lonw2, snap_note,
			...
			stretch_l1, stretch_w1, stretch_l2, stretch_w2, stretch_l3, stretch_w3, stretch_l4, stretch_w4, stretch_l5, stretch_w5, load_stretch, stretch_note,
			recover_l1, recover_w1, recover_l2, recover_w2, recover_l3, recover_w3, recover_l4, recover_w4, recover_l5, recover_w5,
			recover_l11, recover_w11, recover_l21, recover_w21, recover_l31, recover_w31, recover_l41, recover_w41, recover_l51, recover_w51, recover_note,
			growth_l1, growth_w1, growth_l2, growth_w2, rec_growth_l1, rec_growth_w1, rec_growth_l2, rec_growth_w2, growth_note,
			apper_ch1, apper_ch2, apper_ch3, apper_cc1, apper_cc2, apper_cc3, apper_st, apper_st2, apper_st3,
			apper_pf1, apper_pf2, apper_pf3, apper_pb1, apper_pb2, apper_pb3,
			apper_acetate, apper_cotton, apper_nylon, apper_poly, apper_acrylic, apper_wool, apper_note,
			fibre_transfer, fibre_grade, fibre_note, odour, odour_note, curling, curling_note, nedle, nedle_note,
			stat_fla, stat_fib, stat_fc, stat_fwss, stat_fwss2, stat_fwss3, stat_bsk, stat_pm, stat_pl, stat_pb, stat_prt,
			stat_abr, stat_sm, stat_sp, stat_sb, stat_bs, stat_bs2, stat_bs3, stat_th, stat_sr, stat_gr, stat_ap, stat_hs,
			stat_ff, stat_odour, stat_curling, stat_nedle,
	...
	$paramspy_i = [
		$rcek['id'], $_POST['flamability'], $_POST['fla_note'], $_POST['fc_cott'], $_POST['fc_poly'], $_POST['fc_ela'],
		$_POST['fc_cott1'], $_POST['fc_poly1'], $_POST['fc_ela1'], $_POST['std_fc_cott1'], $_POST['std_fc_poly1'], $_POST['std_fc_ela1'],
		$_POST['fibercontent'], $_POST['fiber_note'], $_POST['wpi'], $_POST['cpi'], $_POST['fc_note'],
		$_POST['fabric_weight'], $_POST['fwe_note'], $_POST['fabric_width'], $_POST['fwi_note'], $_POST['bow'], $_POST['skew'], $_POST['bas_note'],
		...
		$_POST['apperss_ch1'], $_POST['apperss_ch2'], $_POST['apperss_ch3'], $_POST['apperss_ch4'], $_POST['apperss_cc1'], $_POST['apperss_cc2'], $_POST['apperss_cc3'], $_POST['apperss_cc4'],
		$_POST['apperss_st'], $_POST['apperss_pf1'], $_POST['apperss_pf2'], $_POST['apperss_pf3'], $_POST['apperss_pf4'], $_POST['apperss_pb1'], $_POST['apperss_pb2'], $_POST['apperss_pb3'], $_POST['apperss_pb4'],
		$_POST['apperss_sf1'], $_POST['apperss_sf2'], $_POST['apperss_sf3'], $_POST['apperss_sf4'], $_POST['apperss_sb1'], $_POST['apperss_sb2'], $_POST['apperss_sb3'], $_POST['apperss_sb4'],
		$_POST['apperss_note'], $_POST['pillingm_f1'], $_POST['pillingm_b1'], $_POST['pillingm_f2'], $_POST['pillingm_b2'], $_POST['pillingm_f3'], $_POST['pillingm_b3'], $_POST['pillingm_f4'], $_POST['pillingm_b4'], $_POST['pillingm_f5'], $_POST['pillingm_b5'], $_POST['pillm_note'],
		...
		$_POST['abr'], $_POST['abr_note'], $_POST['snaggingm_l1'], $_POST['snaggingm_w1'], $_POST['snaggingm_l2'], $_POST['snaggingm_w2'], $_POST['snaggingm_l3'], $_POST['snaggingm_w3'], $_POST['snaggingm_l4'], $_POST['snaggingm_w4'], $_POST['snam_note'],
		$_POST['sp_grdl1'], $_POST['sp_clsl1'], $_POST['sp_shol1'], $_POST['sp_medl1'], $_POST['sp_lonl1'], $_POST['sp_grdw1'], $_POST['sp_clsw1'], $_POST['sp_show1'], $_POST['sp_medw1'], $_POST['sp_lonw1'],
		$_POST['sp_grdl2'], $_POST['sp_clsl2'], $_POST['sp_shol2'], $_POST['sp_medl2'], $_POST['sp_lonl2'], $_POST['sp_grdw2'], $_POST['sp_clsw2'], $_POST['sp_show2'], $_POST['sp_medw2'], $_POST['sp_lonw2'], $_POST['snap_note'],
		...
		$_POST['stretch_l1'], $_POST['stretch_w1'], $_POST['stretch_l2'], $_POST['stretch_w2'], $_POST['stretch_l3'], $_POST['stretch_w3'], $_POST['stretch_l4'], $_POST['stretch_w4'], $_POST['stretch_l5'], $_POST['stretch_w5'], $_POST['load_stretch'], $_POST['stretch_note'],
		...
		$_POST['recover_l11'], $_POST['recover_w11'], $_POST['recover_l21'], $_POST['recover_w21'], $_POST['recover_l31'], $_POST['recover_w31'], $_POST['recover_l41'], $_POST['recover_w41'], $_POST['recover_l51'], $_POST['recover_w51'], $_POST['recover_note'],
		$_POST['growth_l1'], $_POST['growth_w1'], $_POST['growth_l2'], $_POST['growth_w2'], $_POST['rec_growth_l1'], $_POST['rec_growth_w1'], $_POST['rec_growth_l2'], $_POST['rec_growth_w2'], $_POST['growth_note'],
		$_POST['apper_ch1'], $_POST['apper_ch2'], $_POST['apper_ch3'], $_POST['apper_cc1'], $_POST['apper_cc2'], $_POST['apper_cc3'], $_POST['apper_st'], $_POST['apper_st2'], $_POST['apper_st3'],
		$_POST['apper_pf1'], $_POST['apper_pf2'], $_POST['apper_pf3'], $_POST['apper_pb1'], $_POST['apper_pb2'], $_POST['apper_pb3'],
		$_POST['apper_acetate'], $_POST['apper_cotton'], $_POST['apper_nylon'], $_POST['apper_poly'], $_POST['apper_acrylic'], $_POST['apper_wool'], $_POST['apper_note'],
		$_POST['fibre_transfer'], $_POST['fibre_grade'], $_POST['fibre_note'], $_POST['odour'], $_POST['odour_note'], $_POST['curling'], $_POST['curling_note'], $_POST['nedle'], $_POST['nedle_note'],
		$_POST['stat_fla'], $_POST['stat_fib'], $_POST['stat_fc'], $_POST['stat_fwss'], $_POST['stat_fwss2'], $_POST['stat_fwss3'], $_POST['stat_bsk'], $_POST['stat_pm'], $_POST['stat_pl'], $_POST['stat_pb'], $_POST['stat_prt'],
		$_POST['stat_abr'], $_POST['stat_sm'], $_POST['stat_sp'], $_POST['stat_sb'], $_POST['stat_bs'], $_POST['stat_bs2'], $_POST['stat_bs3'], $_POST['stat_th'], $_POST['stat_sr'], $_POST['stat_gr'], $_POST['stat_ap'], $_POST['stat_hs'],
		$_POST['stat_ff'], $_POST['stat_odour'], $_POST['stat_curling'], $_POST['stat_nedle'],
		...
		$_POST['ph'], $_POST['ph_note'], $_POST['soil'], $_POST['soil_note']
	];

	$sqlPHY = sqlsrv_query($con_db_qc_sqlsrv, $sqlpy_i, $paramspy_i);
...
if ($_POST['colorfastness_save'] == "save" and $cek1 > 0) {
	$sqlcl_u = "UPDATE db_qc.tbl_tq_test SET
			wash_temp=?, wash_colorchange=?, wash_acetate=?, wash_cotton=?, wash_nylon=?, 
			wash_poly=?, wash_acrylic=?, wash_wool=?, wash_staining=?, wash_note=?, 
			water_colorchange=?, water_acetate=?, water_cotton=?, water_nylon=?, water_poly=?, 
			water_acrylic=?, water_wool=?, water_staining=?, water_note=?, acid_colorchange=?, 
			acid_acetate=?, acid_cotton=?, acid_nylon=?, acid_poly=?, acid_acrylic=?, 
			acid_wool=?, acid_staining=?, acid_note=?, alkaline_colorchange=?, alkaline_acetate=?, 
			alkaline_cotton=?, alkaline_nylon=?, alkaline_poly=?, alkaline_acrylic=?, alkaline_wool=?, 
			alkaline_staining=?, alkaline_note=?, crock_len1=?, crock_wid1=?, crock_len2=?, 
			crock_wid2=?, crock_note=?, phenolic_colorchange=?, phenolic_note=?, cm_printing_colorchange=?, 
			cm_printing_staining=?, cm_printing_note=?, cm_dye_temp=?, cm_dye_colorchange=?, cm_dye_stainingface=?, 
			cm_dye_stainingback=?, cm_dye_note=?, light_rating1=?, light_rating2=?, light_note=?, 
			light_pers_colorchange=?, light_pers_note=?, saliva_staining=?, saliva_note=?, bleeding=?, 
			bleeding_note=?, chlorin=?, nchlorin1=?, nchlorin2=?, chlorin_note=?, 
			dye_tf_sstaining=?, dye_tf_cstaining=?, dye_tf_acetate=?, dye_tf_cotton=?, dye_tf_nylon=?, 
			dye_tf_poly=?, dye_tf_acrylic=?, dye_tf_wool=?, dye_tf_note=?, stat_wf=?, 
			stat_wtr=?, stat_pac=?, stat_pal=?, stat_cr=?, stat_py=?, 
			stat_cmo=?, stat_cm=?, stat_lg=?, stat_lp=?, stat_slv=?, 
			stat_bld=?, stat_chl=?, stat_nchl=?, stat_dye=?, 
			sco_acid_original=?, sco_acid_status=?, sca_acid_original=?, sca_acid_status=?, 
			sco_alkaline_afterwash=?, sco_alkaline_status=?, sca_alkaline_afterwash=?, 
			sca_alkaline_status=?, sc_note=?, tgl_update=GETDATE()
		WHERE id_nokk = ?";
	$paramscl_u = [
			$_POST['wash_temp'], $_POST['wash_colorchange'], $_POST['wash_acetate'], $_POST['wash_cotton'], $_POST['wash_nylon'],
			$_POST['wash_poly'], $_POST['wash_acrylic'], $_POST['wash_wool'], $_POST['wash_staining'], $_POST['wash_note'],
			$_POST['water_colorchange'], $_POST['water_acetate'], $_POST['water_cotton'], $_POST['water_nylon'], $_POST['water_poly'],
			$_POST['water_acrylic'], $_POST['water_wool'], $_POST['water_staining'], $_POST['water_note'], $_POST['acid_colorchange'],
			$_POST['acid_acetate'], $_POST['acid_cotton'], $_POST['acid_nylon'], $_POST['acid_poly'], $_POST['acid_acrylic'],
			$_POST['acid_wool'], $_POST['acid_staining'], $_POST['acid_note'], $_POST['alkaline_colorchange'], $_POST['alkaline_acetate'],
			$_POST['alkaline_cotton'], $_POST['alkaline_nylon'], $_POST['alkaline_poly'], $_POST['alkaline_acrylic'], $_POST['alkaline_wool'],
			$_POST['alkaline_staining'], $_POST['alkaline_note'], $_POST['crock_len1'], $_POST['crock_wid1'], $_POST['crock_len2'],
			$_POST['crock_wid2'], $_POST['crock_note'], $_POST['phenolic_colorchange'], $_POST['phenolic_note'], $_POST['cm_printing_colorchange'],
			$_POST['cm_printing_staining'], $_POST['cm_printing_note'], $_POST['cm_dye_temp'], $_POST['cm_dye_colorchange'], $_POST['cm_dye_stainingface'],
			$_POST['cm_dye_stainingback'], $_POST['cm_dye_note'], $_POST['light_rating1'], $_POST['light_rating2'], $_POST['light_note'],
			$_POST['light_pers_colorchange'], $_POST['light_pers_note'], $_POST['saliva_staining'], $_POST['saliva_note'], $_POST['bleeding'],
			$_POST['bleeding_note'], $_POST['chlorin'], $_POST['nchlorin1'], $_POST['nchlorin2'], $_POST['chlorin_note'],
			$_POST['dye_tf_sstaining'], $_POST['dye_tf_cstaining'], $_POST['dye_tf_acetate'], $_POST['dye_tf_cotton'], $_POST['dye_tf_nylon'],
			$_POST['dye_tf_poly'], $_POST['dye_tf_acrylic'], $_POST['dye_tf_wool'], $_POST['dye_tf_note'], $_POST['stat_wf'],
			$_POST['stat_wtr'], $_POST['stat_pac'], $_POST['stat_pal'], $_POST['stat_cr'], $_POST['stat_py'],
			$_POST['stat_cmo'], $_POST['stat_cm'], $_POST['stat_lg'], $_POST['stat_lp'], $_POST['stat_slv'],
			$_POST['stat_bld'], $_POST['stat_chl'], $_POST['stat_nchl'], $_POST['stat_dye'],
			$sco_original, $_POST['sco_acid_status'], $sca_acid, $_POST['sca_acid_status'],
			$sco_alkaline_afterwash, $_POST['sco_alkaline_status'], $sca_alkaline_afterwash,
			$_POST['sca_alkaline_status'], $_POST['sc_note'],
			$rcek['id'] // Primary Key untuk WHERE
		];
	$sqlCLR = sqlsrv_query($con_db_qc_sqlsrv, $sqlcl_u, $paramscl_u);

    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <div class="pull-right">
            ...
            <a href="pages/cetak/report_grouping_form.php?awal=<?php echo $Awal; ?>&akhir=<?php echo $Akhir; ?>&no_order=<?php echo $Order; ?>&no_po=<?php echo $PO; ?>&item=<?php echo $Item; ?>&warna=<?php echo $Warna; ?>&langganan=<?php echo $Langganan; ?>&delay=<?php echo $Delay; ?>&demand=<?php echo $Demand; ?>&prodorder=<?php echo $Prodorder; ?>" class="btn btn-primary" target="_blank">Cetak Groping Form CQA</a> 
        </div>

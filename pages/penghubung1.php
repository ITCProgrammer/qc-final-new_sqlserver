<table class="newbonpenghubung">
  <tr>
	...
	<select class="form-control select2" name="penghubung_masalah" id="kategori" style="width:150px">
			<?php if($cek>0){ 
				if ($rcek['penghubung_masalah'] !='') { ?>
					<option selected value="<?=$rcek['penghubung_masalah']?>" ><?=$rcek['penghubung_masalah']?></option>	
				<?php }
	...
	<input type="text" name="penghubung_keterangan" placeholder="Notes" style="width:150px" value="<?=$rcek['penghubung_keterangan']?>">
	</td>
  </tr>
...
<tr>
  ...
  <tr>
    <td>Roll</td>
    <td>
      <input type="text" name="penghubung_roll1" placeholder="0" style="width:50px" value="<?=$rcek['penghubung_roll1']?>">
      <input type="text" name="penghubung_roll2" placeholder="KG" style="width:50px" value="<?=$rcek['penghubung_roll2']?>">
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="text" name="penghubung_roll3" placeholder="0.00" style="width:50px" value="<?=$rcek['penghubung_roll3']?>">
    
	 <select class="form-control select2" name="penghubung_roll4"  style="width:80px">
  ...
  <tr>
	...
	<select  style="width:250px" class="form-control select2" multiple="multiple" data-placeholder="Max 3 Depart" name="penghubung_dep[]" id="t_jawab">
						<?php

						$a = $rcek['penghubung_dep'] ; 

        ...
        <div class="col-md-6">
            <div class="form-group">
				...
				function handleChange() {
                    ...
                    value="<?php echo $rd['no_report_fl'];?>" placeholder="No Report FL" required>
                </div>
            </div> 
            <div class="form-group">
                <label for="nodemand" class="col-sm-3 control-label">No Demand</label>
                <div class="col-sm-8">
                    <input name="nodemand" type="text" class="form-control" id="nodemand" placeholder="No Demand" value="<?php if($rd['nodemand_new']!=''){echo $rd['nodemand_new'];}else if($rd['nodemand_new']==''){echo $rd['nodemand'];}else {echo $_GET['nodemand'];}?>" onchange="window.location='SummaryTQNokkNewFL-'+this.value" required>
                </div>				   
            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <select name="status" class="form-control select2" id="status" style="width: 100%;" <?php if($rcek1['status']!='' AND $_SESSION['nama1']!='Janu Dwi Laksono'){echo "disabled";}?>>
                                    ...
                                    <option <?php if($rcek1['status']=="Ganti Kain"){?> selected=selected <?php };?>value="Ganti Kain">Ganti Kain</option>

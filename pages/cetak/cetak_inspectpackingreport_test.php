...
<table width="100%" border="0">
    ...
    <tr>
      <td><table width="100%" border="0" class="table-list1">
        ...
        <?php }?>
        <?php if(strlen($rd['ITEMDESCRIPTION']) > 40 AND strlen($rd['ITEMDESCRIPTION']) < 100){?>
        <tr>
                <td style="border-top:0px #000000 solid; 
                    border-left:0px #000000 solid;  
                    border-right:0px #000000 solid; 
    ...
    <tr>
      <td><table width="100%" border="1" class="table-list1">
        ...
        <tr>
                ...
                <td width ="2%" align="center"><font size="-2">&nbsp;</font></td>
                <td width ="2%" align="center"><font size="-2">&nbsp;</font></td>
                <td width ="3%" rowspan="4" colspan ="3" align="center"><font size="-2"><?php if($rowdtl['ELEMENTSINSPECTIONELEMENTCODE']!='') echo '<img src="../../php-barcode-master/barcode.php?text=' . $rowdtl['ELEMENTSINSPECTIONELEMENTCODE'] . '&print=true&size=30&codetype=codabar" />'; ?></font></td>
        ...
        <tr>
                <td width ="8%" align="left"><font size="-2">Point</td>

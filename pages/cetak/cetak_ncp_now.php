...
if ($_GET['id'] != "") {
	...
	$qry = sqlsrv_query($con_db_qc_sqlsrv, "SELECT * FROM db_qc.tbl_ncp_qcf_now WHERE no_ncp_gabungan='$_GET[no_ncp_gabungan]' ORDER BY revisi DESC ");
	//$qry=sqlsrv_query($con_db_qc_sqlsrv,"SELECT * FROM tbl_ncp_qcf_new WHERE no_ncp='$_GET[no_ncp]' and dept='$_GET[dept]' and nokk='$_GET[nokk]' and revisi='$_GET[revisi]' ORDER BY revisi DESC ");	
}

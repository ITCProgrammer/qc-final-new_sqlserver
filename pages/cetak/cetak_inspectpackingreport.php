...
<title>Cetak Inspection Report Packing QC</title>
<script>
    ...
    <tr>
      <td><table width="100%" border="1" class="table-list1">
        ...
        <tr>
                ...
                <td width="5%" rowspan="11" align="center" valign="center"><font size="-1">DEFECT CODE NAME</font></td>
        ...
        while($rowdtl = db2_fetch_assoc($stmt2)){
                ...
                $sqlcmt="SELECT 
                ADSTORAGE.UNIQUEID,
                TRIM(ADSTORAGE.VALUESTRING) AS VALUESTRING
        ...
        <tr>
                ...
                <td width ="8%" align="left" style="font-size:8px;">Defect</td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def1=="001"){echo "-";}else{echo $def1;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def2=="001"){echo "-";}else{echo $def2;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def3=="001"){echo "-";}else{echo $def3;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def4=="001"){echo "-";}else{echo $def4;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def5=="001"){echo "-";}else{echo $def5;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def6=="001"){echo "-";}else{echo $def6;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def7=="001"){echo "-";}else{echo $def7;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def8=="001"){echo "-";}else{echo $def8;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def9=="001"){echo "-";}else{echo $def9;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def10=="001"){echo "-";}else{echo $def10;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def11=="001"){echo "-";}else{echo $def11;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def12=="001"){echo "-";}else{echo $def12;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def13=="001"){echo "-";}else{echo $def13;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def14=="001"){echo "-";}else{echo $def14;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def15=="001"){echo "-";}else{echo $def15;}?></td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
                ...
                <td width ="12%" rowspan="4" align="left" valign="top" style="font-size:6px;"><?php echo $rowcmt['VALUESTRING'];?></td>
        </tr>
        <tr>
                <td width ="8%" align="left" style="font-size:8px;">Position L</td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def1=="001"){echo "-";}else{echo $posnl1;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def2=="001"){echo "-";}else{echo $posnl2;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def3=="001"){echo "-";}else{echo $posnl3;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def4=="001"){echo "-";}else{echo $posnl4;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def5=="001"){echo "-";}else{echo $posnl5;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def6=="001"){echo "-";}else{echo $posnl6;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def7=="001"){echo "-";}else{echo $posnl7;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def8=="001"){echo "-";}else{echo $posnl8;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def9=="001"){echo "-";}else{echo $posnl9;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def10=="001"){echo "-";}else{echo $posnl10;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def11=="001"){echo "-";}else{echo $posnl11;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def12=="001"){echo "-";}else{echo $posnl12;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def13=="001"){echo "-";}else{echo $posnl13;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def14=="001"){echo "-";}else{echo $posnl14;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def15=="001"){echo "-";}else{echo $posnl15;}?></td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
        ...
        <tr>
                <td width ="5%" rowspan="2" align="center"><font size="-1"><?php if($rowdtl['VALUEDECIMAL']!=""){echo number_format($rowdtl['VALUEDECIMAL'],2);}else{}?></font></td>
                <td width ="5%" rowspan="2" align="center"><font size="-1"><?php if($rowdtl['WEIGHTNET']!=""){echo number_format($rowdtl['WEIGHTNET'],2);}else{}?></font></td>
                <td width ="8%" align="left" style="font-size:8px;">Position W</td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def1=="001"){echo "-";}else{echo $posnw1;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def2=="001"){echo "-";}else{echo $posnw2;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def3=="001"){echo "-";}else{echo $posnw3;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def4=="001"){echo "-";}else{echo $posnw4;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def5=="001"){echo "-";}else{echo $posnw5;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def6=="001"){echo "-";}else{echo $posnw6;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def7=="001"){echo "-";}else{echo $posnw7;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def8=="001"){echo "-";}else{echo $posnw8;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def9=="001"){echo "-";}else{echo $posnw9;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def10=="001"){echo "-";}else{echo $posnw10;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def11=="001"){echo "-";}else{echo $posnw11;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def12=="001"){echo "-";}else{echo $posnw12;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def13=="001"){echo "-";}else{echo $posnw13;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def14=="001"){echo "-";}else{echo $posnw14;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def15=="001"){echo "-";}else{echo $posnw15;}?></td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
        ...
        <tr>
                <td width ="8%" align="left" style="font-size:8px;">Point</td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def1=="001" OR $poin1==".0000"){echo "-";}else{echo $poin1;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def2=="001" OR $poin2==".0000"){echo "-";}else{echo $poin2;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def3=="001" OR $poin3==".0000"){echo "-";}else{echo $poin3;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def4=="001" OR $poin4==".0000"){echo "-";}else{echo $poin4;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def5=="001" OR $poin5==".0000"){echo "-";}else{echo $poin5;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def6=="001" OR $poin6==".0000"){echo "-";}else{echo $poin6;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def7=="001" OR $poin7==".0000"){echo "-";}else{echo $poin7;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def8=="001" OR $poin8==".0000"){echo "-";}else{echo $poin8;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def9=="001" OR $poin9==".0000"){echo "-";}else{echo $poin9;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def10=="001" OR $poin10==".0000"){echo "-";}else{echo $poin10;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def11=="001" OR $poin11==".0000"){echo "-";}else{echo $poin11;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def12=="001" OR $poin12==".0000"){echo "-";}else{echo $poin12;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def13=="001" OR $poin13==".0000"){echo "-";}else{echo $poin13;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def14=="001" OR $poin14==".0000"){echo "-";}else{echo $poin14;}?></td>
                <td width ="2%" align="center" style="font-size:8px;"><?php if($def15=="001" OR $poin15==".0000"){echo "-";}else{echo $poin15;}?></td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>
                <td width ="2%" align="center" style="font-size:8px;">&nbsp;</td>

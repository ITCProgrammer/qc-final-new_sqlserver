...
<body>
    ...
    <table width="100%" border="1" class="table-list1">
        <thead>
            <tr>
                <th rowspan="2" colspan="5" align="center">BOW & SKEW</th>
                <th colspan="2" align="center">SHIFT A</th>
                <th colspan="2" align="center">SHIFT B</th>
                <th colspan="2" align="center">SHIFT C</th>
            </tr>
            <tr>
                <th rowspan="2" align="center">BOW</th>
                <th rowspan="2" align="center">SKEW</th>
                <th rowspan="2" align="center">BOW</th>
                <th rowspan="2" align="center">SKEW</th>
                <th rowspan="2" align="center">BOW</th>
                <th rowspan="2" align="center">SKEW</th>
        ...
        <tbody>
            <?php
                $query=sqlsrv_query($con_db_qc_sqlsrv,"SELECT no_item ,MAX(no_hanger) no_hanger FROM db_qc.tbl_tq_randomtest WHERE CONVERT(DATE, tgl_update ) BETWEEN '$Awal' AND '$Akhir' AND rbow!='' GROUP BY no_item ");

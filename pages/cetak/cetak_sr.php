...
<title>Cetak Stretch And Recovery</title>
<script>
...
<body>
    ...
    <table width="100%" border="1" class="table-list1">
        <thead>
            <tr>
                <th colspan="5" align="center">STRETCH AND RECOVERY</th>
                <th colspan="8" align="center">SHIFT A</th>
                <th colspan="8" align="center">SHIFT B</th>
                <th colspan="8" align="center">SHIFT C</th>
                <th rowspan="2" colspan="4" align="center">SUM GRADE</th>
            </tr>
            <tr>
                <th rowspan="3" align="center">ITEM</th>
                <th rowspan="3" align="center">DESCRIPTION</th>
                <th rowspan="3" align="center">BUYER</th>
                <th rowspan="3" align="center">WIDTH</th>
                <th rowspan="3" align="center">GSM</th>
                <th rowspan="3" align="center">ORDER</th>
                <th rowspan="3" align="center">COLOR</th>
                <th colspan="4" align="center">GRADE</th>
            ...
            <tr>
                <th colspan="2" align="center">STRETCH</th>
                <th colspan="2" align="center">RECOVERY</th>
                <th rowspan="2" align="center">PREPARE</th>
                <th rowspan="2" align="center">TESTING</th>
                <th colspan="2" align="center">STRETCH</th>
                <th colspan="2" align="center">RECOVERY</th>
                <th rowspan="2" align="center">PREPARE</th>
                <th rowspan="2" align="center">TESTING</th>
        ...
        <tbody>
            <?php
                $query=sqlsrv_query($con_db_qc_sqlsrv,"SELECT no_item ,MAX(no_hanger) no_hanger FROM db_qc.tbl_tq_randomtest WHERE CONVERT(DATE, tgl_update ) BETWEEN '$Awal' AND '$Akhir' AND (rstretch_l1!='' OR rstretch_w1!='' OR rrecover_l1!='' OR rrecover_w1!='') GROUP BY no_item ");

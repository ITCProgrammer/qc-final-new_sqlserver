...
///header("Content-Disposition: attachment; filename=masterdata-fl-".substr($_GET['awal'],0,10).".xls");//ganti nama sesuai keperluan
...
$Akhir = date('Y-m-d', strtotime($_GET['akhir'])) . ' 23:59:59';
?></strong><br>
<table width="100%" border="1">
  ...
  ");
    ...
    <tr>
      ...
      <td>'<?php echo $r['lot_new'];?></td>
      <td><?php echo $r['warna'];?></td>
      <td>'<?php echo $r['kk_legacy'];?></td>

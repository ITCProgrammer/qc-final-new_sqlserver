...
<title>Cetak Inspection Report QC For Customer</title>
<script>
...
<table width="100%" border="0">
    ...
    <tr>
      <td><table width="100%" border="1" class="table-list1">
        ...
        ?>
        <tr>
                <td width ="10%" colspan="2" align="center"><font size="-1"><?php echo substr($rowdtl['ELEMENTSINSPECTIONELEMENTCODE'],8,3);?></font></td>
        ...
        <tr>
                <td width ="5%" align="center"><font size="-1"><?php if($rowdtl['LENGTHGROSS']!=""){echo number_format($rowdtl['LENGTHGROSS'],2);}else{}?></font></td>

...
<title>Cetak Pilling Martindle</title>
<script>
...
<body>
    ...
    <table width="100%" border="1" class="table-list1">
        <thead>
            <tr>
                <th rowspan="2" colspan="5" align="center">PILLING MARTINDLE</th>
        ...
        <tbody>
            <?php
                $query=sqlsrv_query($con_db_qc_sqlsrv,"SELECT no_item ,MAX(no_hanger) no_hanger FROM db_qc.tbl_tq_randomtest WHERE CONVERT(DATE, tgl_update ) BETWEEN '$Awal' AND '$Akhir' AND (rpm_f1!='' OR rpm_f2!='')  GROUP BY no_item ");

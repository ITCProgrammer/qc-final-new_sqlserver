...
<table width="100%">
            ...
            <td><table width="100%" border="0" class="table-list1">  
                ...
                <tr>
                    <td align="left" style="border-top:0px #000000 solid; 
                                border-bottom:0px #000000 solid;
                                border-left:0px #000000 solid; 
                                border-right:0px #000000 solid;">Test Report No. ITC<?php echo $rd2['no_report_fl'];?></td>
                    <td align="left" style="border-top:0px #000000 solid; 
                                border-bottom:0px #000000 solid;
                                border-left:0px #000000 solid; 
    ...
    <tr>
		...
		<tr>
            ...
            <!--Start-->
            <td align="center" style="font-size: 8px;" ><?=$sco_acid_original[0]?></td>
 ...
 <tr>
   <td align="center" style="font-size: 8px;" ><?=$sca_acid_original[0]?></td>

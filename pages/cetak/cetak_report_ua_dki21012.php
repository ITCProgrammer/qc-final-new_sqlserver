...
<body>
    ...
    <table width="100%" border="1" class="table-list1">
        ...
        <tbody>
            ...
            <tr>
			 ...
			 <tr>
                <td align="left" style="font-size: 12px;">WATER REPPELENT</td>
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_wp']=="PASS" OR $rcek1['stat_wp']=="DISPOSISI"){echo "X";}else{echo "&nbsp;";}?></td>
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_wp']=="FAIL"){echo "X";}else{echo "&nbsp;";}?></td>
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_wp']=="DATA"){echo "X";}else{echo "&nbsp;";}?></td>
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_wp']==""){echo "N/A";}else if($rcek1['stat_wp']!=""){echo '';}else{echo "&nbsp;";}?></td>
            </tr>
        </tbody>
    </table>
    ...
    <table width="100%">
		...
		<!-- SNAGGING BEGIN -->
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3"><strong><u>SNAGGING RESISTANCE OF FABRICS:MACE</u></strong> (ASTM D3939, 300 CYCLES)</td>
        </tr>
        <tr>
    ...
    <table width="100%">
	   ...
	   <tr><!--YA-->
		...
		<tr>
            ...
            <td align="right" style="font-size: 11px;" width="33%">GRADE MIN <?php if($rstd['dye_tf8']!=''){echo $rstd['dye_tf8'];}else{}?></td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">ACETATE</td>
            ...
            <td align="right" style="font-size: 11px;" width="33%">GRADE MIN <?php if($rstd['dye_tf2']!=''){echo $rstd['dye_tf2'];}else{}?></td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">COTTON</td>
		...
		<tr>
            ...
            <td align="right" style="font-size: 11px;" width="33%">GRADE MIN <?php if($rstd['dye_tf6']!=''){echo $rstd['dye_tf6'];}else{}?></td>
        </tr>
		<tr>
            <td align="left" style="font-size: 11px;" width="33%">WOOL</td>
            ...
            <td align="right" style="font-size: 11px;" width="33%">GRADE MIN <?php if($rstd['dye_tf7']!=''){echo $rstd['dye_tf7'];}else{}?></td>
        </tr>
        <!-- DYE TRANSFER END -->
        <tr>
            <td align="center" style="font-size: 12px;" colspan="3">&nbsp;</td>
        ...
        <!-- PILLING LOCUS END -->
		 ...
		 <!-- WATER REPELLENT BEGIN -->
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3"><strong><u>WATER REPPELENT</u></strong> (AATC22)</td>
        </tr>
		
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">Original</td>
            <td align="center" style="font-size: 11px;" width="33%"><?php if($rcek1['stat_wp']=="DISPOSISI"){echo $rcekD['drepp1'];}else if($rcek1['repp1']!=""){echo $rcek1['repp1'];}else{echo "N/A";}?></td>
            <td align="right" style="font-size: 11px;" width="33%">GRADE MIN <?php if($rstd['water_repp1']!=''){echo $rstd['water_repp1'];}else{}?></td>
        </tr>
		<tr>
            <td align="left" style="font-size: 11px;" width="33%">3x Wash</td>
            <td align="center" style="font-size: 11px;" width="33%"><?php if($rcek1['stat_wp']=="DISPOSISI"){echo $rcekD['drepp2'];}else if($rcek1['repp2']!=""){echo $rcek1['repp2'];}else{echo "N/A";}?></td>
            <td align="right" style="font-size: 11px;" width="33%">GRADE MIN <?php if($rstd['water_repp2']!=''){echo $rstd['water_repp2'];}else{}?></td>
        </tr>
		<tr>
            <td align="left" style="font-size: 11px;" width="33%">20x Wash</td>
            <td align="center" style="font-size: 11px;" width="33%"><?php if($rcek1['stat_wp']=="DISPOSISI"){echo $rcekD['drepp_note'];}else if($rcek1['repp_note']!=""){echo $rcek1['repp_note'];}else{echo "N/A";}?></td>
            <td align="right" style="font-size: 11px;" width="33%">GRADE MIN <?php if($rstd['water_repp3']!=''){echo $rstd['water_repp3'];}else{}?></td>
        </tr>
        <!-- WATER REPELLENT END -->

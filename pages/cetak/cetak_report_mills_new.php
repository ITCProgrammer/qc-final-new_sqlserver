...
<table width="100%">
    <thead>
            <td><table width="100%" border="0" class="table-list1">  
                ...
                <tr>
                    <td width="45%" align="left" style="border-top:0px #000000 solid; 
                                border-bottom:0px #000000 solid;
                                border-left:0px #000000 solid; 
                                border-right:0px #000000 solid;">Test Report No. ITC<?php echo $rd2['no_test'];?></td>
                    <td width="38%" align="left" style="border-top:0px #000000 solid; 
                                border-bottom:0px #000000 solid;
                                border-left:0px #000000 solid; 
                                border-right:0px #000000 solid;">Submission No. -</td>
                    <td width="17%" align="right" style="border-top:0px #000000 solid; 
                                border-bottom:0px #000000 solid;
                                border-left:0px #000000 solid; 
                                border-right:0px #000000 solid;">&nbsp;</td>
                </tr>
    ...
    <tr>
		...
		<tr>
            ...
            <td rowspan="4" align="left" valign="top" style="font-size: 8px;"><strong>Sweat Conceal Method</strong><br></td>
            ...
            <td rowspan="4" align="center" style="font-size: 8px;" >&nbsp;</td>
            <td rowspan="4" align="center" style="font-size: 8px;" >&nbsp;</td>
        </tr>
 <tr>
   <td align="left" style="font-size: 8px;" >&nbsp;</td>
 ...
 <tr>
   ...
   <td align="left" style="font-size: 8px;" >Alkaline After 5 Wash (grade)</td>
    ...
    <tr>
        ...
        <tr>
            <td align="left" style="font-size: 8px;" colspan="9" hidden="hidden">*All tests need to follow the adidas "Quality Assurance Test Matrix" according to lab test and most updated version</td>
        </tr>
        <tr>

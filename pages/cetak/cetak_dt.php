...
<body>
    ...
    <table width="100%" border="1" class="table-list1">
        ...
        <tbody>
            <?php
                $query=sqlsrv_query($con_db_qc_sqlsrv,"SELECT no_item ,MAX(no_hanger) no_hanger FROM db_qc.tbl_tq_randomtest WHERE CONVERT(DATE, tgl_update ) BETWEEN '$Awal' AND '$Akhir' AND (rwick_l2!='' OR rwick_w2!='' OR rabsor_b1!='' OR rdryaf1!='') GROUP BY no_item ");

...
<title>Cetak Bursting Strength</title>
<script>
...
<body>
    ...
    <table width="100%" border="1" class="table-list1">
        <thead>
            <tr>
                <th colspan="5" align="center">BURSTING STRENGTH</th>
        ...
        <tbody>
            <?php
                $query=sqlsrv_query($con_db_qc_sqlsrv,"SELECT no_item ,MAX(no_hanger) no_hanger FROM db_qc.tbl_tq_randomtest WHERE CONVERT(DATE, tgl_update ) BETWEEN '$Awal' AND '$Akhir' AND (rbs_instron!='' OR rbs_tru!='' OR rbs_mullen!='') GROUP BY no_item ");

...
$data = sqlsrv_query($con_db_qc_sqlsrv, "
    ...
    LEFT JOIN db_qc.tbl_tq_test_2 t2 ON t.id_nokk = TRY_CAST(t2.id_nokk AS BIGINT) 
    OUTER APPLY (
...
function cekstandart($test, $jns, $protocol)
{
    $test      = strtoupper(trim($test));
    $jns       = strtoupper(trim($jns));
    ...
    if (isset($standards[$test][$jns][$protocol])) {
        return strtoupper(trim($standards[$test][$jns][$protocol]));
    }
    return 'N/A';
}


function hasil($test, $cekstandart, $nilai, $ket)
{
    // =========================
    // 1. Ambil angka standard
    // =========================
    $std = str_replace('MIN GRADE', '', $cekstandart);
    $std = trim($std);

    if (strpos($std, '-') !== false) {
        list($a, $b) = explode('-', $std);
        $standard = ((float)$a + (float)$b) / 2;
        $standardText = trim($std);
    } else {
        $standard = (float)$std;
        $standardText = number_format($standard, 1);
    }

    // =========================
    // 2. Convert nilai actual
    // =========================
    $nilai = trim($nilai);

    if (strpos($nilai, '-') !== false) {
        list($a, $b) = explode('-', $nilai);
        $actual = ((float)$a + (float)$b) / 2;
    } else {
        $actual = (float)$nilai;
    }
    ...
    if ($actual == 0 || $standard == 0) {
        $isFail = false; // Anggap tidak gagal jika salah satu nilai adalah 0
    } else {
        $isFail = $actual < $standard;
    }

    // =========================
    // 4. Return berdasarkan $ket
    // =========================
    if ($ket == 'warna') {
        return $isFail ? 'color:red' : '';
    }

    if ($ket == 'nilai') {
        return !empty($nilai) ? $nilai : 'N/A';
    }
...
<!-- Page 1 Begin -->
        ...
        <tr>
            <td align="right" style="font-size: 12px;">Page 1 of 10</td> 
        </tr>
        <tr>
...
<!-- Page 3 Begin -->
    <table width="100%">
        ...
        <tr>
            <td align="right" style="font-size: 12px;">Page 3 of 10</td> 
        </tr>
        <tr>
            <td align="right" style="font-size: 12px;">
    ...
    <table width="100%" border="1" class="table-list1">
        ...
        <tbody>
            ...
            <tr>
                <td rowspan="2" align="left" style="font-size: 12px;">COLORFASTNESS TO CROCKING</td>
            ...
            <tr>
              <td align="left" style="font-size: 12px;">ISO 105-X12:2016</td>
              <td align="left" style="font-size: 12px;<?php echo (($rcek1['stat_cr2'] ?? '') == 'FAIL') ? 'color:red;font-weight:bold;' : ''; ?>">
                <?php if($rcek1['stat_cr2']=="PASS"){echo "PASS";}
                    else if ($rcek1['stat_cr2'] == "ESS PASS") {
                        echo "ESS PASS";
                    } else if ($rcek1['stat_cr2'] == "FAIL") {
                        echo "FAIL";
                    } else if ($rcek1['stat_cr2'] == "DATA") {
                        echo "DATA ONLY";
                    } else if ($rcek1['stat_cr2'] == "") {
                        echo "N/A";
                    } else if ($rcek1['stat_cr2'] != "") {
                        echo $rcekM['mcrock_note'];
                    } else {
            ...
            <tr>
                <td rowspan="2" align="left" style="font-size: 12px;">COLORFASTNESS TO WATER</td>
            ...
            <tr>
              <td align="left" style="font-size: 12px;">ISO 105-E01:2013</td>
              <td align="left" style="font-size: 12px;<?php echo (($rcek1['stat_wtr2'] ?? '') == 'FAIL') ? 'color:red;font-weight:bold;' : ''; ?>">
                <?php if($rcek1['stat_wtr2']=="PASS"){echo "PASS";}
                    else if ($rcek1['stat_wtr2'] == "ESS PASS") {
                        echo "ESS PASS";
                    } else if ($rcek1['stat_wtr2'] == "FAIL") {
                        echo "FAIL";
                    } else if ($rcek1['stat_wtr2'] == "DATA") {
                        echo "DATA ONLY";
                    } else if ($rcek1['stat_wtr2'] == "") {
                        echo "N/A";
                    } else if ($rcek1['stat_wtr2'] != "") {
                        echo $rcekM['mwater_note2'];
                    } else {
                        echo "N/A";
                    }?></td>
              </td>
            ...
            <tr>
                <td rowspan="2" align="left" style="font-size: 12px;">COLORFASTNESS TO PERSPIRATION</td>
            ...
            <tr>
              <td align="left" style="font-size: 12px;" >ISO 105-E04:2013</td>
              <td align="left" style="font-size: 12px;<?php echo (($rcek1['stat_pac2'] ?? '') == 'FAIL') ? 'color:red;font-weight:bold;' : ''; ?>">
                <?php if($rcek1['stat_pac2']=="PASS" AND $rcek1['stat_pal2']=="PASS"){echo "PASS";}
                    else if (($rcek1['stat_pac2'] == "ESS PASS" AND $rcek1['stat_pal2'] == "PASS") OR ($rcek1['stat_pal2'] == "ESS PASS" AND $rcek1['stat_pac2'] == "PASS")) {
                        echo "ESS PASS";
                    } else if ($rcek1['stat_pac2'] == "FAIL" AND $rcek1['stat_pal2'] == "FAIL") {
                        echo "FAIL";
                    } else if ($rcek1['stat_pac2'] == "DATA" AND $rcek1['stat_pal2'] == "DATA") {
                        echo "DATA ONLY";
                    } else if ($rcek1['stat_pac2'] == "") {
                        echo "N/A";
                    } else if ($rcek1['stat_pac2'] != "" AND $rcek1['stat_pal2'] != "") {
                        echo $rcekM['macid_note2'] . " " . $rcekM['malkaline_note2'];
                    } else {
                        echo "N/A";
                    }?>
              </td>
...
<!-- Page 4 Begin -->
    <table width="100%">
        ...
        <tr>
            <td align="right" style="font-size: 12px;">Page 4 of 10</td> 
        </tr>
        <tr>
...
<!-- Page 5 Begin -->
        <table width="100%">
            ...
            <tr>
                <td align="right" style="font-size: 12px;">Page 5 of 10</td> 
            </tr>
                <td align="right" style="font-size: 12px;"><?php echo $rd2['date_out1'] ? $rd2['date_out1']->format("F j, Y") : ""; ?></td> 
            </tr>
            <tr>
        ...
        <tr>
            ...
            <td align="center" style="font-size: 11px; <?php echo hasil('WASHING', cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']), $rcek1['wash_colorchange'], 'warna');?>" width="33%"><?php echo hasil('WASHING', cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']), $rcek1['wash_colorchange'], 'nilai')?></td>
            <td align="right" style="font-size: 11px;" width="33%"><?= cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']);?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="center" style="font-size: 11px; <?php echo hasil('WASHING', cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']), $rcek1['wash_acetate'], 'warna');?>" width="33%"><?php echo hasil('WASHING', cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']), $rcek1['wash_acetate'], 'nilai')?></td>
            <td align="right" style="font-size: 11px;" width="33%"><?= cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']);?></td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">COTTON</td>
            <td align="center" style="font-size: 11px; <?php echo hasil('WASHING', cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']), $rcek1['wash_cotton'], 'warna');?>" width="33%"><?php echo hasil('WASHING', cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']), $rcek1['wash_cotton'], 'nilai')?></td>
            <td align="right" style="font-size: 11px;" width="33%"><?= cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']);?></td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">NYLON</td>
            <td align="center" style="font-size: 11px; <?php echo hasil('WASHING', cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']), $rcek1['wash_nylon'], 'warna');?>" width="33%"><?php echo hasil('WASHING', cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']), $rcek1['wash_nylon'], 'nilai')?></td>
            <td align="right" style="font-size: 11px;" width="33%"><?= cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']);?></td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">POLYESTER</td>
            <td align="center" style="font-size: 11px; <?php echo hasil('WASHING', cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']), $rcek1['wash_poly'], 'warna');?>" width="33%"><?php echo hasil('WASHING', cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']), $rcek1['wash_poly'], 'nilai')?></td>
            <td align="right" style="font-size: 11px;" width="33%"><?= cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']);?></td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">ACRYLIC</td>
            <td align="center" style="font-size: 11px; <?php echo hasil('WASHING', cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']), $rcek1['wash_acrylic'], 'warna');?>" width="33%"><?php echo hasil('WASHING', cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']), $rcek1['wash_acrylic'], 'nilai')?></td>
            <td align="right" style="font-size: 11px;" width="33%"><?= cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']);?></td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">WOOL</td>
            <td align="center" style="font-size: 11px; <?php echo hasil('WASHING', cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']), $rcek1['wash_wool'], 'warna');?>" width="33%"><?php echo hasil('WASHING', cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']), $rcek1['wash_wool'], 'nilai')?></td>
            <td align="right" style="font-size: 11px;" width="33%"><?= cekstandart('WASHING', $rd2['protocol'], $rd2['cstandar']);?></td>
        </tr>
        <!-- WASHING END -->
        <!-- <tr>
...
<!-- Page 6 Start --> 
        <table width="100%">
            ...
            <tr>
                <td align="right" style="font-size: 12px;">Page 6 of 10</td> 
            </tr>
                <td align="right" style="font-size: 12px;"><?php echo $rd2['date_out1'] ? $rd2['date_out1']->format("F j, Y") : ""; ?></td> 
            </tr>
            <tr>
            ...
            <tr>
              <td align="left" style="font-size: 12px;" colspan="3"><strong><u>COLORFASTNESS TO CROCKING</u></strong> (ISO 105-X12:2016)</td>
            </tr>
            <tr>
              <td align="center" style="font-size: 12px;" colspan="3">&nbsp;</td>
            </tr>
            <tr>
              <!-- <td align="left" style="font-size: 11px;" width="33%">DRY (COLOR STAIN)</td> -->
              <td align="left" style="font-size: 11px;">DRY STAINING (LENGTH)</td>
              <td align="center" style="font-size: 11px; <?php echo hasil('CROCKING_DRY', cekstandart('CROCKING_DRY', $rd2['protocol'], $rd2['cstandar']), $rcek1['crock_len12'], 'warna');?>"><?php echo hasil('CROCKING_DRY', cekstandart('CROCKING_DRY', $rd2['protocol'], $rd2['cstandar']), $rcek1['crock_len12'], 'nilai')?></td>
              <td align="right" style="font-size: 11px;"><?= cekstandart('CROCKING_DRY', $rd2['protocol'], $rd2['cstandar']);?></td>
            </tr>
            <tr>
              <td align="left" style="font-size: 11px;">DRY STAINING (WIDTH)</td>
              <td align="center" style="font-size: 11px; <?php echo hasil('CROCKING_DRY', cekstandart('CROCKING_DRY', $rd2['protocol'], $rd2['cstandar']), $rcek1['crock_wid12'], 'warna');?>"><?php echo hasil('CROCKING_DRY', cekstandart('CROCKING_DRY', $rd2['protocol'], $rd2['cstandar']), $rcek1['crock_wid12'], 'nilai')?></td>
              <td align="right" style="font-size: 11px;"><?= cekstandart('CROCKING_DRY', $rd2['protocol'], $rd2['cstandar']);?></td>
            </tr>
            <tr>
              <!-- <td align="left" style="font-size: 11px;" width="33%">WET (COLOR STAIN)</td> -->
              <td align="left" style="font-size: 11px;">WET STAINING (LENGTH)</td>
              <td align="center" style="font-size: 11px; <?php echo hasil('CROCKING_WET', cekstandart('CROCKING_WET', $rd2['protocol'], $rd2['cstandar']), $rcek1['crock_len22'], 'warna');?>"><?php echo hasil('CROCKING_WET', cekstandart('CROCKING_WET', $rd2['protocol'], $rd2['cstandar']), $rcek1['crock_len22'], 'nilai')?></td>
              <td align="right" style="font-size: 11px;"><?= cekstandart('CROCKING_WET', $rd2['protocol'], $rd2['cstandar']);?></td>
            </tr>
            <tr>
              <td style="font-size: 12px;" ><span style="font-size: 11px;">WET STAINING (WIDTH)</span></td>
              <td align="center" style="font-size: 11px; <?php echo hasil('CROCKING_WET', cekstandart('CROCKING_WET', $rd2['protocol'], $rd2['cstandar']), $rcek1['crock_wid22'], 'warna');?>"><?php echo hasil('CROCKING_WET', cekstandart('CROCKING_WET', $rd2['protocol'], $rd2['cstandar']), $rcek1['crock_wid22'], 'nilai')?></td>
              <td align="right" style="font-size: 11px;"><?= cekstandart('CROCKING_WET', $rd2['protocol'], $rd2['cstandar']);?></td>
            </tr>
            <tr>
              <td style="font-size: 12px;" ><strong> Conclusion </strong></td>
              <td align="center"  style="font-size: 12px; <?php echo (($rcek1['stat_cr2'] ?? '') == 'FAIL') ? 'color:red;' : ''; ?>"><?php if ($rcek1['stat_cr2']!=""){echo $rcek1['stat_cr2'];}else{echo "N/A";}?></td>
              <td style="font-size: 12px;"></td>
            </tr>
            <tr>
              <td style="font-size: 12px;" ><strong> Remarks : Grey Scale Rating is based on the 5-step scale of 1 to 5, where 1 is worst and 5 is best </strong></td>
              <td align="center"  style="font-size: 12px;"></td>
              <td style="font-size: 12px;"></td>
            </tr>
            <tr>
            ...
            <tr>
              <!-- <td align="left" style="font-size: 12px;" colspan="3"><strong><u>COLORFASTNESS TO WATER</u></strong> (AATCC 107, MULTIFIBER NO.10)</td> -->
              <td align="left" style="font-size: 12px;" colspan="3"><strong><u>COLORFASTNESS TO WATER</u></strong> (ISO 105-E01:2013)</td>
            </tr>
            <tr>
              <td align="center" style="font-size: 12px;" colspan="3">&nbsp;</td>
            </tr>
            <tr>
              <td align="left" style="font-size: 11px;">COLOR CHANGE</td>
              <td align="center" style="font-size: 11px; <?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_colorchange2'], 'warna');?>"><?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_colorchange2'], 'nilai')?></td>
              <td align="right" style="font-size: 11px;"><?= cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']);?></td>
            </tr>
            <tr>
              <td align="left" style="font-size: 11px;">SELF - STAINING</td>
              <td align="center" style="font-size: 11px; <?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_staining2'], 'warna');?>"><?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_staining2'], 'nilai')?></td>
              <td align="right" style="font-size: 11px;"><?= cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']);?></td>
            </tr>
            <tr>
              <td align="left" style="font-size: 11px;" colspan="3"><u> STAINING ON MULT-FIBER STRIPE</u></td>
            ...
            <tr>
              ...
              <td align="center" style="font-size: 11px; <?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_acetate2'], 'warna');?>"><?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_acetate2'], 'nilai')?></td>
              <td align="right" style="font-size: 11px;"><?= cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']);?></td>
            </tr>
            <tr>
              <td align="left" style="font-size: 11px;">COTTON</td>
              <td align="center" style="font-size: 11px; <?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_cotton2'], 'warna');?>"><?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_cotton2'], 'nilai')?></td>
              <td align="right" style="font-size: 11px;"><?= cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']);?></td>
            </tr>
            <tr>
              <td align="left" style="font-size: 11px;">NYLON</td>
              <td align="center" style="font-size: 11px; <?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_nylon2'], 'warna');?>"><?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_nylon2'], 'nilai')?></td>
              <td align="right" style="font-size: 11px;"><?= cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']);?></td>
            </tr>
            <tr>
              <td align="left" style="font-size: 11px;">POLYESTER</td>
              <td align="center" style="font-size: 11px; <?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_poly2'], 'warna');?>"><?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_poly2'], 'nilai')?></td>
              <td align="right" style="font-size: 11px;"><?= cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']);?></td>
            </tr>
            <tr>
              <td align="left" style="font-size: 11px;">ACRYLIC</td>
              <td align="center" style="font-size: 11px; <?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_acrylic2'], 'warna');?>"><?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_acrylic2'], 'nilai')?></td>
              <td align="right" style="font-size: 11px;"><?= cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']);?></td>
            </tr>
            <tr>
              <td align="left" style="font-size: 11px;">WOOL</td>
              <td align="center" style="font-size: 11px; <?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_wool2'], 'warna');?>"><?php echo hasil('WATER', cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']), $rcek1['water_wool2'], 'nilai')?></td>
              <td align="right" style="font-size: 11px;"><?= cekstandart('WATER', $rd2['protocol'], $rd2['cstandar']);?></td>
            </tr>
            <tr>
              <td style="font-size: 12px;" ><strong> Conclusion </strong></td>
              <td align="center"  style="font-size: 12px; <?php echo (($rcek1['stat_wtr2'] ?? '') == 'FAIL') ? 'color:red;' : ''; ?>"><?php if($rcek1 !=""){echo $rcek1['stat_wtr2'];}else{echo "N/A";}?></td>
              <td style="font-size: 12px;"></td>
            </tr>
            <tr>
              <td style="font-size: 12px;" ><strong> Remarks : Grey Scale Rating is based on the 5-step scale of 1 to 5, where 1 is worst and 5 is best </strong></td>
            ...
            <!-- <tr>
                <td align="center" style="font-size: 12px;" colspan="3">&nbsp;</td>
            </tr> -->            <!-- LIGHT PERSPIRATION END -->            <!-- PHENOLIC YELLOWING BEGIN -->            <!-- <tr>
                <td align="left" style="font-size: 11px;" width="33%">&nbsp;</td>
            ...
            <!-- <tr>
                <td align="center" style="font-size: 12px;" colspan="3">&nbsp;</td>
            </tr> -->            <!-- PHENOLIC YELLOWING END -->            <!-- PILLING TUMBLE BEGIN -->            <!--
            <tr>
...
<!-- Page 6 Start --> 
        <table width="100%">
            ...
            <tr>
                <td align="right" style="font-size: 12px;">Page 7 of 10</td> 
            </tr>
                <td align="right" style="font-size: 12px;"><?php echo $rd2['date_out1'] ? $rd2['date_out1']->format("F j, Y") : ""; ?></td> 
            </tr>
            <tr>
            ...
            <!-- <tr>
                ...
                <td align="center" style="font-size: 11px;" width="33%"><strong>T1 (4A) DARK GREEN / T5 (4B) RED</strong></td>
                <td align="right" style="font-size: 11px;" width="33%">&nbsp;</td>
            </tr> -->            <!-- CROCKING END -->            <!-- WATER BEGIN -->            <!-- <tr>
                <td align="left" style="font-size: 11px;" width="33%">&nbsp;</td>
                <td align="center" style="font-size: 11px;" width="33%"><strong>T1 (7A) NAVY / T5 (7B) BLACK</strong></td>
                <td align="right" style="font-size: 11px;" width="33%">&nbsp;</td>
            </tr> -->            <!-- <tr>
            ...
            <tr>
              <td align="left" style="font-size: 11px;">60 MIN</td>
            ...
            <tr>
              <td align="left" style="font-size: 11px;">SELF STAINING (WHITE FABRIC)</td>
              <td align="center" style="font-size: 11px; <?php if($rcek1['dye_tf_sstaining']!="" AND $rcek1['dye_tf_sstaining'] < 4){echo "color:red;";}?>"><?php if($rcek1['dye_tf_sstaining']==""){echo "N/A";}else{echo $rcek1['dye_tf_sstaining'];}?></td>
              <td align="right" style="font-size: 11px;"><?= cekstandart('DYE_TRANSFER', $rd2['protocol'], $rd2['cstandar']);?></td>
            </tr>
            <tr>
              <!-- <td align="left" style="font-size: 11px;" width="33%">COLOR CHANGE</td> -->
              <td align="left" style="font-size: 11px;">CHANGE IN SHADE</td>
              <td align="center" style="font-size: 11px; <?php if($rcek1['dye_tf_cstaining']!="" AND $rcek1['dye_tf_cstaining'] < 4){echo "color:red;";}?>"><?php if($rcek1['dye_tf_cstaining']==""){echo "N/A";}else{echo $rcek1['dye_tf_cstaining'];}?></td>
              <td align="right" style="font-size: 11px;">&nbsp;</td>
            </tr>
            <tr>
...
<!-- Page 7 Begin -->
    <table width="100%">
        ...
        <tr>
            <td align="right" style="font-size: 12px;">Page 8 of 10</td> 
        </tr>
        <tr>
            <td align="right" style="font-size: 12px;"><?php echo $rd2['date_out1'] ? $rd2['date_out1']->format("F j, Y") : ""; ?></td> 
        </tr>
    ...
    <table width="100%">
        ...
        <tr>
         ...
         <tr>
           <!-- <td align="left" style="font-size: 12px;" colspan="3"><strong><u>COLORFASTNESS TO PERSPIRATION</u></strong> (AATCC 15, AATCC GRAY SCALE, MULTIFIBER NO.10)</td> -->
           <td align="left" style="font-size: 12px;" colspan="3"><strong><u>COLORFASTNESS TO PERSPIRATION</u></strong> (ISO 105-E04:2013)</td>
         </tr>
         <tr>
           <td align="left" style="font-size: 12px;" colspan="3">&nbsp;</td>
         </tr>
         <tr>
           <!-- <td align="left" style="font-size: 11px;" width="33%">ACIDIC</td> -->
           <td align="left" style="font-size: 11px;">ACID PERSPIRATION SOLUTION</td>
           <!-- <td align="center" style="font-size: 11px;" width="33%"><strong>T1 (6A) BLACK / T5 (6B) NAVY</strong></td> -->
           <td align="center" style="font-size: 11px;">&nbsp;</td>
           <td align="right" style="font-size: 11px;">&nbsp;</td>
         </tr>
         <tr>
           ...
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_colorchange2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_colorchange2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <td align="left" style="font-size: 11px;">SELF - STAINING</td>
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_staining2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_staining2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <!-- <td align="left" style="font-size: 11px;" colspan="3"><u>COLOR STAINING ON</u></td> -->
         ...
         <tr>
           <td align="left" style="font-size: 11px;">ACETATE</td>
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_acetate2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_acetate2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <td align="left" style="font-size: 11px;">COTTON</td>
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_cotton2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_cotton2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <td align="left" style="font-size: 11px;">NYLON</td>
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_nylon2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_nylon2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <td align="left" style="font-size: 11px;">POLYESTER</td>
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_poly2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_poly2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <td align="left" style="font-size: 11px;">ACRYLIC</td>
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_acrylic2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_acrylic2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <td align="left" style="font-size: 11px;">WOOL</td>
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_wool2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['acid_wool2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <td align="center" style="font-size: 12px;" colspan="3">&nbsp;</td>
         ...
         <tr>
           <!-- <td align="left" style="font-size: 11px;" width="33%">ALKALINE</td> -->
           <td align="left" style="font-size: 11px;">ALKALINE PERSPIRATION SOLUTION</td>
           <!-- <td align="center" style="font-size: 11px;" width="33%"><strong>T1 (6A) BLACK / T5 (6B) NAVY</strong></td> -->
           <td align="right" style="font-size: 11px;">&nbsp;</td>
           <td align="right" style="font-size: 11px;">&nbsp;</td>
         </tr>
         <tr>
           <!-- <td align="left" style="font-size: 11px;" width="33%">COLOR CHANGE</td> -->
           <td align="left" style="font-size: 11px;">CHANGE IN SHADE</td>
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_colorchange2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_colorchange2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <td align="left" style="font-size: 11px;">SELF - STAINING</td>
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_staining2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_staining2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <!-- <td align="left" style="font-size: 11px;" colspan="3"><u>COLOR STAINING ON</u></td> -->
         ...
         <tr>
           <td align="left" style="font-size: 11px;">ACETATE</td>
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_acetate2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_acetate2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <td align="left" style="font-size: 11px;">COTTON</td>
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_cotton2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_cotton2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <td align="left" style="font-size: 11px;">NYLON</td>
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_nylon2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_nylon2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <td align="left" style="font-size: 11px;">POLYESTER</td>
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_poly2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_poly2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <td align="left" style="font-size: 11px;">ACRYLIC</td>
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_acrylic2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_acrylic2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <td align="left" style="font-size: 11px;">WOOL</td>
           <td align="center" style="font-size: 11px; <?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_wool2'], 'warna');?>"><?php echo hasil('ACID', cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']), $rcek1['alkaline_wool2'], 'nilai')?></td>
           <td align="right" style="font-size: 11px;"><?= cekstandart('ACID', $rd2['protocol'], $rd2['cstandar']);?></td>
         </tr>
         <tr>
           <td style="font-size: 12px;" ><strong> Conclusion </strong></td>
           <td align="center"  style="font-size: 12px; <?php echo (($rcek1['stat_pal2'] ?? '') == 'FAIL') ? 'color:red;' : ''; ?>"><?php if($rcek1['stat_pal2'] !=""){echo $rcek1['stat_pal2'];}else{echo "N/A";}?></td>
           <td></td>
         </tr>
         <tr>
           <td style="font-size: 12px;" ><strong> Remaks : Grey Scale Rating is based on the 5-step scale of 1 to 5, where 1 is bad and 5 is good </strong></td>
           <td align="center"  style="font-size: 12px;"></td>
           <td style="font-size: 12px;"></td>
         </tr>
         <tr>
...
<!-- Page 8 Begin -->
    <table width="100%">
        ...
        <tr>
            <td align="right" style="font-size: 12px;">Page 9 of 10</td> 
        </tr>
        <tr>
            <td align="right" style="font-size: 12px;"><?php echo $rd2['date_out1'] ? $rd2['date_out1']->format("F j, Y") : ""; ?></td> 
        </tr>
...
<!-- Page 8 Begin -->
    <table width="100%">
        ...
        <tr>
            <td align="right" style="font-size: 12px;">Page 10 of 10</td> 
        </tr>
        <tr>
            <td align="right" style="font-size: 12px;"><?php echo $rd2['date_out1'] ? $rd2['date_out1']->format("F j, Y") : ""; ?></td> 
        </tr>

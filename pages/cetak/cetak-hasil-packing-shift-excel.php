...
header("Content-Disposition: attachment; filename=Lap-Packing-Shift-".date($_GET['awal']).".xls");//ganti nama sesuai keperluan
...
<table width="100%">
  ...
  <tr>
        <td colspan="8" align="center"><strong><font size="+1">LAPORAN HASIL PACKING SHIFT <?php echo $Shift; ?></font><br />

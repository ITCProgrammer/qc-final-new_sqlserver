  ...
  <form method="post" enctype="multipart/form-data" name="form1" class="form-horizontal" id="form1">
    ...
    <div class="box-footer">
      ...
      <div class="pull-right">
        <input type="button" class="btn btn-block btn-social btn-linkedin btn-sm" name="lihat" value="Kembali" onClick="window.location.href='FirstLotNew'">	   
      </div>
    </div>
    <!-- /.box-footer -->
  </form>
      ...
      <div class="box-body">
        <table class="table table-bordered table-hover table-striped nowrap" id="example3" style="width:100%">
          ...
          <tr bgcolor="<?php echo $bgcolor; ?>">
            ...
            <a href="#" class="btn btn-danger btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; } ?>" onclick="confirm_delete('./HapusDataFirstLotNew-<?php echo $row1['id'] ?>');"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Hapus"></i> </a>
            </td>

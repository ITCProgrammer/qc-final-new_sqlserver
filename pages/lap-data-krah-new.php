  ...
  <form method="post" enctype="multipart/form-data" name="form1" class="form-horizontal" id="form1">
    ...
    <div class="box-footer">
      ...
      <div class="pull-right">
        <input type="button" class="btn btn-block btn-social btn-linkedin btn-sm" <?php if($_SESSION['lvl_id']=="AFTERSALES"){echo "disabled";}?> name="lihat" value="Kembali" onClick="window.location.href='LapDataKrahNew'">	   
      </div>
    </div>
    <!-- /.box-footer -->
  </form>
...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header with-border">
            <h3 class="box-title">Data Laporan Krah</h3><br>
        ...
        <table class="table table-bordered table-hover table-striped nowrap" id="example1" style="width:100%">
          <thead class="bg-blue">
            <tr>
              ...
              <th rowspan="2"><div align="center">Tgl Buat</div></th>
              ...
              <th rowspan="2"><div align="center">Target</div></th>
              <th rowspan="2"><div align="center">Tgl Selesai</div></th>
              <th rowspan="2"><div align="center">Status</div></th>
              <th rowspan="2"><div align="center">Proses</div></th>
              <th rowspan="2"><div align="center">Order Legacy</div></th>
          ...
          <tr bgcolor="<?php echo $bgcolor; ?>">
            ...
            <td><?php echo substr($row1['jenis_kain'],0,25)."...";?></td>
            <td align="center"><?php echo $row1['rol'];?></td>
            <td align="center"><?php echo $row1['bruto'];?></td>
            <td align="center"><?php echo $row1['pcs_bruto'];?></td>
            <td align="center"><?php echo $row1['rol_netto'];?></td>
            <td align="center"><?php echo $row1['qty_netto'];?></td>
            <td align="center"><?php echo $row1['pcs_netto'];?></td>
            ...
            <td align="center"><?php echo $row1['order_legacy'];?></td>

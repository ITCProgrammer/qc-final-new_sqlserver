<script type="text/javascript">
    ...
    function proses_demand() {
        ...
        if (demand == 0) {
            ...
            window.location.href = 'InputLapJahitShading&' + demand;
        }
    }
    ...
    function proses_shift() {
        ...
        if (demand == "") {
            ...
            window.location.href = 'InputLapJahitShading&' + demand + '&' + shift;
        }
    }
</script>
<?php
...
if ($_POST['simpan'] == "simpan") {
    ...
    if ($cek > 0) {
        ...
        if ($sql1) {
            ...
            if (result.value) {
                window.location.href='InputLapJahitShading&$_POST[demand]';
...
if ($_GET['nokk'] != "") { //ini demand di htaccess masih nokk
    $demand = $_GET['nokk'];
} else {
    $demand = "";
}
    ...
    <div class="box box-info">
        ...
        <div class="box-body">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea name="jenis_kain" class="form-control" id="jenis_kain" placeholder="Jenis Kain"><?php
                        if ($crow > 0 && $row['jenis_kain'] != "") {
                            echo $row['jenis_kain'];
                        } else {
                            if ($shift != "") {
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input name="lot" class="form-control" type="text" id="lot" value="<?php if ($crow > 0 && $row['lot'] != "" && is_numeric($row['lot'])) {
                            echo $row['lot'];
                        } else {
                            if ($shift != "") {
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            <input name="roll_ok" type="text" class="form-control" id="roll_ok" value="<?php if ($crow > 0) {
                                echo $row['roll_ok'];
                            } ?>" placeholder="0" required>
                            <span class="input-group-addon">Roll</span>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            <input name="roll_reject" type="text" class="form-control" id="roll_reject" value="<?php if ($crow > 0) {
                                echo $row['roll_reject'];
                            } ?>" placeholder="0" required>
                            <span class="input-group-addon">Roll</span>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <input name="ket_roll_reject" type="text" class="form-control" id="ket_roll_reject" value="<?php if ($crow > 0) {
                            echo $row['ket_roll_reject'];
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input name="prod_order" type="text" class="form-control" id="prod_order" value="<?php if ($crow > 0) {
                            echo $row['prod_order'];
                        } else {
                            if ($shift != "") {
                                echo trim($rowdb2['PRODUCTIONORDERCODE']);
        ...
        <div class="box-footer">
            ...
            <button type="button" class="btn btn-warning pull-left" name="lihat" value="lihat"
                onClick="window.location.href='LihatDataJahitShading'"><i class="fa fa-search"></i> Lihat Data</button>
        </div>
    </div>
</form>

...
include "koneksi.php";
$noitem=$_GET['no_item'];
$qry=sqlsrv_query($con_db_qc_sqlsrv,"SELECT * FROM db_qc.tbl_std_tq_ua WHERE no_item='$noitem'");
$cek=sqlsrv_has_rows($qry) ? 1 : 0; 
...
if($_POST['physical_save']=="save" and $cek>0){
	$sqlPHY=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_std_tq_ua SET
    ...
    $sqlPHY=sqlsrv_query($con_db_qc_sqlsrv,"INSERT INTO db_qc.tbl_std_tq_ua (
        no_item,
        flamability,
        bow,
        skew,
...
if($_POST['functional_save']=="save" and $cek>0){
    $sqlFPH=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_std_tq_ua SET
    wick1='$_POST[wick1]',
    wick2='$_POST[wick2]',
    wick3='$_POST[wick3]',
    wick4='$_POST[wick4]',
    ...
    $sqlFPH=sqlsrv_query($con_db_qc_sqlsrv,"INSERT INTO db_qc.tbl_std_tq_ua (
        no_item,
        wick1,
        wick2,
        wick3,
...
if($_POST['colorfastness_save']=="save" and $cek>0){
    $sqlCLR=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_std_tq_ua SET
    wash1='$_POST[wash1]',
    wash2='$_POST[wash2]',
    wash3='$_POST[wash3]',
    wash4='$_POST[wash4]',
    ...
    $sqlCLR=sqlsrv_query($con_db_qc_sqlsrv,"INSERT INTO db_qc.tbl_std_tq_ua (
        no_item,
        wash1,
        wash2,
        wash3,

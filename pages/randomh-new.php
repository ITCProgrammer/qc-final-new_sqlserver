...
$sqlCek2=sqlsrv_query($con_db_qc_sqlsrv,"SELECT TOP 1 * FROM db_qc.tbl_tq_nokk WHERE no_hanger=? ",[$nohanger]);
$cek2=0;
$rcek2=sqlsrv_fetch_array($sqlCek2,SQLSRV_FETCH_ASSOC);
if($rcek2){
    $cek2++;
}

$sqlTR=sqlsrv_query($con_db_qc_sqlsrv,"SELECT TOP 1 * FROM db_qc.tbl_tq_temp_random WHERE no_hanger=? ",[$nohanger]);
$cekTR=0;
$rcekTR=sqlsrv_fetch_array($sqlTR,SQLSRV_FETCH_ASSOC);
if($rcekTR){
    $cekTR++;
}

$sqlTR2=sqlsrv_query($con_db_qc_sqlsrv,"SELECT TOP 1 * FROM db_qc.tbl_tq_temp_random2 WHERE no_hanger=? ",[$nohanger]);
$cekTR2=0;
$rcekTR2=sqlsrv_fetch_array($sqlTR2,SQLSRV_FETCH_ASSOC);
if($rcekTR2){
    $cekTR2++;
}

$sqlRW=sqlsrv_query($con_db_qc_sqlsrv,"SELECT TOP 1 * FROM db_qc.tbl_tq_random_warna WHERE no_hanger=? ORDER BY id DESC ",[$nohanger]);
$cekRW=0;
$rcekRW=sqlsrv_fetch_array($sqlRW,SQLSRV_FETCH_ASSOC);
if($rcekRW){
    $cekRW++;
}
?>	
...
if($_POST['physical_save']=="save" and $cekR>0 and $cekRW>0 and $cekTR>0 and $cekTR2>0){
	$sqlPHY=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_randomtest SET
	 ...
	 if($sqlPHY){
		$sql_PHYWarna=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_random_warna SET
		...
		if($_POST['sts_random']=="2"){
			$sql_tempPHY=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_temp_random SET
			...
			$sql_tempPHY1=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_temp_random2 SET
			sts='2'
			WHERE no_hanger='$nohanger'");
		 }else if($_POST['sts_random2']=="2"){
			$sql_tempPHY=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_temp_random2 SET
			temp_rprt_f1='$_POST[rpillingrt_f1]',
			temp_rprt_b1='$_POST[rpillingrt_b1]',
			temp_rpb_f1='$_POST[rpillingb_f1]',
			temp_rsp_grdl1='$_POST[rsp_grdl1]',
			...
			$sql_tempPHY1=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_temp_random SET
			sts='2'
			WHERE no_hanger='$nohanger'");
		 }
		 echo "<script>swal({
	 ...
	 window.location.href='RandomhNew-$nohanger'; 
		...
		$sqlPHY=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_randomtest SET
		  ...
		  rss_washes15='$_POST[rss_washes15]',
			  ...
			  WHERE no_hanger='$nohanger'");
		 if($sqlPHY){
			$sql_PHYWarna=sqlsrv_query($con_db_qc_sqlsrv,"INSERT INTO db_qc.tbl_tq_random_warna 
			(no_item,no_hanger,rflamabilityw,rfc_cott1w,rfc_poly1w,rfc_ela1w,rwpiw,rcpiw,rf_weightw,rf_widthw,rboww,rskeww,rssw,rapperssw,rpmw,rplw,rpbw,rprtw,rsmw,rspw,rsbw,
			rbsw,rthickw,rstretchw,rrecoverw,rgrowthw,rrec_growthw,rapperw,rh_shrinkagew,rfibrew,rodourw,rcurlingw,rnedlew,tgl_buat,tgl_update) VALUES 
			('$rcek2[no_item]','$_GET[no_hanger]','$_POST[rflamabilityw]','$_POST[rfc_cott1w]','$_POST[rfc_poly1w]','$_POST[rfc_ela1w]','$_POST[rwpiw]','$_POST[rcpiw]',
			'$_POST[rf_weightw]','$_POST[rf_widthw]','$_POST[rboww]','$_POST[rskeww]','$_POST[rssw]','$_POST[rapperssw]','$_POST[rpmw]','$_POST[rplw]','$_POST[rpbw]','$_POST[rprtw]',
			'$_POST[rsmw]','$_POST[rspw]','$_POST[rsbw]','$_POST[rbsw]','$_POST[rthickw]','$_POST[rstretchw]','$_POST[rrecoverw]','$_POST[rgrowthw]','$_POST[rrec_growthw]',
			'$_POST[rapperw]','$_POST[rh_shrinkagew]','$_POST[rfibrew]','$_POST[rodourw]','$_POST[rcurlingw]','$_POST[rnedlew]',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ");
			if($_POST['sts_random']=="2"){
				$sql_tempPHY=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_temp_random SET
				temp_rprt_f1='$_POST[rpillingrt_f1]',
				temp_rprt_b1='$_POST[rpillingrt_b1]',
	  ...
	  if (result.value) {
		...
		$sqlPHY=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_randomtest SET
		  ...
		  WHERE no_hanger='$nohanger'");
	 if($sqlPHY){
		$sql_tempPHY=sqlsrv_query($con_db_qc_sqlsrv,"INSERT INTO db_qc.tbl_tq_temp_random 
		(no_item,no_hanger,temp_rprt_f1,temp_rprt_b1,temp_rpb_f1,temp_rsp_grdl1,temp_rsp_clsl1,temp_rsp_shol1,temp_rsp_medl1,temp_rsp_lonl1,temp_rsp_grdw1,temp_rsp_clsw1,
		temp_rsp_show1,temp_rsp_medw1,temp_rsp_lonw1,temp_rsp_grdl2,temp_rsp_grdw2,temp_rsm_l1,temp_rsm_w1,temp_rbs_instron,temp_rbs_tru,temp_rbs_mullen,temp_rpm_f1,
		temp_rpm_f2,temp_rstretch_l1,temp_rstretch_w1,temp_rrecover_l1,temp_rrecover_w1,temp_rwick_l2,temp_rwick_w2,temp_rabsor_b1,temp_rdryaf1,sts,tgl_buat,tgl_update) VALUES 
		('$rcek2[no_item]','$_GET[no_hanger]','$_POST[rpillingrt_f1]','$_POST[rpillingrt_b1]','$_POST[rpillingb_f1]','$_POST[rsp_grdl1]','$_POST[rsp_clsl1]','$_POST[rsp_shol1]',
		'$_POST[rsp_medl1]','$_POST[rsp_lonl1]','$_POST[rsp_grdw1]','$_POST[rsp_clsw1]','$_POST[rsp_show1]','$_POST[rsp_medw1]','$_POST[rsp_lonw1]','$_POST[rsp_grdl2]',
		'$_POST[rsp_grdw2]','$_POST[rsnaggingm_l1]','$_POST[rsnaggingm_w1]','$_POST[rinstron]','$_POST[rtru_burst]','$_POST[rmullen]','$_POST[rpillingm_f1]','$_POST[rpillingm_f2]',
		'$_POST[rstretch_l1]','$_POST[rstretch_w1]','$_POST[rrecover_l1]','$_POST[rrecover_w1]','$_POST[rwick_l2]','$_POST[rwick_w2]','$_POST[rabsor_b1]','$_POST[rdryaf1]','1',
		CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ");
			
			$sql_tempPHY1=sqlsrv_query($con_db_qc_sqlsrv,"INSERT INTO db_qc.tbl_tq_temp_random2 
			(no_item,no_hanger,temp_rprt_f1,temp_rprt_b1,temp_rpb_f1,temp_rsp_grdl1,temp_rsp_clsl1,temp_rsp_shol1,temp_rsp_medl1,temp_rsp_lonl1,temp_rsp_grdw1,temp_rsp_clsw1,
			temp_rsp_show1,temp_rsp_medw1,temp_rsp_lonw1,temp_rsp_grdl2,temp_rsp_grdw2,temp_rsm_l1,temp_rsm_w1,temp_rbs_instron,temp_rbs_tru,temp_rbs_mullen,temp_rpm_f1,
			temp_rpm_f2,temp_rstretch_l1,temp_rstretch_w1,temp_rrecover_l1,temp_rrecover_w1,temp_rwick_l2,temp_rwick_w2,temp_rabsor_b1,temp_rdryaf1,sts,tgl_buat,tgl_update) VALUES 
			('$rcek2[no_item]','$_GET[no_hanger]','$_POST[rpillingrt_f1]','$_POST[rpillingrt_b1]','$_POST[rpillingb_f1]','$_POST[rsp_grdl1]','$_POST[rsp_clsl1]','$_POST[rsp_shol1]',
			'$_POST[rsp_medl1]','$_POST[rsp_lonl1]','$_POST[rsp_grdw1]','$_POST[rsp_clsw1]','$_POST[rsp_show1]','$_POST[rsp_medw1]','$_POST[rsp_lonw1]','$_POST[rsp_grdl2]',
			'$_POST[rsp_grdw2]','$_POST[rsnaggingm_l1]','$_POST[rsnaggingm_w1]','$_POST[rinstron]','$_POST[rtru_burst]','$_POST[rmullen]','$_POST[rpillingm_f1]','$_POST[rpillingm_f2]',
			'$_POST[rstretch_l1]','$_POST[rstretch_w1]','$_POST[rrecover_l1]','$_POST[rrecover_w1]','$_POST[rwick_l2]','$_POST[rwick_w2]','$_POST[rabsor_b1]','$_POST[rdryaf1]',
			...
			rbsw,rthickw,rstretchw,rrecoverw,rgrowthw,rrec_growthw,rapperw,rh_shrinkagew,rfibrew,rodourw,rcurlingw,rnedlew,tgl_buat,tgl_update) VALUES 
			('$rcek2[no_item]','$_GET[no_hanger]','$_POST[rflamabilityw]','$_POST[rfc_cott1w]','$_POST[rfc_poly1w]','$_POST[rfc_ela1w]','$_POST[rwpiw]','$_POST[rcpiw]',
			'$_POST[rf_weightw]','$_POST[rf_widthw]','$_POST[rboww]','$_POST[rskeww]','$_POST[rssw]','$_POST[rapperssw]','$_POST[rpmw]','$_POST[rplw]','$_POST[rpbw]',
			'$_POST[rprtw]','$_POST[rsmw]','$_POST[rspw]','$_POST[rsbw]','$_POST[rbsw]','$_POST[rthickw]','$_POST[rstretchw]','$_POST[rrecoverw]','$_POST[rgrowthw]',
			'$_POST[rrec_growthw]','$_POST[rapperw]','$_POST[rh_shrinkagew]','$_POST[rfibrew]','$_POST[rodourw]','$_POST[rcurlingw]','$_POST[rnedlew]',CURRENT_TIMESTAMP,
			CURRENT_TIMESTAMP) ");
  ...
  if (result.value) {
	...
	$sqlPHY=sqlsrv_query($con_db_qc_sqlsrv,"INSERT INTO db_qc.tbl_tq_randomtest 
	(no_item,no_hanger,rflamability,rfla_note,rfc_cott,rfc_poly,rfc_elastane,rfc_cott1,rfc_poly1,rfc_elastane1,std_rfc_cott1,std_rfc_poly1,std_rfc_elastane1,rfibercontent,
	rfiber_note,rfc_wpi,rfc_cpi,rfc_note,rf_weight,rfwe_note,rf_width,rfwi_note,rbow,rskew,rbas_note,rh_shrinkage_l1,rh_shrinkage_w1,rh_shrinkage_grd,rh_shrinkage_note,
	rss_temp,rss_washes3,rss_washes10,rss_washes15,rss_cmt,rshrinkage_l1,rshrinkage_l2,rshrinkage_l3,rshrinkage_l4,rshrinkage_l5,rshrinkage_l6,rshrinkage_w1,rshrinkage_w2,
	rshrinkage_w3,rshrinkage_w4,rshrinkage_w5,rshrinkage_w6,rspirality1,rspirality2,rspirality3,rspirality4,rspirality5,rspirality6,rss_linedry,rss_tumbledry,rsns_note,
	rapperss_ch1,rapperss_ch2,rapperss_ch3,rapperss_ch4,rapperss_cc1,rapperss_cc2,rapperss_cc3,rapperss_cc4,rapperss_st,rapperss_pf1,rapperss_pf2,rapperss_pf3,rapperss_pf4,
	rapperss_pb1,rapperss_pb2,rapperss_pb3,rapperss_pb4,rapperss_sf1,rapperss_sf2,rapperss_sf3,rapperss_sf4,rapperss_sb1,rapperss_sb2,rapperss_sb3,rapperss_sb4,rapperss_note,
	rpm_f1,rpm_b1,rpm_f2,rpm_b2,rpm_f3,rpm_b3,rpm_f4,rpm_b4,rpm_f5,rpm_b5,rpillm_note,rpl_f1,rpl_b1,rpl_f2,rpl_b2,rpl_f3,rpl_b3,rpl_f4,rpl_b4,rpl_f5,rpl_b5,rpilll_note,rpb_f1,
	rpb_b1,rpb_f2,rpb_b2,rpb_f3,rpb_b3,rpb_f4,rpb_b4,rpb_f5,rpb_b5,rpillb_note,rprt_f1,rprt_b1,rprt_f2,rprt_b2,rprt_f3,rprt_b3,rprt_f4,rprt_b4,rprt_f5,rprt_b5,rpillr_note,
	rabration,rabr_note,rsm_l1,rsm_w1,rsm_l2,rsm_w2,rsm_l3,rsm_w3,rsm_l4,rsm_w4,rsnam_note,rsp_grdl1,rsp_clsl1,rsp_shol1,rsp_medl1,rsp_lonl1,rsp_grdw1,rsp_clsw1,rsp_show1,
	rsp_medw1,rsp_lonw1,rsp_grdl2,rsp_clsl2,rsp_shol2,rsp_medl2,rsp_lonl2,rsp_grdw2,rsp_clsw2,rsp_show2,rsp_medw2,rsp_lonw2,rsnap_note,rsb_l1,rsb_w1,rsb_l2,rsb_w2,rsb_l3,
	rsb_w3,rsb_l4,rsb_w4,rsnab_note,rbs_instron,rbs_mullen,rbs_tru,rbs_tru2,rburs_note,rthick1,rthick2,rthick3,rthickav,rthick_note,rstretch_l1,rstretch_w1,rstretch_l2,
	rstretch_w2,rstretch_l3,rstretch_w3,rstretch_l4,rstretch_w4,rstretch_l5,rstretch_w5,rload_stretch,rstretch_note,rrecover_l1,rrecover_w1,rrecover_l2,rrecover_w2,rrecover_l3,
	rrecover_w3,rrecover_l4,rrecover_w4,rrecover_l5,rrecover_w5,rrecover_note,rgrowth_l1,rgrowth_w1,rgrowth_l2,rgrowth_w2,rrec_growth_l1,rrec_growth_w1,rrec_growth_l2,
	rrec_growth_w2,rgrowth_note,rapper_ch1,rapper_ch2,rapper_ch3,rapper_cc1,rapper_cc2,rapper_cc3,rapper_st,rapper_st2,rapper_st3,rapper_pf1,rapper_pf2,rapper_pf3,rapper_pb1,
	rapper_pb2,rapper_pb3,rapper_acetate,rapper_cotton,rapper_nylon,rapper_poly,rapper_acrylic,rapper_wool,rapper_note,rfibre_transfer,rfibre_grade,rfibre_note,rodour,rodour_note,
	rcurling,rcurling_note,rwick_l1,rwick_w1,rwick_l2,rwick_w2,rwick_l3,rwick_w3,rwick_note,rabsor_f1,rabsor_f2,rabsor_f3,rabsor_b1,rabsor_b2,rabsor_b3,rabsor_note,rdry1,rdry2,
	rdry3,rdry_note,rrepp1,rrepp2,rrepp3,rrepp4,rrepp_note,rph,rph_note,rsoil,rsoil_note,tgl_buat,tgl_update) VALUES 
	('$rcek2[no_item]','$_GET[no_hanger]','$_POST[rflamability]','$_POST[rfla_note]','$_POST[rfc_cott]','$_POST[rfc_poly]','$_POST[rfc_ela]','$_POST[rfc_cott1]','$_POST[rfc_poly1]',
	'$_POST[rfc_ela1]','$_POST[std_rfc_cott1]','$_POST[std_rfc_poly1]','$_POST[std_rfc_elastane1]','$_POST[rfibercontent]','$_POST[rfiber_note]','$_POST[rwpi]','$_POST[rcpi]',
	'$_POST[rfc_note]','$_POST[rfabric_weight]','$_POST[rfwe_note]','$_POST[rfabric_width]','$_POST[rfwi_note]','$_POST[rbow]','$_POST[rskew]','$_POST[rbas_note]',
	'$_POST[rh_shrinkage_l1]','$_POST[rh_shrinkage_w1]','$_POST[rh_shrinkage_grd]','$_POST[rh_shrinkage_note]','$_POST[rss_temp]','$_POST[rss_washes3]','$_POST[rss_washes10]',
	'$_POST[rss_washes15]','$_POST[rss_cmt]','$_POST[rshrinkage_len1]','$_POST[rshrinkage_len2]','$_POST[rshrinkage_len3]','$_POST[rshrinkage_len4]','$_POST[rshrinkage_len5]',
	'$_POST[rshrinkage_len6]','$_POST[rshrinkage_wid1]','$_POST[rshrinkage_wid2]','$_POST[rshrinkage_wid3]','$_POST[rshrinkage_wid4]','$_POST[rshrinkage_wid5]',
	'$_POST[rshrinkage_wid6]','$_POST[rspirality1]','$_POST[rspirality2]','$_POST[rspirality3]','$_POST[rspirality4]','$_POST[rspirality5]','$_POST[rspirality6]',
	'$_POST[rss_linedry]','$_POST[rss_tumbledry]','$_POST[rsns_note]','$_POST[rapperss_ch1]','$_POST[rapperss_ch2]','$_POST[rapperss_ch3]','$_POST[rapperss_ch4]',
	'$_POST[rapperss_cc1]','$_POST[rapperss_cc2]','$_POST[rapperss_cc3]','$_POST[rapperss_cc4]','$_POST[rapperss_st]','$_POST[rapperss_pf1]','$_POST[rapperss_pf2]',
	'$_POST[rapperss_pf3]','$_POST[rapperss_pf4]','$_POST[rapperss_pb1]','$_POST[rapperss_pb2]','$_POST[rapperss_pb3]','$_POST[rapperss_pb4]','$_POST[rapperss_sf1]',
	'$_POST[rapperss_sf2]','$_POST[rapperss_sf3]','$_POST[rapperss_sf4]','$_POST[rapperss_sb1]','$_POST[rapperss_sb2]','$_POST[rapperss_sb3]','$_POST[rapperss_sb4]',
	'$_POST[rapperss_note]','$_POST[rpillingm_f1]','$_POST[rpillingm_b1]','$_POST[rpillingm_f2]','$_POST[rpillingm_b2]','$_POST[rpillingm_f3]','$_POST[rpillingm_b3]',
	'$_POST[rpillingm_f4]','$_POST[rpillingm_b4]','$_POST[rpillingm_f5]','$_POST[rpillingm_b5]','$_POST[rpillm_note]','$_POST[rpillingl_f1]','$_POST[rpillingl_b1]',
	'$_POST[rpillingl_f2]','$_POST[rpillingl_b2]','$_POST[rpillingl_f3]','$_POST[rpillingl_b3]','$_POST[rpillingl_f4]','$_POST[rpillingl_b4]','$_POST[rpillingl_f5]',
	'$_POST[rpillingl_b5]','$_POST[rpilll_note]','$_POST[rpillingb_f1]','$_POST[rpillingb_b1]','$_POST[rpillingb_f2]','$_POST[rpillingb_b2]','$_POST[rpillingb_f3]',
	'$_POST[rpillingb_b3]','$_POST[rpillingb_f4]','$_POST[rpillingb_b4]','$_POST[rpillingb_f5]','$_POST[rpillingb_b5]','$_POST[rpillb_note]','$_POST[rpillingrt_f1]',
	'$_POST[rpillingrt_b1]','$_POST[rpillingrt_f2]','$_POST[rpillingrt_b2]','$_POST[rpillingrt_f3]','$_POST[rpillingrt_b3]','$_POST[rpillingrt_f4]','$_POST[rpillingrt_b4]',
	'$_POST[rpillingrt_f5]','$_POST[rpillingrt_b5]','$_POST[rpillr_note]','$_POST[rabr]','$_POST[rabr_note]','$_POST[rsnaggingm_l1]','$_POST[rsnaggingm_w1]','$_POST[rsnaggingm_l2]',
	'$_POST[rsnaggingm_w2]','$_POST[rsnaggingm_l3]','$_POST[rsnaggingm_w3]','$_POST[rsnaggingm_l4]','$_POST[rsnaggingm_w4]','$_POST[rsnam_note]','$_POST[rsp_grdl1]',
	'$_POST[rsp_clsl1]','$_POST[rsp_shol1]','$_POST[rsp_medl1]','$_POST[rsp_lonl1]','$_POST[rsp_grdw1]','$_POST[rsp_clsw1]','$_POST[rsp_show1]','$_POST[rsp_medw1]','$_POST[rsp_lonw1]',
	'$_POST[rsp_grdl2]','$_POST[rsp_clsl2]','$_POST[rsp_shol2]','$_POST[rsp_medl2]','$_POST[rsp_lonl2]','$_POST[rsp_grdw2]','$_POST[rsp_clsw2]','$_POST[rsp_show2]','$_POST[rsp_medw2]',
	'$_POST[rsp_lonw2]','$_POST[rsnap_note]','$_POST[rsnaggingb_l1]','$_POST[rsnaggingb_w1]','$_POST[rsnaggingb_l2]','$_POST[rsnaggingb_w2]','$_POST[rsnaggingb_l3]',
	'$_POST[rsnaggingb_w3]','$_POST[rsnaggingb_l4]','$_POST[rsnaggingb_w4]','$_POST[rsnab_note]','$_POST[rinstron]','$_POST[rmullen]','$_POST[rtru_burst]','$_POST[rtru_burst2]',
	'$_POST[rburs_note]','$_POST[rthick1]','$_POST[rthick2]','$_POST[rthick3]','$_POST[rthickav]','$_POST[rthick_note]','$_POST[rstretch_l1]','$_POST[rstretch_w1]',
	'$_POST[rstretch_l2]','$_POST[rstretch_w2]','$_POST[rstretch_l3]','$_POST[rstretch_w3]','$_POST[rstretch_l4]','$_POST[rstretch_w4]','$_POST[rstretch_l5]','$_POST[rstretch_w5]',
	'$_POST[rload_stretch]','$_POST[rstretch_note]','$_POST[rrecover_l1]','$_POST[rrecover_w1]','$_POST[rrecover_l2]','$_POST[rrecover_w2]','$_POST[rrecover_l3]',
	'$_POST[rrecover_w3]','$_POST[rrecover_l4]','$_POST[rrecover_w4]','$_POST[rrecover_l5]','$_POST[rrecover_w5]','$_POST[rrecover_note]','$_POST[rgrowth_l1]','$_POST[rgrowth_w1]',
	'$_POST[rgrowth_l2]','$_POST[rgrowth_w2]','$_POST[rrec_growth_l1]','$_POST[rrec_growth_w1]','$_POST[rrec_growth_l2]','$_POST[rrec_growth_w2]','$_POST[rgrowth_note]',
	'$_POST[rapper_ch1]','$_POST[rapper_ch2]','$_POST[rapper_ch3]','$_POST[rapper_cc1]','$_POST[rapper_cc2]','$_POST[rapper_cc3]','$_POST[rapper_st]','$_POST[rapper_st2]',
	'$_POST[rapper_st3]','$_POST[rapper_pf1]','$_POST[rapper_pf2]','$_POST[rapper_pf3]','$_POST[rapper_pb1]','$_POST[rapper_pb2]','$_POST[rapper_pb3]','$_POST[rapper_acetate]',
	'$_POST[rapper_cotton]','$_POST[rapper_nylon]','$_POST[rapper_poly]','$_POST[rapper_acrylic]','$_POST[rapper_wool]','$_POST[rapper_note]','$_POST[rfibre_transfer]',
	'$_POST[rfibre_grade]','$_POST[rfibre_note]','$_POST[rodour]','$_POST[rodour_note]','$_POST[rcurling]','$_POST[rcurling_note]','$_POST[rwick_l1]','$_POST[rwick_w1]',
	'$_POST[rwick_l2]','$_POST[rwick_w2]','$_POST[rwick_l3]','$_POST[rwick_w3]','$_POST[rwick_note]','$_POST[rabsor_f1]','$_POST[rabsor_f2]','$_POST[rabsor_f3]',
	'$_POST[rabsor_b1]','$_POST[rabsor_b2]','$_POST[rabsor_b3]','$_POST[rabsor_note]','$_POST[rdry1]','$_POST[rdry2]','$_POST[rdry3]','$_POST[rdry_note]','$_POST[rrepp1]',
	'$_POST[rrepp3]','$_POST[rrepp3]','$_POST[rrepp4]','$_POST[rrepp_note]','$_POST[rph]','$_POST[rph_note]', '$_POST[rsoil]', '$_POST[rsoil_note]',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ");
	
	 if($sqlPHY){
		$sql_tempPHY=sqlsrv_query($con_db_qc_sqlsrv,"INSERT INTO db_qc.tbl_tq_temp_random 
		(no_item,no_hanger,temp_rprt_f1,temp_rprt_b1,temp_rpb_f1,temp_rsp_grdl1,temp_rsp_clsl1,temp_rsp_shol1,temp_rsp_medl1,temp_rsp_lonl1,temp_rsp_grdw1,temp_rsp_clsw1,temp_rsp_show1,
		temp_rsp_medw1,temp_rsp_lonw1,temp_rsp_grdl2,temp_rsp_grdw2,temp_rsm_l1,temp_rsm_w1,temp_rbs_instron,temp_rbs_tru,temp_rbs_mullen,temp_rpm_f1,temp_rpm_f2,temp_rstretch_l1,
		temp_rstretch_w1,temp_rrecover_l1,temp_rrecover_w1,temp_rwick_l2,temp_rwick_w2,temp_rabsor_b1,temp_rdryaf1,sts,tgl_buat,tgl_update) VALUES 
		('$rcek2[no_item]','$_GET[no_hanger]','$_POST[rpillingrt_f1]','$_POST[rpillingrt_b1]','$_POST[rpillingb_f1]','$_POST[rsp_grdl1]','$_POST[rsp_clsl1]','$_POST[rsp_shol1]',
		'$_POST[rsp_medl1]','$_POST[rsp_lonl1]','$_POST[rsp_grdw1]','$_POST[rsp_clsw1]','$_POST[rsp_show1]','$_POST[rsp_medw1]','$_POST[rsp_lonw1]','$_POST[rsp_grdl2]',
		'$_POST[rsp_grdw2]','$_POST[rsnaggingm_l1]','$_POST[rsnaggingm_w1]','$_POST[rinstron]','$_POST[rtru_burst]','$_POST[rmullen]','$_POST[rpillingm_f1]','$_POST[rpillingm_f2]',
		'$_POST[rstretch_l1]','$_POST[rstretch_w1]','$_POST[rrecover_l1]','$_POST[rrecover_w1]','$_POST[rwick_l2]','$_POST[rwick_w2]','$_POST[rabsor_b1]','$_POST[rdryaf1]',
		'1',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ");
			...
			$sql_tempPHY1=sqlsrv_query($con_db_qc_sqlsrv,"INSERT INTO db_qc.tbl_tq_temp_random2 
			(no_item,no_hanger,temp_rprt_f1,temp_rprt_b1,temp_rpb_f1,temp_rsp_grdl1,temp_rsp_clsl1,temp_rsp_shol1,temp_rsp_medl1,temp_rsp_lonl1,temp_rsp_grdw1,temp_rsp_clsw1,
			temp_rsp_show1,temp_rsp_medw1,temp_rsp_lonw1,temp_rsp_grdl2,temp_rsp_grdw2,temp_rsm_l1,temp_rsm_w1,temp_rbs_instron,temp_rbs_tru,temp_rbs_mullen,temp_rpm_f1,temp_rpm_f2,
			temp_rstretch_l1,temp_rstretch_w1,temp_rrecover_l1,temp_rrecover_w1,temp_rwick_l2,temp_rwick_w2,temp_rabsor_b1,temp_rdryaf1,sts,tgl_buat,tgl_update) VALUES 
			('$rcek2[no_item]','$_GET[no_hanger]','$_POST[rpillingrt_f1]','$_POST[rpillingrt_b1]','$_POST[rpillingb_f1]','$_POST[rsp_grdl1]','$_POST[rsp_clsl1]','$_POST[rsp_shol1]',
			'$_POST[rsp_medl1]','$_POST[rsp_lonl1]','$_POST[rsp_grdw1]','$_POST[rsp_clsw1]','$_POST[rsp_show1]','$_POST[rsp_medw1]','$_POST[rsp_lonw1]','$_POST[rsp_grdl2]',
			'$_POST[rsp_grdw2]','$_POST[rsnaggingm_l1]','$_POST[rsnaggingm_w1]','$_POST[rinstron]','$_POST[rtru_burst]','$_POST[rmullen]','$_POST[rpillingm_f1]','$_POST[rpillingm_f2]',
			'$_POST[rstretch_l1]','$_POST[rstretch_w1]','$_POST[rrecover_l1]','$_POST[rrecover_w1]','$_POST[rwick_l2]','$_POST[rwick_w2]','$_POST[rabsor_b1]','$_POST[rdryaf1]',
			...
			$sql_PHYWarna=sqlsrv_query($con_db_qc_sqlsrv,"INSERT INTO db_qc.tbl_tq_random_warna 
			(no_item,no_hanger,rflamabilityw,rfc_cott1w,rfc_poly1w,rfc_ela1w,rwpiw,rcpiw,rf_weightw,rf_widthw,rboww,rskeww,rssw,rapperssw,rpmw,rplw,rpbw,rprtw,rsmw,rspw,rsbw,rbsw,
			rthickw,rstretchw,rrecoverw,rgrowthw,rrec_growthw,rapperw,rh_shrinkagew,rfibrew,rodourw,rcurlingw,rnedlew,tgl_buat,tgl_update) VALUES 
			('$rcek2[no_item]','$_GET[no_hanger]','$_POST[rflamabilityw]','$_POST[rfc_cott1w]','$_POST[rfc_poly1w]','$_POST[rfc_ela1w]','$_POST[rwpiw]','$_POST[rcpiw]',
			'$_POST[rf_weightw]','$_POST[rf_widthw]','$_POST[rboww]','$_POST[rskeww]','$_POST[rssw]','$_POST[rapperssw]','$_POST[rpmw]','$_POST[rplw]','$_POST[rpbw]',
			'$_POST[rprtw]','$_POST[rsmw]','$_POST[rspw]','$_POST[rsbw]','$_POST[rbsw]','$_POST[rthickw]','$_POST[rstretchw]','$_POST[rrecoverw]','$_POST[rgrowthw]',
			'$_POST[rrec_growthw]','$_POST[rapperw]','$_POST[rh_shrinkagew]','$_POST[rfibrew]','$_POST[rodourw]','$_POST[rcurlingw]','$_POST[rnedlew]',
			CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ");
...
if($_POST['colorfastness_save']=="save" and $cekR>0){
	$sqlCLR=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_randomtest SET
  ...
  if (result.value) {
	...
	$sqlCLR=sqlsrv_query($con_db_qc_sqlsrv,"INSERT INTO db_qc.tbl_tq_randomtest 
	(no_item,no_hanger,rwash_temp,rwash_colorchange,rwash_acetate,rwash_cotton,rwash_nylon,rwash_poly,rwash_acrylic,rwash_wool,rwash_staining,rwash_note,rwater_colorchange,
	rwater_acetate,rwater_cotton,rwater_nylon,rwater_poly,rwater_acrylic,rwater_wool,rwater_staining,rwater_note,racid_colorchange,racid_acetate,racid_cotton,racid_nylon,
	racid_poly,racid_acrylic,racid_wool,racid_staining,racid_note,ralkaline_colorchange,ralkaline_acetate,ralkaline_cotton,ralkaline_nylon,ralkaline_poly,ralkaline_acrylic,
	ralkaline_wool,ralkaline_staining,ralkaline_note,rcrock_len1,rcrock_wid1,rcrock_len2,rcrock_wid2,rcrock_note,rphenolic_colorchange,rphenolic_note,rcm_printing_colorchange,
	rcm_printing_staining,rcm_printing_note,rcm_dye_temp,rcm_dye_colorchange,rcm_dye_stainingface,rcm_dye_stainingback,rcm_dye_note,rlight_rating1,rlight_rating2,rlight_note,
	rlight_pers_colorchange,rlight_pers_note,rsaliva_staining,rsaliva_note,rbleeding,rbleeding_note,rchlorin,rnchlorin1,rnchlorin2,rchlorin_note,rdye_tf_sstaining,
	rdye_tf_cstaining,rdye_tf_acetate,rdye_tf_cotton,rdye_tf_nylon,rdye_tf_poly,rdye_tf_acrylic,rdye_tf_wool,rdye_tf_note,tgl_buat,tgl_update) VALUES 
	('$rcek2[no_item]','$_GET[no_hanger]','$_POST[rwash_temp]','$_POST[rwash_colorchange]','$_POST[rwash_acetate]','$_POST[rwash_cotton]','$_POST[rwash_nylon]','$_POST[rwash_poly]',
	'$_POST[rwash_acrylic]','$_POST[rwash_wool]','$_POST[rwash_staining]','$_POST[rwash_note]','$_POST[rwater_colorchange]','$_POST[rwater_acetate]','$_POST[rwater_cotton]',
	'$_POST[rwater_nylon]','$_POST[rwater_poly]','$_POST[rwater_acrylic]','$_POST[rwater_wool]','$_POST[rwater_staining]','$_POST[rwater_note]','$_POST[racid_colorchange]',
	'$_POST[racid_acetate]','$_POST[racid_cotton]','$_POST[racid_nylon]','$_POST[racid_poly]','$_POST[racid_acrylic]','$_POST[racid_wool]','$_POST[racid_staining]',
	'$_POST[racid_note]','$_POST[ralkaline_colorchange]','$_POST[ralkaline_acetate]','$_POST[ralkaline_cotton]','$_POST[ralkaline_nylon]','$_POST[ralkaline_poly]',
	'$_POST[ralkaline_acrylic]','$_POST[ralkaline_wool]','$_POST[ralkaline_staining]','$_POST[ralkaline_note]','$_POST[rcrock_len1]','$_POST[rcrock_wid1]','$_POST[rcrock_len2]',
	'$_POST[rcrock_wid2]','$_POST[rcrock_note]','$_POST[rphenolic_colorchange]','$_POST[rphenolic_note]','$_POST[rcm_printing_colorchange]','$_POST[rcm_printing_staining]',
	'$_POST[rcm_printing_note]','$_POST[rcm_dye_temp]','$_POST[rcm_dye_colorchange]','$_POST[rcm_dye_stainingface]','$_POST[rcm_dye_stainingback]','$_POST[rcm_dye_note]',
	'$_POST[rlight_rating1]','$_POST[rlight_rating2]','$_POST[rlight_note]','$_POST[rlight_pers_colorchange]','$_POST[rlight_pers_note]','$_POST[rsaliva_staining]',
	'$_POST[rsaliva_note]','$_POST[rbleeding]','$_POST[rbleeding_note]','$_POST[rchlorin]','$_POST[rnchlorin1]','$_POST[rnchlorin2]','$_POST[rchlorin_note]','$_POST[rdye_tf_sstaining]',
	'$_POST[rdye_tf_cstaining]','$_POST[rdye_tf_acetate]','$_POST[rdye_tf_cotton]','$_POST[rdye_tf_nylon]','$_POST[rdye_tf_poly]','$_POST[rdye_tf_acrylic]','$_POST[rdye_tf_wool]',
	'$_POST[rdye_tf_note]',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ");
...
if($_POST['functional_save']=="save" and $cekR>0 and $cekTR>0 and $cekTR2>0 and $cekRW>0){
	$sqlFPH=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_randomtest SET
	...
	");
	if($sqlFPH){
		$sql_FPHWarna=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_random_warna SET
			...
			");
		if($_POST['sts_random']=="2"){
			$sql_tempFPH=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_temp_random SET
			 temp_rwick_l2='$_POST[rwick_l2]',
			 temp_rwick_w2='$_POST[rwick_w2]',
			 temp_rabsor_b1='$_POST[rabsor_b1]',
			 temp_rdryaf1='$_POST[rdryaf1]',
			...
			$sql_tempFPH1=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_temp_random2 SET
			sts='2'
			WHERE no_hanger='$nohanger'");
			}else if($_POST['sts_random2']=="2"){
			$sql_tempFPH=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_temp_random2 SET
			 temp_rwick_l2='$_POST[rwick_l2]',
			 temp_rwick_w2='$_POST[rwick_w2]',
			 temp_rabsor_b1='$_POST[rabsor_b1]',
			 temp_rdryaf1='$_POST[rdryaf1]',
			...
			$sql_tempFPH1=sqlsrv_query($con_db_qc_sqlsrv,"UPDATE db_qc.tbl_tq_temp_random SET
			sts='2'
			WHERE no_hanger='$nohanger'");
			}
	echo "<script>swal({
  ...
  if (result.value) {
	...
	");
	if($sqlFPH){
		$sql_FPHWarna=sqlsrv_query($con_db_qc_sqlsrv,"INSERT INTO db_qc.tbl_tq_random_warna 
		(no_item,no_hanger,rwickw_ori,rwickw_af,rabsorw_ori,rabsorw_af,rdryw_ori,rdryw_af,rreppw_ori,rreppw_af,rphw,rsoilw,rhumidityw,tgl_buat,tgl_update) VALUES 
		('$rcek2[no_item]','$_GET[no_hanger]', '$_POST[rwickw_ori]', '$_POST[rwickw_af]', '$_POST[rabsorw_ori]', '$_POST[rabsorw_af]', '$_POST[rdryw_ori]', '$_POST[rdryw_af]',
		 '$_POST[rreppw_ori]', '$_POST[rreppw_af]', '$_POST[rphw]', '$_POST[rsoilw]', '$_POST[rhumidityw]',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ");
  ...
  if (result.value) {
	...
	if($sqlFPH){
		...
		('$rcek2[no_item]','$_GET[no_hanger]', '$_POST[rwickw_ori]', '$_POST[rwickw_af]', '$_POST[rabsorw_ori]', '$_POST[rabsorw_af]', '$_POST[rdryw_ori]', '$_POST[rdryw_af]', 
		'$_POST[rreppw_ori]', '$_POST[rreppw_af]', '$_POST[rphw]', '$_POST[rsoilw]', '$_POST[rhumidityw]',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ");
		$sql_tempFPH=sqlsrv_query($con_db_qc_sqlsrv,"INSERT INTO db_qc.tbl_tq_temp_random 
		(no_item,no_hanger,temp_rwick_l2,temp_rwick_w2,temp_rabsor_b1,temp_rdryaf1,sts,tgl_buat,tgl_update) VALUES 
		('$rcek2[no_item]','$_GET[no_hanger]','$_POST[rwick_l2]','$_POST[rwick_w2]','$_POST[rabsor_b1]','$_POST[rdryaf1]','1',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ");
		$sql_tempFPH1=sqlsrv_query($con_db_qc_sqlsrv,"INSERT INTO db_qc.tbl_tq_temp_random2 
		(no_item,no_hanger,temp_rwick_l2,temp_rwick_w2,temp_rabsor_b1,temp_rdryaf1,sts,tgl_buat,tgl_update) VALUES 
		('$rcek2[no_item]','$_GET[no_hanger]','$_POST[rwick_l2]','$_POST[rwick_w2]','$_POST[rabsor_b1]','$_POST[rdryaf1]','2',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP) ");
  ...
  if (result.value) {
	...
	$sqlFPH=sqlsrv_query($con_db_qc_sqlsrv,"INSERT INTO db_qc.tbl_tq_randomtest 
	(no_item,no_hanger,rwick_l1,rwick_w1,rwick_l2,rwick_w2,rwick_l3,rwick_w3,rwick_l4,rwick_w4,rwick_note,rabsor_f1,rabsor_f2,rabsor_f3,rabsor_b1,rabsor_b2,rabsor_b3,rabsor_note,
	rdry1,rdry2,rdry3,rdryaf1,rdryaf2,rdryaf3,rdry_note,rrepp1,rrepp2,rrepp3,rrepp4,rrepp_note,rph,rph_note,rsoil,rsoil_note,rhumidity,rhumidity_note,tgl_buat,tgl_update) VALUES 
	('$rcek2[no_item]','$_GET[no_hanger]', '$_POST[rwick_l1]', '$_POST[rwick_w1]', '$_POST[rwick_l2]', '$_POST[rwick_w2]', '$_POST[rwick_l3]', '$_POST[rwick_w3]', '$_POST[rwick_l4]', 
	'$_POST[rwick_w4]', '$_POST[rwick_note]', '$_POST[rabsor_f1]', '$_POST[rabsor_f2]', '$_POST[rabsor_f3]', '$_POST[rabsor_b1]', '$_POST[rabsor_b2]', '$_POST[rabsor_b3]', 
	'$_POST[rabsor_note]', '$_POST[rdry1]', '$_POST[rdry2]', '$_POST[rdry3]', '$_POST[rdryaf1]', '$_POST[rdryaf2]', '$_POST[rdryaf3]', '$_POST[rdry_note]', '$_POST[rrepp1]', 
	'$_POST[rrepp2]', '$_POST[rrepp3]', '$_POST[rrepp4]', '$_POST[rrepp_note]', '$_POST[rph]', '$_POST[rph_note]', '$_POST[rsoil]', '$_POST[rsoil_note]', '$_POST[rhumidity]', 
	'$_POST[rhumidity_note]',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP  ) ");

    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <a href="FormSchedule" class="btn btn-success <?php if ($_SESSION['akses'] == "biasa" or $_SESSION['lvl_id'] != "INSPEKSI") {
            echo "disabled";
                  ...
                  <tr bgcolor="<?php echo $bgcolor; ?>">
                    <td align="center">
                      <div class="btn-group">
                        ...
                        <a href="#" onclick="confirm_del('HapusSch-<?php echo $rowd['id'] ?>');" class="btn btn-xs btn-danger <?php if ($_SESSION['akses'] == "biasa" or $rCEk['idb'] != "" or $rCEk['status'] == "sedang jalan" or $_SESSION['lvl_id'] != "INSPEKSI") {
                             echo "disabled";
                           } ?>"><i class="fa fa-trash"></i></a>
                      </div>
                    </td>
                    <td align="center">
                      <a href="#" id='<?php echo $rowd['no_mesin']; ?>' class="edit_status_mesin <?php if ($_SESSION['lvl_id10'] == "3") {
                           echo "disabled";
                         } ?>">
                      ...
                      <?php if ($rowd['diff'] >= 20) { ?>
                        <span class='badge bg-red blink_me'>
                          <?php echo "Harus Segera di Inspek!"; ?>
                        </span>
                      <?php } ?>
                    </td>
                    <td align="center">
                      <?php echo $rowd['no_urut']; ?><br />
                      ...
                      <?php else: ?>
                        <a href="FormInspeksiKain-<?= $rowd['nodemand']; ?>" target="blank" id='<?php echo $rowd['id']; ?>'
                          class="btn btn-xs btn-info <?php if ($rowd['no_urut'] != "1") {
                            echo " hidden ";
                          } ?>"> Inspeksi </a>
                      <?php endif; ?>
                    </td>
                    ...
                    <td>
                      <?php echo $rowd['ket_status']; ?><br />
                      <i>
                        <?php echo $rowd['nokk']; ?>
                      </i><br />
                      <i>
                        <?php echo $rowd['nodemand']; ?>
                      </i><br />

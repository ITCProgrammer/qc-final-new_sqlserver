...
<div class="box box-info" style="width: 98%;">
    ...
    <div class="box-body"> 
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                        <?php foreach ($array_no_demand_other2 as $key => $data_other) {
                            ...
                            ?>
                                <div style="border:solid thin <?= $border_color ?>; float:left;margin-left:22px;padding:6px "><?= $data_other ?></div>
                        <?php } ?>             
                    </div>
            </div> 
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input name="nodemand" type="text" class="form-control" id="nodemand" placeholder="No Demand" value="<?php if ($rd['nodemand_new'] != '') {
                        echo $rd['nodemand_new'];
                    } else if ($rd['nodemand_new'] == '') {
                        echo $rd['nodemand'];
                    } else {
                        echo $_GET['nodemand'];
                    } ?>" onchange="window.location='SummaryTQNokkNew-'+this.value" required>
                </div>
                <div class="col-sm-5">
                        <?php foreach ($array_no_demand_other3_4 as $data_other) { ?>
                                <div style="border:solid thin #ddd; float:left; margin-left:22px;padding:6px "><?= $data_other ?></div>
                        <?php } ?>             
                </div>				
            ...
            <?php if (count($array_no_demand_other5_6) > 0) { ?>
                <div class="form-group">
                    <label for="buyer" class="col-sm-3 control-label"></label>
                    <div class="col-sm-4">
                    </div>
                        <div class="col-sm-5">
            ...
            <div class="box">
              <div class="box-header">
                <small class="pull-right">Date: <?php echo $rcek1['tgl_buat']; ?></small>
                  <div class="box-body">
                    <table id="example1-sumarytq-new" class="table table-bordered table-hover table-striped" width="100%"> 
                        <thead class="bg-blue">
                            <tr>
                        ...
                        <tbody>
                                ...
                                <?php if (in_array("FLAMMABILITY", $detail)) { ?>
                                    <tr>
                                        <td align="left" ><a href="Testing2New-<?php echo $row['nodemand']; ?>-<?php echo $row['no_test']; ?>" class="btn btn-info btn-xs <?php if ($_SESSION['akses'] == 'biasa') {
                                                echo "disabled";
                                            } ?>"><?php if (in_array("FLAMMABILITY", $detail)) {
                                                echo "FLAMMABILITY";
                                            } ?></a></td>
                                        ...
                                        <td align="center" ><?php if ($row['fla_note'] != "") {
                                            echo $row['fla_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("FIBER CONTENT", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['fiber_note'] != "") {
                                            echo $row['fiber_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("FABRIC COUNT", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['fc_note'] != "") {
                                            echo $row['fc_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("BOW & SKEW", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['bas_note'] != "") {
                                            echo $row['bas_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("PILLING MARTINDLE", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['pillm_note'] != "") {
                                            echo $row['pillm_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("PILLING LOCUS", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['pilll_note'] != "") {
                                            echo $row['pilll_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['fwe_note'] != "") {
                                            echo $row['fwe_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['fwi_note'] != "") {
                                            echo $row['fwi_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['sns_note'] != "") {
                                            echo $row['sns_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                 ...
                                 <?php if (in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" >
                                        <?php if ($row['spirality_status'] == "DISPOSISI") { ?> <span class='label bg-yellow blink_me'><?php echo "DISPOSISI"; ?></span> 
                                        <?php } else if ($row['spirality_status'] == "FAIL") { ?> <span class='label bg-red blink_me'><?php echo "FAIL"; ?></span>
                                        <?php } else if ($row['spirality_status'] == "MARGINAL PASS") { ?> <span class='label bg-purple'><?php echo "MARGINAL PASS"; ?></span> 
                                        <?php } else if ($row['spirality_status'] == "DATA") { ?> <span class='label bg-blue'><?php echo "DATA"; ?></span>  
                                        <?php } else if ($row['spirality_status'] == "PASS") { ?> <span class='label bg-green'><?php echo "PASS"; ?></span>
                                        <?php } else if ($row['spirality_status'] == "R") { ?> <span class='label bg-orange'><?php echo "R"; ?></span>
                                        <?php } else if ($row['spirality_status'] == "RANDOM") { ?> <span class='label bg-maroon'><?php echo "RANDOM"; ?></span>
                                        <?php } else if ($row['spirality_status'] == "A") { ?> <span class='label bg-teal'><?php echo "A"; ?></span> <?php } ?> 
                                        </td>
                                ...
                                <?php if (in_array("PILLING BOX", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['pillb_note'] != "") {
                                            echo $row['pillb_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("PILLING RANDOM TUMBLER", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['pillr_note'] != "") {
                                            echo $row['pillr_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("ABRATION", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['abr_note'] != "") {
                                            echo $row['abr_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("SNAGGING MACE", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['snam_note'] != "") {
                                            echo $row['snam_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("SNAGGING POD", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['snap_note'] != "") {
                                            echo $row['snap_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("BEAN BAG", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['snab_note'] != "") {
                                            echo $row['snab_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if ($row['bs_instron'] != "") { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['burs_note'] != "") {
                                            echo $row['burs_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                ...
                                <?php if (in_array("THICKNESS", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['thick_note'] != "") {
                                            echo $row['thick_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("STRETCH & RECOVERY", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['stretch_note'] != "" or $row['recover_note'] != "") {
                                ...
                                <?php if (in_array("GROWTH", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['growth_note'] != "") {
                                ...
                                <?php if (in_array("APPEARANCE", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['apper_note'] != "") {
                                            echo $row['apper_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("HEAT SHRINKAGE", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['h_shrinkage_note'] != "") {
                                ...
                                <?php if (in_array("FIBRE/FUZZ", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['fibre_note'] != "") {
                                            echo $row['fibre_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("ODOUR", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['odour_note'] != "") {
                                            echo $row['odour_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("CURLING", $detail)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['curling_note'] != "") {
                                            echo $row['curling_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("WICKING", $detail2)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['wick_note'] != "") {
                                            echo $row['wick_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("ABSORBENCY", $detail2)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['absor_note'] != "") {
                                            echo $row['absor_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("DRYING TIME", $detail2)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['dry_note'] != "") {
                                            echo $row['dry_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("WATER REPPELENT", $detail2)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['repp_note'] != "") {
                                            echo $row['repp_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("PH", $detail2)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['ph_note'] != "") {
                                            echo $row['ph_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("SOIL RELEASE", $detail2)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['soil_note'] != "") {
                                            echo $row['soil_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("HUMIDITY", $detail2)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['humidity_note'] != "") {
                                            echo $row['humidity_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("WASHING", $detail3)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['wash_note'] != "") {
                                            echo $row['wash_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("PERSPIRATION ACID", $detail3)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['acid_note'] != "") {
                                            echo $row['acid_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("PERSPIRATION ALKALINE", $detail3)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['alkaline_note'] != "") {
                                ...
                                <?php if (in_array("WATER", $detail3)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['water_note'] != "") {
                                            echo $row['water_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("CROCKING", $detail3)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['crock_note'] != "") {
                                            echo $row['crock_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("PHENOLIC YELLOWING", $detail3)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['phenolic_note'] != "") {
                                ...
                                <?php if (in_array("LIGHT", $detail3)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['light_note'] != "") {
                                            echo $row['light_note'];
                                        } ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (in_array("COLOR MIGRATION-OVEN TEST", $detail3)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['cm_printing_note'] != "") {
                                ...
                                <?php if (in_array("COLOR MIGRATION", $detail3)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['cm_dye_note'] != "") {
                                ...
                                <?php if (in_array("LIGHT PERSPIRATION", $detail3)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['light_pers_note'] != "") {
                                ...
                                <?php if (in_array("SALIVA", $detail3)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['saliva_note'] != "") {
                                ...
                                <?php if (in_array("BLEEDING", $detail3)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['bleeding_note'] != "") {
                                ...
                                <?php if (in_array("CHLORIN & NON-CHLORIN", $detail3)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['chlorin_note'] != "") {
                                ...
                                <?php if (in_array("DYE TRANSFER", $detail3)) { ?>
                                    <tr>
                                        ...
                                        <td align="center" ><?php if ($row['dye_tf_note'] != "") {
                                ...
                                <?php
                                #47 Test
                                if (in_array("FLAMMABILITY", $detail) and $row['stat_fla'] != "") {
                                    $Fla = "True";
                                } else {
                                    $Fla = "False";
                                }
                                if (in_array("FIBER CONTENT", $detail) and $row['stat_fib'] != "") {
                                    $Fib = "True";
                                } else {
                                    $Fib = "False";
                                }
                                if (in_array("FABRIC COUNT", $detail) and $row['stat_fc'] != "") {
                                    $Fc = "True";
                                } else {
                                    $Fc = "False";
                                }
                                if (in_array("BOW & SKEW", $detail) and $row['stat_bsk'] != "") {
                                    $Bsk = "True";
                                } else {
                                    $Bsk = "False";
                                }
                                if (in_array("PILLING MARTINDLE", $detail) and $row['stat_pm'] != "") {
                                    $Pm = "True";
                                } else {
                                    $Pm = "False";
                                }
                                if (in_array("PILLING LOCUS", $detail) and $row['stat_pl'] != "") {
                                    $Pl = "True";
                                } else {
                                    $Pl = "False";
                                }
                                if (in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY", $detail) and $row['stat_fwss2'] != "") {
                                    $Fwss2 = "True";
                                } else {
                                    $Fwss2 = "False";
                                }
                                if (in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY", $detail) and $row['stat_fwss3'] != "") {
                                    $Fwss3 = "True";
                                } else {
                                    $Fwss3 = "False";
                                }
                                if (in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY", $detail) and $row['stat_fwss'] != "") {
                                    $Fwss = "True";
                                } else {
                                    $Fwss = "False";
                                }
                                if (in_array("PILLING BOX", $detail) and $row['stat_pb'] != "") {
                                    $Pb = "True";
                                } else {
                                    $Pb = "False";
                                }
                                if (in_array("PILLING RANDOM TUMBLER", $detail) and $row['stat_prt'] != "") {
                                    $Prt = "True";
                                } else {
                                    $Prt = "False";
                                }
                                if (in_array("ABRATION", $detail) and $row['stat_abr'] != "") {
                                    $Abr = "True";
                                } else {
                                    $Abr = "False";
                                }
                                if (in_array("SNAGGING MACE", $detail) and $row['stat_sm'] != "") {
                                    $Sm = "True";
                                } else {
                                    $Sm = "False";
                                }
                                if (in_array("SNAGGING POD", $detail) and $row['stat_sp'] != "") {
                                    $Sp = "True";
                                } else {
                                    $Sp = "False";
                                }
                                if (in_array("BEAN BAG", $detail) and $row['stat_sb'] != "") {
                                    $Sb = "True";
                                } else {
                                    $Sb = "False";
                                }
                                if (in_array("BURSTING STRENGTH", $detail) and $row['stat_bs2'] != "") {
                                    $Bs2 = "True";
                                } else {
                                    $Bs2 = "False";
                                }
                                if (in_array("BURSTING STRENGTH", $detail) and $row['stat_bs3'] != "") {
                                    $Bs3 = "True";
                                } else {
                                    $Bs3 = "False";
                                }
                                if (in_array("BURSTING STRENGTH", $detail) and $row['stat_bs'] != "") {
                                    $Bs = "True";
                                } else {
                                    $Bs = "False";
                                }
                                if (in_array("THICKNESS", $detail) and $row['stat_th'] != "") {
                                    $Th = "True";
                                } else {
                                    $Th = "False";
                                }
                                if (in_array("STRETCH & RECOVERY", $detail) and $row['stat_sr'] != "") {
                                    $Sr = "True";
                                } else {
                                    $Sr = "False";
                                }
                                if (in_array("GROWTH", $detail) and $row['stat_gr'] != "") {
                                    $Gr = "True";
                                } else {
                                    $Gr = "False";
                                }
                                if (in_array("APPEARANCE", $detail) and $row['stat_ap'] != "") {
                                    $Ap = "True";
                                } else {
                                    $Ap = "False";
                                }
                                if (in_array("HEAT SHRINKAGE", $detail) and $row['stat_hs'] != "") {
                                    $Hs = "True";
                                } else {
                                    $Hs = "False";
                                }
                                if (in_array("FIBRE/FUZZ", $detail) and $row['stat_ff'] != "") {
                                    $Ff = "True";
                                } else {
                                    $Ff = "False";
                                }
                                if (in_array("ODOUR", $detail) and $row['stat_odour'] != "") {
                                    $Odo = "True";
                                } else {
                                    $Odo = "False";
                                }
                                if (in_array("WICKING", $detail2) and $row['stat_wic'] != "") {
                                    $Wic = "True";
                                } else {
                                    $Wic = "False";
                                }
                                if (in_array("ABSORBENCY", $detail2) and $row['stat_abs'] != "") {
                                    $Abs = "True";
                                } else {
                                    $Abs = "False";
                                }
                                if (in_array("DRYING TIME", $detail2) and $row['stat_dry'] != "") {
                                    $Dry = "True";
                                } else {
                                    $Dry = "False";
                                }
                                if (in_array("WATER REPPELENT", $detail2) and $row['stat_wp'] != "") {
                                    $Wp = "True";
                                } else {
                                    $Wp = "False";
                                }
                                if (in_array("PH", $detail2) and $row['stat_ph'] != "") {
                                    $Ph = "True";
                                } else {
                                    $Ph = "False";
                                }
                                if (in_array("SOIL RELEASE", $detail2) and $row['stat_sor'] != "") {
                                    $Sor = "True";
                                } else {
                                    $Sor = "False";
                                }
                                if (in_array("HUMIDITY", $detail2) and $row['stat_hum'] != "") {
                                    $Hum = "True";
                                } else {
                                    $Hum = "False";
                                }
                                if (in_array("WASHING", $detail3) and $row['stat_wf'] != "") {
                                    $Wf = "True";
                                } else {
                                    $Wf = "False";
                                }
                                if (in_array("PERSPIRATION ACID", $detail3) and $row['stat_pac'] != "") {
                                    $Pac = "True";
                                } else {
                                    $Pac = "False";
                                }
                                if (in_array("PERSPIRATION ALKALINE", $detail3) and $row['stat_pal'] != "") {
                                    $Pal = "True";
                                } else {
                                    $Pal = "False";
                                }
                                if (in_array("WATER", $detail3) and $row['stat_wtr'] != "") {
                                    $Wtr = "True";
                                } else {
                                    $Wtr = "False";
                                }
                                if (in_array("CROCKING", $detail3) and $row['stat_cr'] != "") {
                                    $Cr = "True";
                                } else {
                                    $Cr = "False";
                                }
                                if (in_array("PHENOLIC YELLOWING", $detail3) and $row['stat_py'] != "") {
                                    $Py = "True";
                                } else {
                                    $Py = "False";
                                }
                                if (in_array("LIGHT", $detail3) and $row['stat_lg'] != "") {
                                    $Lg = "True";
                                } else {
                                    $Lg = "False";
                                }
                                if (in_array("COLOR MIGRATION-OVEN TEST", $detail3) and $row['stat_cmo'] != "") {
                                    $Cmo = "True";
                                } else {
                                    $Cmo = "False";
                                }
                                if (in_array("COLOR MIGRATION", $detail3) and $row['stat_cm'] != "") {
                                    $Cm = "True";
                                } else {
                                    $Cm = "False";
                                }
                                if (in_array("LIGHT PERSPIRATION", $detail3) and $row['stat_lp'] != "") {
                                    $Lp = "True";
                                } else {
                                    $Lp = "False";
                                }
                                if (in_array("SALIVA", $detail3) and $row['stat_slv'] != "") {
                                    $Slv = "True";
                                } else {
                                    $Slv = "False";
                                }
                                if (in_array("BLEEDING", $detail3) and $row['stat_bld'] != "") {
                                    $Bld = "True";
                                } else {
                                    $Bld = "False";
                                }
                                if (in_array("CHLORIN & NON-CHLORIN", $detail3) and $row['stat_chl'] != "") {
                                    $Chl = "True";
                                } else {
                                    $Chl = "False";
                                }
                                if (in_array("CHLORIN & NON-CHLORIN", $detail3) and $row['stat_nchl'] != "") {
                                    $Nchl = "True";
                                } else {
                                    $Nchl = "False";
                                }
                                if (in_array("DYE TRANSFER", $detail3) and $row['stat_dye'] != "") {
                                    $Dye = "True";
                                } else {
                                    $Dye = "False";
                                }
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="status" class="form-control select2" id="status" style="width: 100%;" <?php if ($rcek1['status'] != '' and $_SESSION['nama1'] != 'Janu Dwi Laksono') {
                                    echo "disabled";
                                } ?>>
                                    <option <?php if ($rcek1['status'] == "") { ?> selected=selected <?php }
                                    ; ?>value="">Pilih</option>
                                    
                                    <option <?php if ($rcek1['status'] == "Approve") { ?> selected=selected <?php }
                                    ; ?>value="Approve">Approve</option>
                                    <option <?php if ($rcek1['status'] == "Conditional Approve") { ?> selected=selected <?php }
                                    ; ?>value="Conditional Approve">Conditional Approve</option>
                                    <option <?php if ($rcek1['status'] == "Limit Approve") { ?> selected=selected <?php }
                                    ; ?>value="Limit Approve">Limit Approve</option>
                                    
                                    <option <?php if ($rcek1['status'] == "Reject") { ?> selected=selected <?php }
                                    ; ?>value="Reject">Reject</option>
                                    <option <?php if ($rcek1['status'] == "Marginal Pass") { ?> selected=selected <?php }
                                    ; ?>value="Marginal Pass">Marginal Pass</option>
                                    <option <?php if ($rcek1['status'] == "Pass") { ?> selected=selected <?php }
                                    ; ?>value="Pass">Pass</option>
                                    <option <?php if ($rcek1['status'] == "Fail") { ?> selected=selected <?php }
                        ...
                        <div class="form-group">					
                            <?php if ($no_test != "") { ?>
                                    <button type="submit" class="btn btn-primary pull-right" name="status_save" value="save" <?php if ($_SESSION['akses'] == 'biasa' or ($rcek1['status'] != '' and $_SESSION['nama1'] != 'Janu Dwi Laksono')) {
                                        echo "disabled";
                                    } ?>><i class="fa fa-save"></i> Simpan Status</button>
                            <?php } ?>
                        </div>
                    </div>
                    </form>
          ...
          <div class="row invoice-info">
              ...
              <?php } ?>-->
                  ...
                  <?php if ($rcek1['fc_wpi'] != "" or $rcek1['fc_cpi'] != "") { ?>    
                      <tr>
                        ...
                        <td colspan="6">
                        W: <?php if ($rcek1['stat_fc'] == "RANDOM") {
                            echo $rcekR['rfc_wpi'];
                        } else {
                            echo $rcek1['fc_wpi'];
                        } ?>
                        C: <?php if ($rcek1['stat_fc'] == "RANDOM") {
                            echo $rcekR['rfc_cpi'];
                        } else {
                            echo $rcek1['fc_cpi'];
                        } ?>
                  ...
                  <?php if ($rcek1['ss_temp'] != "") { ?>    
                      <tr>
                        ...
                        <td colspan="6"><?php if ($rcek1['stat_fwss'] == "RANDOM") {
                            echo $rcekR['rss_temp'];
                        } else {
                            echo $rcek1['ss_temp'];
                        } ?></td>
                  ...
                  <?php if ($rcek1['shrinkage_l1'] != "" or $rcek1['shrinkage_l2'] != "" or $rcek1['shrinkage_l3'] != "" or $rcek1['shrinkage_l4'] != "") { ?>    
                      <tr>
                        ...
                        <td><?php if ($rcek1['stat_fwss'] == "RANDOM") {
                  ...
                  <?php if ($rcek1['apperss_ch1'] != "" or $rcek1['apperss_ch2'] != "" or $rcek1['apperss_ch3'] != "" or $rcek1['apperss_ch4'] != "") { ?>    
                      ...
                      <th>Apperance</th>
                        ...
                        <td colspan="3"><?php if ($rcek1['stat_fwss'] == "RANDOM") {
                  ...
                  <?php if ($rcek1['pm_f1'] != "" or $rcek1['pm_f2'] != "" or $rcek1['pm_f3'] != "" or $rcek1['pm_f4'] != "" or $rcek1['pm_f5'] != "") { ?>    
                      <tr>
                        ...
                        <th>Face</th>
                        <td><?php if ($rcek1['stat_pm'] == "RANDOM") {
                            echo $rcekR['rpm_f1'];
                        } else {
                            echo $rcek1['pm_f1'];
                        } ?></td>
                  ...
                  <?php if ($rcek1['pl_f1'] != "" or $rcek1['pl_f2'] != "" or $rcek1['pl_f3'] != "" or $rcek1['pl_f4'] != "" or $rcek1['pl_f5'] != "" or $rcek1['pl_b1'] != "") { ?>    
                      <tr>
                        ...
                        <th>Face</th>
                        <td><?php if ($rcek1['stat_pl'] == "RANDOM") {
                            echo $rcekR['rpl_f1'];
                        } else {
                            echo $rcek1['pl_f1'];
                        } ?></td>
                  ...
                  <?php if ($rcek1['pb_f1'] != "" or $rcek1['pb_f2'] != "" or $rcek1['pb_f3'] != "" or $rcek1['pb_f4'] != "" or $rcek1['pb_f5'] != "") { ?>    
                      <tr>
                        ...
                        <th>Face</th>
                        <td><?php if ($rcek1['stat_pb'] == "RANDOM") {
                            echo $rcekR['rpb_f1'];
                        } else {
                            echo $rcek1['pb_f1'];
                        } ?></td>
                  ...
                  <?php if ($rcek1['prt_f1'] != "" or $rcek1['prt_f2'] != "" or $rcek1['prt_f3'] != "" or $rcek1['prt_f4'] != "" or $rcek1['prt_f5'] != "" or $rcek1['prt_b1'] != "") { ?>    
                      <tr>
                        ...
                        <th>Face</th>
                        <td><?php if ($rcek1['stat_prt'] == "RANDOM") {
                            echo $rcekR['rprt_f1'];
                        } else {
                            echo $rcek1['prt_f1'];
                        } ?></td>
                  ...
                  <?php if ($rcek1['sm_l1'] != "" or $rcek1['sm_l2'] != "" or $rcek1['sm_l3'] != "" or $rcek1['sm_l4'] != "") { ?>    
                      <tr>
                        ...
                        <th>Len</th>
                        <td><?php if ($rcek1['stat_sm'] == "RANDOM") {
                            echo $rcekR['rsm_l1'];
                        } else {
                            echo $rcek1['sm_l1'];
                        } ?></td>
                  ...
                  <?php if ($rcek1['sp_grdl1'] != "" or $rcek1['sp_clsl1'] != "" or $rcek1['sp_shol1'] != "" or $rcek1['sp_medl1'] != "" or $rcek1['sp_lonl1'] != "") { ?>    
                      <tr>
                        <th>L1</th>
                        <td><?php if ($rcek1['stat_sp'] == "RANDOM") {
                  ...
                  <?php if ($rcek1['sb_l1'] != "" or $rcek1['sb_l2'] != "" or $rcek1['sb_l3'] != "" or $rcek1['sb_l4'] != "") { ?>    
                      <tr>
                        ...
                        <th>Len</th>
                        <td><?php if ($rcek1['stat_sb'] == "RANDOM") {
                            echo $rcekR['rsb_l1'];
                        } else {
                            echo $rcek1['sb_l1'];
                        } ?></td>
                  ...
                  <?php if ($rcek1['bs_instron'] != "" or $rcek1['bs_mullen'] != "" or $rcek1['bs_tru'] != "") { ?>    
                      <tr>
                        ...
                        <td><?php if ($rcek1['stat_bs2'] == "RANDOM") {
                            echo $rcekR['rbs_instron'];
                        } else {
                            echo $rcek1['bs_instron'];
                        } ?></td>
                        <td><?php if ($rcek1['stat_bs3'] == "RANDOM") {
                  ...
                  <?php if ($rcek1['thick1'] != "" or $rcek1['thick2'] != "" or $rcek1['thick3'] != "" or $rcek1['thickav'] != "") { ?>    
                      <tr>
                        ...
                        <td><?php if ($rcek1['stat_th'] == "RANDOM") {
                            echo $rcekR['rthick1'];
                        } else {
                            echo $rcek1['thick1'];
                        } ?></td>
                  ...
                  <?php if ($rcek1['stretch_l1'] != "" or $rcek1['stretch_l2'] != "" or $rcek1['stretch_l3'] != "" or $rcek1['stretch_l4'] != "" or $rcek1['stretch_l5'] != "") { ?>    
                      <tr>
                        ...
                        <th>Load</th>
                        <td><?php if ($rcek1['stat_sr'] == "RANDOM") {
                  ...
                  <?php if ($rcek1['growth_l1'] != "" or $rcek1['growth_l2'] != "") { ?>    
                      <tr>
                        ...
                        <th>Len</th>
                        <td><?php if ($rcek1['stat_gr'] == "RANDOM") {
                  ...
                  <?php if ($rcek1['apper_ch1'] != "" or $rcek1['apper_ch2'] != "" or $rcek1['apper_ch3'] != "") { ?>    
                      ...
                      <th rowspan="7">Apperance</th>
                        <th>&nbsp;</th>
                        <td><?php if ($rcek1['stat_ap'] == "RANDOM") {
                        ...
                        <td colspan="4"><?php if ($rcek1['stat_ap'] == "RANDOM") {
                  ...
                  <?php if ($rcek1['h_shrinkage_l1'] != "" or $rcek1['h_shrinkage_w1'] != "" or $rcek1['h_shrinkage_grd'] != "" or $rcek1['h_shrinkage_app'] != "") { ?>    
                      <tr>
                        ...
                        <th>Suhu</th>
                        <td><?php if ($rcek1['stat_hs'] == "RANDOM") {
                  ...
                  <?php if ($rcek1['fibre_transfer'] != "" or $rcek1['fibre_grade'] != "") { ?>    
                      <tr>
                        ...
                        <td><?php if ($rcek1['stat_ff'] == "RANDOM") {
                  ...
                  <?php if ($rcek1['odour'] != "") { ?>  
                    <tr>
                        ...
                        <td colspan="4"><?php if ($rcek1['stat_odour'] == "RANDOM") {
                            echo $rcekR['rodour'];
                        } else {
                            echo $rcek1['odour'];
                        } ?></td>
                ...
                <?php if ($rcek1['curling'] != "") { ?>  
                    <tr>
                        ...
                        <td colspan="4"><?php if ($rcek1['stat_curling'] == "RANDOM") {
                            echo $rcekR['rcurling'];
                        } else {
                            echo $rcek1['curling'];
                        } ?></td>
              ...
              <table class="table">
                ...
                <td><?php if ($rcek1['stat_wic'] == "RANDOM") {
                    ...
                    <tr>
                        <th>&nbsp;</th>
                        <th >Afterwash</th>
                        <td><?php if ($rcek1['stat_wic2'] == "RANDOM") {
                            echo $rcekR['rwick_l2'];
                        } else {
                            echo $rcek1['wick_l2'];
                        } ?></td>
                ...
                <td><?php if ($rcek1['stat_wic'] == "RANDOM") {
                    ...
                    echo $rcek1['wick_w3'];
                      ...
                      <tr>
                        ...
                        <td><?php if ($rcek1['stat_wic1'] == "RANDOM") {
                            echo $rcekR['rwick_w1'];
                        } else {
                            echo $rcek1['wick_w1'];
                        } ?></td>
                    ...
                    <tr>
                        ...
                        <td><?php if ($rcek1['stat_wic3'] == "RANDOM") {
                            echo $rcekR['rwick_w2'];
                        } else {
                            echo $rcek1['wick_w2'];
                        } ?></td>
                ...
                <?php if ($rcek1['dry1'] != "" or $rcek1['dry2'] != "" or $rcek1['dry3'] != "" or $rcek1['dryaf1'] != "" or $rcek1['dryaf2'] != "" or $rcek1['dryaf3'] != "") { ?>  
                    <tr>
                        ...
                        <th>Original</th>
                        <td><?php if ($rcek1['stat_dry'] == "RANDOM") {
                            echo $rcekR['rdry1'];
                        } else {
                            echo $rcek1['dry1'];
                        } ?></td>
                      ...
                      <tr>
                        <th>Afterwash</th>
                        <td><?php if ($rcek1['stat_dry1'] == "RANDOM") {
                            echo $rcekR['rdryaf1'];
                        } else {
                            echo $rcek1['dryaf1'];
                        } ?></td>
                ...
                <td><?php if ($rcek1['stat_wp'] == "RANDOM") {
                    ...
                    echo $rcek1['repp4'];
                     ...
                     <tr>
                        <th>Afterwash</th>
                        <td><?php if ($rcek1['stat_wp1'] == "RANDOM") {
                            echo $rcekR['rrepp2'];
                        } else {
                            echo $rcek1['repp2'];
                        } ?>
                ...
                <?php if ($rcek1['ph'] != "") { ?>  
                    <tr>
                        <th colspan="2">Ph</th>
                        <td colspan="4"><?php if ($rcek1['stat_ph'] == "RANDOM") {
                            echo $rcekR['rph'];
                        } else {
                            echo $rcek1['ph'];
                        } ?></td>
                ...
                <?php if ($rcek1['soil'] != "") { ?>  
                    <tr>
                        ...
                        <td colspan="4"><?php if ($rcek1['stat_sor'] == "RANDOM") {
                            echo $rcekR['rsoil'];
                        } else {
                            echo $rcek1['soil'];
                        } ?></td>
                ...
                <?php if ($rcek1['humidity'] != "") { ?>  
                    <tr>
                        ...
                        <td colspan="4"><?php if ($rcek1['stat_hum'] == "RANDOM") {
            ...
            <div class="col-sm-4 invoice-col">
              ...
              <table class="table">
                  ...
                  <tr>
                    ...
                    <th>Suhu</th>
                    <td colspan="4"><?php if ($rcek1['stat_wf'] == "RANDOM") {
                ...
                <tr>
                    <th>&nbsp;</th>
                    <td><?php if ($rcek1['stat_wf'] == "RANDOM") {
                        echo $rcekR['rwash_colorchange'];
                    } else {
                        echo $rcek1['wash_colorchange'];
                    } ?></td>
                    <td colspan="2"><?php if ($rcek1['stat_wf'] == "RANDOM") {
            ...
            <?php if ($rcek1['acid_colorchange'] != "" or $rcek1['acid_acetate'] != "" or $rcek1['acid_cotton'] != "" or $rcek1['acid_nylon'] != "" or $rcek1['acid_poly'] != "" or $rcek1['acid_acrylic'] != "" or $rcek1['acid_wool'] != "" or $rcek1['acid_staining'] != "") { ?>
                <tr>
                  ...
                  <tr>
                    <td ><?php if ($rcek1['stat_pac'] == "RANDOM") {
                        echo $rcekR['racid_colorchange'];
                    } else {
                        echo $rcek1['acid_colorchange'];
                    } ?></td>
                    <td colspan="2"><?php if ($rcek1['stat_pac'] == "RANDOM") {
            ...
            <?php if ($rcek1['alkaline_colorchange'] != "" or $rcek1['alkaline_acetate'] != "" or $rcek1['alkaline_cotton'] != "" or $rcek1['alkaline_nylon'] != "" or $rcek1['alkaline_poly'] != "" or $rcek1['alkaline_acrylic'] != "" or $rcek1['alkaline_wool'] != "" or $rcek1['alkaline_staining'] != "") { ?>
                <tr>
                  ...
                  <tr>
                    <td><?php if ($rcek1['stat_pal'] == "RANDOM") {
                        echo $rcekR['ralkaline_colorchange'];
                    } else {
                        echo $rcek1['alkaline_colorchange'];
                    } ?></td>
                    <td colspan="2"><?php if ($rcek1['stat_pal'] == "RANDOM") {
            ...
            <?php if ($rcek1['water_colorchange'] != "" or $rcek1['water_acetate'] != "" or $rcek1['water_cotton'] != "" or $rcek1['water_nylon'] != "" or $rcek1['water_poly'] != "" or $rcek1['water_acrylic'] != "" or $rcek1['water_wool'] != "" or $rcek1['water_staining'] != "") { ?>
                <tr>
                  ...
                  <tr>
                    <td><?php if ($rcek1['stat_wtr'] == "RANDOM") {
                        echo $rcekR['rwater_colorchange'];
                    } else {
                        echo $rcek1['water_colorchange'];
                    } ?></td>
                    <td colspan="2"><?php if ($rcek1['stat_wtr'] == "RANDOM") {
            ...
            <?php if ($rcek1['crock_len1'] != "" or $rcek1['crock_wid1'] != "" or $rcek1['crock_len2'] != "" or $rcek1['crock_wid2'] != "") { ?>
                ...
                <tr>
                    <th>Len</th>
                    <td><?php if ($rcek1['stat_cr'] == "RANDOM") {
                        echo $rcekR['rcrock_len1'];
                    } else {
                        echo $rcek1['crock_len1'];
                    } ?></td>
                    <td colspan="2"><?php if ($rcek1['stat_cr'] == "RANDOM") {
                ...
                <tr>
                    ...
                    <td colspan="3"><?php if ($rcek1['stat_cr'] == "RANDOM") {
            ...
            <?php if ($rcek1['phenolic_colorchange'] != "") { ?>
                <tr>
                    ...
                    <td colspan="4"><?php if ($rcek1['stat_py'] == "RANDOM") {
            ...
            <?php if ($rcek1['light_rating1'] != "" or $rcek1['light_rating2'] != "") { ?>
                <tr>
                    <th>Light</th>
                    <th>&nbsp;</th>
                    <td><?php if ($rcek1['stat_lg'] == "RANDOM") {
                        echo $rcekR['rlight_rating1'];
                    } else {
                        echo $rcek1['light_rating1'];
                    } ?></td>
                    <td colspan="2"><?php if ($rcek1['stat_lg'] == "RANDOM") {
            ...
            <?php if ($rcek1['cm_printing_colorchange'] != "" or $rcek1['cm_printing_staining'] != "") { ?>
                <tr>
                    ...
                    <th>&nbsp;</th>
                    <td colspan="3"><?php if ($rcek1['stat_cmo'] == "RANDOM") {
                        echo $rcekR['rcm_printing_colorchange'];
                    } else {
                        echo $rcek1['cm_printing_colorchange'];
                    } ?></td>
                    <td><?php if ($rcek1['stat_cmo'] == "RANDOM") {
            ...
            <?php if ($rcek1['cm_dye_temp'] != "" or $rcek1['cm_dye_colorchange'] != "" or $rcek1['cm_dye_stainingface'] != "" or $rcek1['cm_dye_stainingback'] != "") { ?>
                <tr>
                    ...
                    <th>Suhu</th>
                    <td colspan="4"><?php if ($rcek1['stat_cm'] == "RANDOM") {
                ...
                <tr>
                    <th>&nbsp;</th>
                    <td><?php if ($rcek1['stat_cm'] == "RANDOM") {
            ...
            <?php if ($rcek1['light_pers_colorchange'] != "") { ?>
                <tr>
                    ...
                    <th><strong>CC</strong></th>
                    <td colspan="4"><?php if ($rcek1['stat_lp'] == "RANDOM") {
            ...
            <?php if ($rcek1['saliva_staining'] != "") { ?>
                <tr>
                    <th>Saliva</th>
                    <th>&nbsp;</th>
                    <td colspan="2"><?php if ($rcek1['stat_slv'] == "RANDOM") {
            ...
            <?php if ($rcek1['bleeding'] != "") { ?>
                <tr>
                    <th>Bleeding</th>
                    <th>&nbsp;</th>
                    <td colspan="2"><?php if ($rcek1['stat_bld'] == "RANDOM") {
            ...
            <?php if ($rcek1['chlorin'] != "" or $rcek1['nchlorin1'] != "" or $rcek1['nchlorin2'] != "") { ?>
                <tr>
                    <th>Chlorin</th>
                    <th>&nbsp;</th>
                    <td colspan="2"><?php if ($rcek1['stat_chl'] == "RANDOM") {
                        echo $rcekR['rchlorin'];
                    } else {
                        echo $rcek1['chlorin'];
                    } ?></td>
                ...
                <tr>
                    <th>Non-Chlorin</th>
                    <th>&nbsp;</th>
                    <td colspan="2"><?php if ($rcek1['stat_nchl'] == "RANDOM") {
            ...
            <?php if ($rcek1['dye_tf_cstaining'] != "" or $rcek1['dye_tf_acetate'] != "" or $rcek1['dye_tf_cotton'] != "" or $rcek1['dye_tf_nylon'] != "" or $rcek1['dye_tf_poly'] != "" or $rcek1['dye_tf_acrylic'] != "" or $rcek1['dye_tf_wool'] != "" or $rcek1['dye_tf_sstaining'] != "") {
                ...
                <tr>
                    <th>&nbsp;</th>
                    <td><?php if ($rcek1['stat_dye'] == "RANDOM") {
                        echo $rcekR['rdye_tf_acetate'];
                    } else {
                        echo $rcek1['dye_tf_acetate'];
                    } ?></td>
                    <td colspan="2"><?php if ($rcek1['stat_dye'] == "RANDOM") {

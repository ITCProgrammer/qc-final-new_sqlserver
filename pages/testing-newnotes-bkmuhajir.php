...
if ($_POST['physical_save'] == "save" and $cek1 > 0) {
	...
	if ($sqlPHY) {
		...
		$paramspy_m = [
					$_POST['mflamability'], $_POST['mfla_note'], $_POST['mfc_cott'], $_POST['mfc_poly'], $_POST['mfc_elastane'],
					$_POST['mfc_cott1'], $_POST['mfc_poly1'], $_POST['mfc_elastane1'], $_POST['std_mfc_cott1'], $_POST['std_mfc_poly1'],
		...
		$params = [
				...
				$_POST['dgrowth_l1'],
				 ...
				 $_POST['dgrowth_l2'],
				 $_POST['dgrowth_w2'],
				 $_POST['drec_growth_l1'],
				 $_POST['drec_growth_w1'],
				 $_POST['drec_growth_l2'],
				 $_POST['drec_growth_w2'],
				 $_POST['dgrowth_note'],
				$_POST['dapper_ch1'],
				 $_POST['dapper_ch2'],
				 $_POST['dapper_ch3'],
			 ...
			 $_POST['dapper_st3'],
				$_POST['dapper_pf1'],
				 ...
				 $_POST['dapper_pb2'],
				 $_POST['dapper_pb3'],
				$_POST['dapper_acetate'],
				 $_POST['dapper_cotton'],
				 $_POST['dapper_nylon'],
				 $_POST['dapper_poly'],
				 $_POST['dapper_acrylic'],
				 $_POST['dapper_wool'],
				 $_POST['dapper_note'],
				$_POST['dfibre_transfer'],
				 $_POST['dfibre_grade'],
				 $_POST['dfibre_note'],
				 $_POST['dodour'],
				 $_POST['dodour_note'],
...
// $sqlPHYDI = sqlsrv_query($con_db_qc_sqlsrv, $sql, $params);
		...
		$sqlpy_mi = "
			INSERT INTO db_qc.tbl_tq_marginal (
				...
				mfc_cott1, mfc_poly1, std_mfc_cott1, std_mfc_poly1, std_mfc_elastane1,
		...
		$paramspy_mi = [
			$rcek['id'], $_POST['mflamability'], $_POST['mfla_note'], $_POST['mfc_cott'], $_POST['mfc_poly'], $_POST['mfc_elastane'],
			$_POST['mfc_cott1'], $_POST['mfc_poly1'],  $_POST['std_mfc_cott1'], $_POST['std_mfc_poly1'], $_POST['std_mfc_elastane1'],

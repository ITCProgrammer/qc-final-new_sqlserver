...
<script>
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		$('#autocheck4to5dua').on('change', function (e) {
			if ($(this).is(':checked')) {	
				let val='4-5';
				if(document.forms['form2']['jns_test2'].value == "PERSPIRATION ACID"){
					...
					// $("[name=alkaline_staining2]").val(val);
				}
				
				if(!loading){
					if ($('#autocheck4point5dua').is(':checked')){
						loading=true
						$('#autocheck4point5dua').attr("checked",false).trigger("click");
					}
				}
				loading=false;
			}else{
		...
		$('#autocheck4point5dua').on('change', function (e) {
			if ($(this).is(':checked')) {
				let val='4-5';
				if(document.forms['form2']['jns_test2'].value == "WASHING"){
					$("[name=wash_colorchange2]").val(val);
					$("[name=wash_cotton2]").val(val);
					$("[name=wash_poly2]").val(val);
					$("[name=wash_wool2]").val(val);
					$("[name=wash_acetate2]").val(val);
					$("[name=wash_nylon2]").val(val);
					$("[name=wash_acrylic2]").val(val);
					// $("[name=wash_staining]").val(val);
				}else if(document.forms['form2']['jns_test2'].value == "PERSPIRATION ACID"){
					$("[name=acid_colorchange2]").val(val);
					$("[name=acid_cotton2]").val(val);
					...
					// $("[name=water_staining2]").val(val);
				}else if(document.forms['form2']['jns_test2'].value == "DYE TRANSFER"){
					$("[name=dye_tf_acetate2]").val(val);
					$("[name=dye_tf_nylon2]").val(val);
					$("[name=dye_tf_acrylic2]").val(val);
					$("[name=dye_tf_sstaining2]").val(val);
					$("[name=dye_tf_cotton2]").val(val);
					$("[name=dye_tf_poly2]").val(val);
					$("[name=dye_tf_wool2]").val(val);
					// $("[name=dye_tf_cstaining2]").val(val);
				}

				if(!loading){
					if ($('#autocheck4to5dua').is(':checked')){
						loading=true	
						$('#autocheck4to5dua').attr("checked",false).trigger("click");			
					}
				}
				loading=false;
			}else{
					...
					<div class="tab-pane" id="tab_2">
						<form class="form-horizontal" action="" method="post" enctype="multipart/form-data" name="form2"
							...
							<div class="form-group">
								...
								<div class="col-sm-2 div-autocheck" style="display:none;" >
									<div class="checkbox-wrapper-28">
										<input id="autocheck4point5dua" type="checkbox" class="promoted-input-checkbox"/>
										<svg><use xlink:href="#checkmark-28" /></svg>
										<label for="autocheck4point5dua">
											4-5 (ISO)
										</label>
										<svg xmlns="http://www.w3.org/2000/svg" style="display: none">
											<symbol id="checkmark-28" viewBox="0 0 24 24">
						...
						<!-- WATER BEGIN-->
							<div class="form-group" id="c2" style="display:none;">
								<label for="water" class="col-sm-2 control-label">WATER AATCC</label>
								<div class="col-sm-2">
						...
						<!-- PERSPIRATION ACID BEGIN-->
							...
							<div class="form-group" id="c31" style="display:none;">
								...
								<div class="col-sm-2">
									...
									<input name="acid_acetate2" type="text" class="form-control" id="acid_acetate"
						...
						<!-- PERSPIRATION ALKALINE BEGIN-->
							<div class="form-group" id="c4" style="display:none;">
								<label for="alkaline" class="col-sm-2 control-label">PERSPIRATION ALKALINE AATCC</label>
								<div class="col-sm-2">
							...
							<div class="form-group" id="c41" style="display:none;">
								<label for="alkaline" class="col-sm-2 control-label">PERSPIRATION ALKALINE ISO</label>
								<div class="col-sm-2">
									<input name="alkaline_colorchange2" type="text" class="form-control"
										id="alkaline_colorchange2" value="<?php echo $rcek1['alkaline_colorchange2']; ?>"
										placeholder="4-5 Color Change">
						...
						<!-- CROCKING BEGIN-->
							<div class="form-group" id="c5" style="display:none;">
								<label for="crocking" class="col-sm-2 control-label">CROCKING AATCC</label>
							...
							<div class="form-group" id="c51" style="display:none;">
...
if ($_POST['colorfastness_save'] == "save") {
	$fields = array('classification_shedding', 'syringe_shedding', 'observation_shedding', 'avg_gr_shedding', 'avg_per_shedding', 'nama_rub', 'status_rub', 'bleeding_root','acid_colorchange2',
					'acid_acetate2','acid_cotton2','acid_nylon2','acid_poly2','acid_acrylic2','acid_wool2','acid_staining2','acid_note2',
					'alkaline_colorchange2','alkaline_acetate2','alkaline_cotton2','alkaline_nylon2','alkaline_poly2','alkaline_acrylic2',
					'alkaline_wool2','alkaline_staining2','alkaline_note2','crock_len12','crock_wid12','crock_len22','crock_wid22', 'water_colorchange2','water_acetate2','water_cotton2',
					'water_nylon2','water_poly2','water_acrylic2','water_wool2','water_staining2','water_note2');
    foreach ($fields as $field) {
        $value = trim($_POST[$field]);
...
$sqlPHYDI = sqlsrv_query($con_db_qc_sqlsrv, $sql, $params);
		...
		$paramspy_mi = [
			...
			$_POST['mgrowth_l1'],
			 ...
			 $_POST['mgrowth_l2'],
			 $_POST['mgrowth_w2'],
			 $_POST['mrec_growth_l1'],
			 $_POST['mrec_growth_w1'],
			 $_POST['mrec_growth_l2'],
			 $_POST['mrec_growth_w2'],
			 $_POST['mgrowth_note'],
			$_POST['mapper_ch1'],
			 $_POST['mapper_ch2'],
			 $_POST['mapper_ch3'],
			...
			$_POST['mapper_pf1'],
			 ...
			 $_POST['mapper_pb2'],
			 $_POST['mapper_pb3'],
			$_POST['mapper_acetate'],
			 $_POST['mapper_cotton'],
			 $_POST['mapper_nylon'],
			 $_POST['mapper_poly'],
			 $_POST['mapper_acrylic'],
			 $_POST['mapper_wool'],
			 $_POST['mapper_note'],

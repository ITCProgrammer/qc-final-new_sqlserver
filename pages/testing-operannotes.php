                  ...
                  <label for="no_po" class="col-sm-3 control-label">No Demand</label>
                  	<div class="col-sm-4">
						<div class="input-group">	  
							...
							onchange="window.location='TestingOperan-'+this.value" value="<?php if($cek>0){echo $rcek['nodemand'];}else{echo $_GET['nodemand'];} ?>" placeholder="No Demand" required <?php if($_SESSION['lvl_id']=="TQ"){echo "readonly";}?>>
						</div>	  
		  			</div>
            </div>
			<div class="form-group">
...
<div class="box box-success">
   	<div class="box-header with-border">
    	<h3 class="box-title">No Demand Lama</h3>
		<div class="box-tools pull-right">
			<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
		</div>
  	</div>
        ...
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> Result.
				...
				Date: 
				<?php 
				if (!empty($rcek1['tgl_buat'])) {
					echo $rcek1['tgl_buat']->format('d-m-Y'); 
				}
				?>
			</small>
          </h2>
...
if($_POST['physical_save']=="save" AND $cekNew>0){
	...
	$sqlPHY = "UPDATE db_qc.tbl_tq_test SET 
		  flamability=?,
		  fla_note=?,
		  fc_cott=?,
		  fc_poly=?,
	...
	$sqlPHY = sqlsrv_query($con_db_qc_sqlsrv, $sqlPHY, $paramsPHY);

	if($sqlPHY){

		$sqlPHYD = "UPDATE db_qc.tbl_tq_disptest SET 
		dflamability=?,
		dfla_note=?,
		dfc_cott=?,
		dfc_poly=?,
		...
		$sqlPHYD = sqlsrv_query($con_db_qc_sqlsrv, $sqlPHYD, $paramsPHYD);
		$sqlPHYDI = "INSERT INTO db_qc.tbl_tq_disptest (id_nokk, dflamability, dfla_note, dfc_cott, dfc_poly, dfc_elastane, dfc_cott1, dfc_poly1, dfc_elastane1, std_dfc_cott1, std_dfc_poly1, std_dfc_elastane1, dfibercontent, dfiber_note, dfc_wpi, dfc_cpi, dfc_note, df_weight, dfwe_note, df_width, dfwi_note, dbow, dskew, dbas_note, dh_shrinkage_temp, dh_shrinkage_l1, dh_shrinkage_w1, dh_shrinkage_grd, dh_shrinkage_app, dh_shrinkage_note, dss_temp, dss_washes3, dss_washes10, dss_washes15, dss_cmt, dshrinkage_l1, dshrinkage_l2, dshrinkage_l3, dshrinkage_l4, dshrinkage_l5, dshrinkage_l6, dshrinkage_w1, dshrinkage_w2, dshrinkage_w3, dshrinkage_w4, dshrinkage_w5, dshrinkage_w6, dspirality1, dspirality2, dspirality3, dspirality4, dspirality5, dspirality6, dss_linedry, dss_tumbledry, dsns_note, dapperss_ch1, dapperss_ch2, dapperss_ch3, dapperss_ch4, dapperss_cc1, dapperss_cc2, dapperss_cc3, dapperss_cc4, dapperss_st, dapperss_pf1, dapperss_pf2, dapperss_pf3, dapperss_pf4, dapperss_pb1, dapperss_pb2, dapperss_pb3, dapperss_pb4, dapperss_sf1, dapperss_sf2, dapperss_sf3, dapperss_sf4, dapperss_sb1, dapperss_sb2, dapperss_sb3, dapperss_sb4, dapperss_note, dpm_f1, dpm_b1, dpm_f2, dpm_b2, dpm_f3, dpm_b3, dpm_f4, dpm_b4, dpm_f5, dpm_b5, dpillm_note, dpl_f1, dpl_b1, dpl_f2, dpl_b2, dpl_f3, dpl_b3, dpl_f4, dpl_b4, dpl_f5, dpl_b5, dpilll_note, dpb_f1, dpb_b1, dpb_f2, dpb_b2, dpb_f3, dpb_b3, dpb_f4, dpb_b4, dpb_f5, dpb_b5, dpillb_note, dprt_f1, dprt_b1, dprt_f2, dprt_b2, dprt_f3, dprt_b3, dprt_f4, dprt_b4, dprt_f5, dprt_b5, dpillr_note, dabration, dabr_note, dsm_l1, dsm_w1, dsm_l2, dsm_w2, dsm_l3, dsm_w3, dsm_l4, dsm_w4, dsnam_note, dsp_grdl1, dsp_clsl1, dsp_shol1, dsp_medl1, dsp_lonl1, dsp_grdw1, dsp_clsw1, dsp_show1, dsp_medw1, dsp_lonw1, dsp_grdl2, dsp_clsl2, dsp_shol2, dsp_medl2, dsp_lonl2, dsp_grdw2, dsp_clsw2, dsp_show2, dsp_medw2, dsp_lonw2, dsnap_note, dsb_l1, dsb_w1, dsb_l2, dsb_w2, dsb_l3, dsb_w3, dsb_l4, dsb_w4, dsnab_note, dbs_instron, dbs_mullen, dbs_tru, dburs_note, dthick1, dthick2, dthick3, dthickav, dthick_note, dstretch_l1, dstretch_w1, dstretch_l2, dstretch_w2, dstretch_l3, dstretch_w3, dstretch_l4, dstretch_w4, dstretch_l5, dstretch_w5, dload_stretch, dstretch_note, drecover_l1, drecover_w1, drecover_l2, drecover_w2, drecover_l3, drecover_w3, drecover_l4, drecover_w4, drecover_l5, drecover_w5, drecover_note, dgrowth_l1, dgrowth_w1, dgrowth_l2, dgrowth_w2, drec_growth_l1, drec_growth_w1, drec_growth_l2, drec_growth_w2, dgrowth_note, dapper_ch1, dapper_ch2, dapper_ch3, dapper_cc1, dapper_cc2, dapper_cc3, dapper_st, dapper_st2, dapper_st3, dapper_pf1, dapper_pf2, dapper_pf3, dapper_pb1, dapper_pb2, dapper_pb3, dapper_acetate, dapper_cotton, dapper_nylon, dapper_poly, dapper_acrylic, dapper_wool, dapper_note, dfibre_transfer, dfibre_grade, dfibre_note, dodour, dodour_note, dcurling, dcurling_note, tgl_buat, tgl_update)
		VALUES (".",".str_repeat("?,", count($paramsPHYD)-1)."GETDATE(),GETDATE())";

		$paramsPHYDI = array_merge(array($rcek['id']), array_slice($paramsPHYD, 0, count($paramsPHYD)-1));
		$sqlPHYDI = sqlsrv_query($con_db_qc_sqlsrv, $sqlPHYDI, $paramsPHYDI);
	...
	echo "<script>swal({
		...
		text: 'Bagian else INSERT sangat panjang. Minta versi eksplisit penuh jika diperlukan.',
		type: 'error',
		}).then((result) => {
		if (result.value) {
			window.location.href='TestingOperanNoTes-$notes'; 
...
if($_POST['colorfastness_save']=="save" and $cekNew>0){
	$sqlCLR = "UPDATE db_qc.tbl_tq_test SET
	wash_temp=?,
	wash_colorchange=?,
	wash_acetate=?,
	wash_cotton=?,
	...
	$sqlCLR = sqlsrv_query($con_db_qc_sqlsrv, $sqlCLR, $paramsCLR);

	if($sqlCLR){
		$sqlCLRD = "UPDATE db_qc.tbl_tq_disptest SET
		dwash_temp=?,
		dwash_colorchange=?,
		dwash_acetate=?,
		dwash_cotton=?,
		...
		$sqlCLRD = sqlsrv_query($con_db_qc_sqlsrv, $sqlCLRD, $paramsCLRD);

		$sqlCLRDI = "INSERT INTO db_qc.tbl_tq_disptest (
		id_nokk,
		dwash_temp,
		dwash_colorchange,
		dwash_acetate,
		...
		$sqlCLRDI = sqlsrv_query($con_db_qc_sqlsrv, $sqlCLRDI, $paramsCLRDI);
	...
	$sqlCLR = "INSERT INTO db_qc.tbl_tq_test (
	id_nokk,
	wash_temp,
	wash_colorchange,
	wash_acetate,
...
if($_POST['functional_save']=="save" and $cekNew>0){
	...
	$sqlFPH = "UPDATE db_qc.tbl_tq_test SET
	wick_l1=?,
	wick_w1=?,
	wick_l2=?,
	wick_w2=?,
	...
	$sqlFPH = sqlsrv_query($con_db_qc_sqlsrv, $sqlFPH, $paramsFPH);

	if($sqlFPH){

		$sqlFPHD = "UPDATE db_qc.tbl_tq_disptest SET
		dwick_l1=?,
		dwick_w1=?,
		dwick_l2=?,
		dwick_w2=?,
		...
		$sqlFPHD = sqlsrv_query($con_db_qc_sqlsrv, $sqlFPHD, $paramsFPHD);
		$sqlFPHDI = "INSERT INTO db_qc.tbl_tq_disptest (
		id_nokk,
		dwick_l1,
		dwick_w1,
		dwick_l2,
		...
		$sqlFPHDI = sqlsrv_query($con_db_qc_sqlsrv, $sqlFPHDI, $paramsFPHDI);
	...
	$sqlFPH = "INSERT INTO db_qc.tbl_tq_test (
	id_nokk,
	wick_l1,
	wick_w1,
	wick_l2,
